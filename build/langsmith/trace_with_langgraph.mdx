...
![Trace tree for a LangGraph run with LangChain](images/langgraph-with-langchain-trace.png)
...
![Trace tree for a LangGraph run without LangChain](images/langgraph-without-langchain-trace.png)
