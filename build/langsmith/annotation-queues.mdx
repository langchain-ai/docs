...
- **From the Details view**: In a [tracing project](/langsmith/observability-concepts#tracing-projects), click into any row to open the side panel in the [Details view](/langsmith/view-traces#details-view). The panel offers two actions, each with a fixed scope:
