...
1. Navigate to **Tracing Projects** in the left-hand menu and select a tracing project. In an agent-based workspace, select the agent and then the [environment](/langsmith/agent-environments#select-an-environment) you want to analyze.
1. Click **+New** in the top right corner then **New Insights Report** to generate new insights over it.
