...
evals/
  my-task/
    ...
    identity.json               # Optional caller identity fixture
    environment/
...
### Set an eval identity

Add `identity.json` when a task needs a specific caller, groups, or claims. The fixture is optional, including for projects that export [identity](/langsmith/managed-deep-agents-identity), and scaffolding does not create one automatically.
