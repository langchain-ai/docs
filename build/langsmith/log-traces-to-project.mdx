...
LangSmith uses the concept of a [_project_](/langsmith/observability-concepts#tracing-projects) to group traces. If left unspecified, the project is set to `default`.
