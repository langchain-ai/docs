---
title: View traces
description: Inspect agent threads in LangSmith using the Trajectory view or Details view.
---
...
- [**Trajectory**](#trajectory-view) (**beta**): The conversation layer. Scan the [trajectory](/langsmith/observability-concepts#trajectories) as inputs, outputs, reasoning, tool calls, and subagent activity. Use this to find where to look. Press `M` to switch to this view.
...
<Note>
The Trajectory tab is disabled for threads that don't have any renderable messages. The Trajectory view is in **[beta](/langsmith/release-stages)**—the side panel defaults to the Details view.
</Note>
...
<Note>The Trajectory view is in **[beta](/langsmith/release-stages)**. The side panel defaults to the [Details view](#details-view).</Note>
