...
[LangChain](/oss/python/langchain/overview) chat models and [Deep Agents](/oss/python/deepagents/overview) support the gateway through two convenience environment variables:
