...
- **[Enable SmithDB](/langsmith/self-host-smithdb)** (optional): run SmithDB alongside ClickHouse on an existing Kubernetes installation. ClickHouse remains required.
