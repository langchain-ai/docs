...
<Note>
Use these tiers only after you decide to enable SmithDB. For non-SmithDB LangSmith services, see [Configure LangSmith for scale](/langsmith/self-host-scale).
</Note>
