...
Use this section if you would like to only deploy metrics exporters for the components in your self hosted deployment, which you can then scrape using your telemetry. If you would like a full observability stack deployed for you, go to the [End-to-End Deployment Section](/self_hosting/observability/observability_stack#prerequisites).
...
![LangSmith Grafana Dashboards](images/langsmith_grafana_dashboards.png)
