---
title: Trajectory view integrations
description: Frameworks and SDKs that render in the LangSmith Trajectory view and the metadata each one sets.
---

<Note>
The [Trajectory view](/langsmith/view-traces#trajectory-view) is in **[beta](/langsmith/release-stages)**.
</Note>
