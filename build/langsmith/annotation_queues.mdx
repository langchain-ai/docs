...
![](images/create_annotation_queue.png)
...
![](images/create_annotation_queue_new.png)
...
![annotation queue rubric](images/create_annotation_rubric.png)

Reviewers will see this:

![rubric for annotators](images/rubric_for_annotators.png)
...
![](images/annotation_queue_edit.png)

## Assign runs to an annotation queue

To assign runs to an annotation queue, either:

1. Click on **Add to Annotation Queue** in top right corner of any trace view. You can add ANY intermediate run (span) of the trace to an annotation queue, not just the root span. ![](images/add_to_annotation_queue.png)

2. Select multiple runs in the runs table then click **Add to Annotation Queue** at the bottom of the page. ![](images/multi_select_annotation_queue.png)
...
4. Select one or multiple experiments from the dataset page and click **Annotate**. From the resulting popup, you may either create a new queue or add the runs to an existing one: ![](images/annotate_experiment.png)
