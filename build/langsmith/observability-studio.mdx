...
Define your [configuration](/oss/python/langgraph/graph-api-nodes#add-runtime-configuration) to specify prompt fields and their associated nodes using `langgraph_nodes` and `langgraph_type` keys.
