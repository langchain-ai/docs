...
Install the Vercel AI SDK. We use Vercel's OpenAI integration for the code snippets below, but you can use any of their other options as well.
...
# The belowe examples use OpenAI, but you can use any LLM provider of choice
...
The `traceable` return type is complex, which necessitates the cast. You can also omit the AI SDK `tool` wrapper function
