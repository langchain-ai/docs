---
title: LangSmith Engine notifications
sidebarTitle: Notifications
description: Send LangSmith Engine issue and run-failure notifications to Slack channels and webhook endpoints.
---
...
Notification destinations are configured per tracing project or agent environment. On the **Engine** page, click **Configure Engine**, then under **Notifications** click **+ Add destination**. For each destination, choose:
