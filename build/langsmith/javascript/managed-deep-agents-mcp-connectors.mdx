...
Connect a managed deep agent to remote [Model Context Protocol (MCP)](/oss/javascript/deepagents/mcp) servers to add their tools to the agent. Managed Deep Agents creates the MCP client and loads the tools.
