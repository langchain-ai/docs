...
For connection scopes, OAuth authorization interrupts, and custom tool examples, see [Manage connections](/langsmith/javascript/managed-deep-agents-connections).
