---
title: How to use multiple messages in the playground
sidebarTitle: Use multiple messages in the playground
---
...
![](images/multiturn_from_dataset.gif)
...
![](images/multiturn_manual_list.gif)
