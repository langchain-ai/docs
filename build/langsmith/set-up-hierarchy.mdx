...
For what changes when a workspace moves from tracing projects to agents and environments, refer to [Migrate to agent-based workspaces](/langsmith/migrate-to-agent-based-workspaces).
