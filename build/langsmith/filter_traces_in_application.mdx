...
<Tip>**Recommended reading**: It might be helpful to read the [Conceptual guide on tracing](../concepts) to gain familiarity with the concepts mentioned on this page.</Tip>
...
![Filter Shortcuts](images/filter_shortcuts.png)
...
![Filtering on time](images/filter_time.png)
...
![Filtering](images/filter_full_text.png)
...
![Filtering](images/search_kv_input.png)
...
![Filtering](images/search_kv_output.png)
...
![Filtering](images/search_kv_filter_shortcut.png)
...
![Filtering](images/search_kv_tool.png)
...
![Filtering](images/negative_filtering_1.png)
...
![Filtering](images/negative_filtering_2.png)
...
![Filtering](images/negative_filtering_3.png)
...
![Filtering](images/negative_filtering_4.png)
...
![Filtering](images/save_a_filter.png)
...
![Filtering](images/selecting_a_filter.png)
...
![Copy Filter](images/copy_filter.png)
...
![Filtering within trace view](images/filter_runs_in_trace_view.png)
...
![Raw Query](images/raw_query.png)
...
![Filtering](images/trace_filter.png)
...
![Filtering](images/child_runs.png)
...
![Filtering](images/search_kv_tool_tree.png)
