...
- **Evals**: Managed Deep Agents [evals](/langsmith/python/managed-deep-agents-evals) are Harbor evals under `evals/tasks/`. The `evals/` directory is not included in the deployed agent build.
