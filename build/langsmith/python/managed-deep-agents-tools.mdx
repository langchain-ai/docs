...
Custom tools are application code the agent can call. Unlike [instructions](/langsmith/python/managed-deep-agents-instructions) and [skills](/langsmith/python/managed-deep-agents-skills), MDA does not discover them automatically.
