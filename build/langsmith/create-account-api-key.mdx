...
Service keys can only be deleted, not deactivated or reactivated. Open the **Service** tab and select the trash icon in the **Actions** column to delete a service key.
