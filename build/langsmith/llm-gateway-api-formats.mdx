...
<Note>
Explicit caching support is a temporary measure while a gateway-level caching policy is being developed. The fields below are passed through to the upstream provider.
</Note>
