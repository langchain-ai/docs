...
<CardGroup cols={2}>
  <Card title="Identity" icon="fingerprint" href="/langsmith/managed-deep-agents-identity">
    Authenticate callers and scope threads, store access, and credentials.
  </Card>
  <Card title="Connectors" icon="plug" href="/langsmith/managed-deep-agents-connectors">
    Attach tools and capabilities, receive provider events, and reply on the conversation.
  </Card>
