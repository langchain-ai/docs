...
![Add trace with attachments to dataset](images/add_trace_with_attachments_to_dataset.png)
...
![Create example with attachments](images/create_example_with_attachments.png)

Once uploaded, you can view examples with attachments in the LangSmith UI. Each attachment will be rendered with a preview for easy inspection. ![Attachments with examples](images/attachments_with_examples.png)
...
![Adding multimodal variable](images/adding_multimodal_variable.gif)
...
![Attachment editing](images/attachment_editing.gif)
