...
For mount paths, sync behavior, sync limits, and mounting buckets and Git repositories alongside a repo, see [Sandbox mounts](/langsmith/sandbox-mounts#mount-a-context-hub-repo).
