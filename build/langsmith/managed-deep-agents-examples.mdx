...
description: An annotated Managed Deep Agents project that uses tools, middleware, schedules, skills, and a sandbox.
---
...
For the packaging rules behind this layout, see the [CLI project file reference](/langsmith/managed-deep-agents-cli#project-file-reference).
