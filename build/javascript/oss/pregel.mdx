...
<Tabs>
  ...
  <Tab title="Functional API">
    ...
    In the [Functional API](/oss/functional-api), you can use an [`entrypoint`](https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph.entrypoint.html) to create a Pregel application. The `entrypoint` decorator allows you to define a function that takes input and returns output.
