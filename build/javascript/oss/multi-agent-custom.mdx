...
See the multi-agent [supervisor](/oss/agent-supervisor#4-create-delegation-tasks) example for a full example of using [`Send()`](https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.Send.html) in handoffs.
