...
You can find a [list of all models that support tool calling](/oss/python/integrations/chat/).
...
To see how to invoke the tools, please refer to [how to use a model to call tools](/oss/python/how-to/tool_calling/).
:::
```
