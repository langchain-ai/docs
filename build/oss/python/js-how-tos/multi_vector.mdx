...
- [Text splitters](/oss/python/concepts/text_splitters)
...
- smaller chunks: split a document into smaller chunks, and embed those (e.g. the [`ParentDocumentRetriever`](/oss/python/how-to/parent_document_retriever))
...
Next, check out the individual sections for deeper dives on specific retrievers, the [broader tutorial on RAG](/oss/python/tutorials/rag), or this section to learn how to
