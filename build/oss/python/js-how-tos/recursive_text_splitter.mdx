...
Next, check out [specific techinques for splitting on code](/oss/python/how-to/code_splitter) or the [full tutorial on retrieval-augmented generation](/oss/python/tutorials/rag).
