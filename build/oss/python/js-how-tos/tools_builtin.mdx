...
For a complete list of available ready-made toolkits, visit [Integrations](/oss/python/integrations/toolkits/).
...
**[Built-In Tools](/oss/python/integrations/tools/)**: For a list of all built-in tools, see [this page](/oss/python/integrations/tools/)
    
**[Custom Tools](/oss/python/how-to/custom_tools)**: Although built-in tools are useful, it's highly likely that you'll have to define your own tools. See [this guide](/oss/python/how-to/custom_tools) for instructions on how to do so.
