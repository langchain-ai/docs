...
Next, check out some other retrieval how-to guides, such as how to [improve results using multiple embeddings per document](/oss/python/how-to/multi_vector)
or how to [create your own custom retriever](/oss/python/how-to/custom_retriever).
