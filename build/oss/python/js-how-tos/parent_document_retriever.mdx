...
This is a more specific form of [generating multiple embeddings per document](/oss/python/how-to/multi_vector).
...
Next, check out the more general form of [generating multiple embeddings per document](/oss/python/how-to/multi_vector), the [broader tutorial on RAG](/oss/python/tutorials/rag), or this section to learn how to
