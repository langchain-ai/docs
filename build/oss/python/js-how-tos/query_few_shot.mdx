...
- [Query analysis](/oss/python/tutorials/rag#query-analysis)
...
Let's take a look at how we can add examples for the LangChain YouTube video query analyzer we built in the [query analysis tutorial](/oss/python/tutorials/rag#query-analysis).
...
Next, check out some of the other query analysis guides in this section, like [how to deal with high cardinality data](/oss/python/how-to/query_high_cardinality).
