...
Please also see the section on [installing integration packages](/oss/python/how-to/installation/#installing-integration-packages)
...
when resolving direct dependencies, even if you don't intend this. See [this section on installing integration packages](/oss/python/how-to/installation/#installing-integration-packages)
...
They can be as specific as [`@langchain/anthropic`](/oss/python/integrations/platforms/anthropic/), which contains integrations just for Anthropic models,
