...
- [Configuring chain parameters at runtime](/oss/python/how-to/binding)
- [Prompt templates](/oss/python/concepts/prompt_templates)
- [Chat Messages](/oss/python/concepts/messages)
...
1. Conditionally return runnables from a [`RunnableLambda`](/oss/python/how-to/functions) (recommended)
...
Next, check out the other [how-to guides on runnables](/oss/python/how-to/#langchain-expression-language) in this section.
