...
- [Tool calling](/oss/python/concepts/tools)
...
`initChatModel` requires `langchain>=0.2.11`. See [this guide](/oss/python/how-to/installation/#installing-integration-packages) for some considerations to take when upgrading.
