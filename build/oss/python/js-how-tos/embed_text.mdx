...
<Info>
**Head to [Integrations](/oss/python/integrations/text_embedding) for documentation on built-in integrations with text embedding providers.**
...
Next, check out how to [avoid excessively recomputing embeddings with caching](/oss/python/how-to/caching_embeddings), or the [full tutorial on retrieval-augmented generation](/oss/python/tutorials/rag).
