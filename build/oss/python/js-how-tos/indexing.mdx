...
- [Retrieval-augmented generation (RAG)](/oss/python/tutorials/rag/)
...
Compatible Vectorstores: [`PGVector`](/oss/python/integrations/vectorstores/pgvector), [`Chroma`](/oss/python/integrations/vectorstores/chroma), [`CloudflareVectorize`](/oss/python/integrations/vectorstores/cloudflare_vectorize),
[`ElasticVectorSearch`](/oss/python/integrations/vectorstores/elasticsearch), [`FAISS`](/oss/python/integrations/vectorstores/faiss), [`MariaDB`](/oss/python/integrations/vectorstores/mariadb), [`MomentoVectorIndex`](/oss/python/integrations/vectorstores/momento_vector_index),
[`Pinecone`](/oss/python/integrations/vectorstores/pinecone), [`SupabaseVectorStore`](/oss/python/integrations/vectorstores/supabase), [`VercelPostgresVectorStore`](/oss/python/integrations/vectorstores/vercel_postgres),
[`Weaviate`](/oss/python/integrations/vectorstores/weaviate), [`Xata`](/oss/python/integrations/vectorstores/xata)
