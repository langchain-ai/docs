...
- [Question answering over SQL data](/oss/python/tutorials/sql_qa)
...
Next, check out some of the other guides in this section, like [how to validate queries](/oss/python/how-to/sql_query_checking).
You might also be interested in the query analysis guide [on handling high cardinality](/oss/python/how-to/query_high_cardinality).
