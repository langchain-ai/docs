...
Next, check out a [more advanced way of splitting by character](/oss/python/how-to/recursive_text_splitter), or the [full tutorial on retrieval-augmented generation](/oss/python/tutorials/rag).
