...
We'll also be using `chroma` for our vector store. Follow the instructions [here](/oss/python/integrations/vectorstores/chroma) to setup.
...
Next, check out the [broader tutorial on RAG](/oss/python/tutorials/rag), or this section to learn how to
