...
Another common use-case is tool calling. While you should generally use the [`.bindTools()`](/oss/python/how-to/tool_calling/) method for tool-calling models, you can also bind provider-specific args directly if you want lower level control:
...
Next, you might be interested in our how-to guides on [passing data through a chain](/oss/python/how-to/passthrough/).
