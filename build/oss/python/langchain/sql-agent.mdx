...
```
We can resume execution, in this case accepting the query, using [Command](/oss/python/langgraph/graph-api-send-command#combine-control-flow-and-state-updates-with-command):
