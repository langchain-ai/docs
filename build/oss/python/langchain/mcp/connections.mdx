...
import McpLifecycleShortJs from '/snippets/python/code-samples/mcp-lifecycle-short-js.mdx';
import McpMultiServerJs from '/snippets/python/code-samples/mcp-multi-server-js.mdx';
import McpProtocolErasJs from '/snippets/python/code-samples/mcp-protocol-eras-js.mdx';
