...
<Tip>
  Sign up for LangSmith to quickly spot issues and improve the performance of your LangGraph projects. [LangSmith](/langsmith/home) lets you use trace data to debug, test, and monitor your LLM apps built with LangGraph.
</Tip>
...
Check out [this guide](/langsmith/evaluate-graph) for evaluating LangGraph applications, including SQL agents like this one, using LangSmith.
