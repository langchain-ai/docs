...
<Warning>
    **Code-scan generated PRs are not allowed.** Submitting pull requests generated in bulk by automated code-scanning or static-analysis tools — whether for security findings, style fixes, or any other purpose — is considered a denial-of-service attack on maintainer bandwidth. We close all such PRs without review and may block accounts that submit them.
</Warning>
