...
Build a [retrieval](/oss/python/langchain/retrieval) agent with LangGraph that decides when to search a vector store versus answering the user directly.
...
- [Retrieval](/oss/python/langchain/retrieval) using
