...
![LangSmith Trace View](/oss/python/images/d38d1f2b-0f4c-4707-b531-a3c749de987f.png)

In addition, you will be able to filter traces after the fact using the tags or metadata provided. For example,

![LangSmith Filter View](/oss/python/images/410e0089-2ab8-46bb-a61a-827187fd46b3.png)
