...
This guide provides a quick overview for getting started with the `AlibabaCloudMySQL` [vector store](/oss/python/integrations/vectorstores#overview). For a detailed listing of all alibabacloud-mysql vector store features, parameters, and configurations, head to the [langchain-alibabacloud-mysql](https://github.com/wangkuahai/langchain-alibabacloud-mysql).
