...
This notebook provides a quick overview for getting started with ScrapeGraph [tools](/oss/python/integrations/tools/). For detailed documentation of all ScrapeGraph features and configurations head to the [API reference](https://python.langchain.com/docs/integrations/tools/scrapegraph).
...
### [Invoke directly with args](/oss/python/concepts/tools)
...
### [Invoke with ToolCall](/oss/python/concepts/tools)
