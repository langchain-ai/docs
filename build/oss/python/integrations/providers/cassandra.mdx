...
Learn more in the [example notebook](/oss/python/integrations/memory/cassandra_chat_message_history).
...
Learn more in the [example notebook](/oss/python/integrations/llm_caching#cassandra-caches) (scroll to the Cassandra section).
...
Learn more in the [example notebook](/oss/python/integrations/llm_caching#cassandra-caches) (scroll to the appropriate section).
