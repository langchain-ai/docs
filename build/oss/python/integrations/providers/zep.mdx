...
You can also find Zep Open Source compatible [Retriever](/oss/python/integrations/retrievers/zep_memorystore), [Vector Store](/oss/python/integrations/vectorstores/zep) and [Memory](/oss/python/integrations/memory/zep_memory) examples
...
See a [Perpetual Memory Example here](/oss/python/integrations/memory/zep_cloud_chat_message_history).
...
See a [Memory RAG Example here](/oss/python/integrations/memory/zep_memory_cloud).
