...
This will help you get started with the Zotero [retriever](/oss/python/deepagents/retrieval). For detailed documentation of all `ZoteroRetriever` features and configurations head to the [GitHub page](https://github.com/TimBMK/langchain-zotero-retriever).
