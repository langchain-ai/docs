...
This notebook provides a quick overview for getting started with Writer [chat](/oss/python/concepts/chat_models/).
...
### Model features
| [Tool calling](/oss/python/how-to/tool_calling) | Structured output | JSON mode | Image input | Audio input | Video input | [Token-level streaming](/oss/python/how-to/chat_streaming/) | Native async |         [Token usage](/oss/python/how-to/chat_token_usage_tracking/)          | Logprobs |
| :---: |:-----------------:| :---: | :---: |  :---: | :---: | :---: | :---: |:--------------------------------:|:--------:|
| ✅ |         ❌         | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ |                ✅                 |    ❌     |
