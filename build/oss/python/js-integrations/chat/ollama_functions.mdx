...
<Warning>
**The LangChain Ollama integration package has official support for tool calling. [Click here to view the documentation](/oss/python/integrations/chat/ollama#tools).**
...
- Chat model [conceptual guide](/oss/python/concepts/chat_models)
- Chat model [how-to guides](/oss/python/how-to/#chat-models)
