...
If you want a lighterweight solution, and the webpages you want to load do not require JavaScript to render, you can use the [`CheerioWebBaseLoader`](/oss/python/integrations/document_loaders/web_loaders/web_cheerio) instead.
