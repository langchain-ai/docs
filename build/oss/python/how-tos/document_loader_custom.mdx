...
The main abstractions for [Document Loading](/oss/python/concepts/document_loaders/) are:
...
page_content='Head to [Integrations](/oss/python/integrations/text_embedding/) for documentation on built-in integrations with text embedding model providers.
