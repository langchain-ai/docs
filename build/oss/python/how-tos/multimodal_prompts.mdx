...
Here we demonstrate how to use prompt templates to format [multimodal](/oss/python/concepts/multimodality/) inputs to models. 
...
Let's use this prompt to pass an image to a [chat model](/oss/python/concepts/chat_models/#multimodality):
