...
- [Tokens](/oss/python/concepts/tokens)

</Info>

Certain [chat models](/oss/python/concepts/chat_models/) can be configured to return token-level log probabilities representing the likelihood of a given token. This guide walks through how to get this information in LangChain.
...
Next, check out the other how-to guides chat models in this section, like [how to get a model to return structured output](/oss/python/how-to/structured_output) or [how to track token usage](/oss/python/how-to/chat_token_usage_tracking).
