...
Important LangChain primitives like [chat models](/oss/python/concepts/chat_models), [output parsers](/oss/python/concepts/output_parsers), [prompts](/oss/python/concepts/prompt_templates), [retrievers](/oss/python/concepts/retrievers), and [agents](/oss/python/concepts/agents) implement the LangChain [Runnable Interface](/oss/python/concepts/runnables).
...
<Info>
**For a higher-level overview of streaming techniques in LangChain, see [this section of the conceptual guide](/oss/python/concepts/streaming).**
...
Custom functions can be [designed to return generators](/oss/python/how-to/functions#streaming), which are able to operate on streams.
...
To learn more, check out the other how-to guides in this section, or the [conceptual guide on Langchain Expression Language](/oss/python/concepts/lcel/).
