...
<Note>
**`Embeddings` do not currently implement the [Runnable](/oss/python/concepts/runnables/) interface and are also **not** instances of pydantic `BaseModel`.**
