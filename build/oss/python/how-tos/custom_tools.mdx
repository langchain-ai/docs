...
When constructing an [agent](/oss/python/concepts/agents/), you will need to provide it with a list of [Tools](/oss/python/concepts/tools/) that it can use. Besides the actual function that is called, the Tool consists of several components:
...
1. Functions;
2. LangChain [Runnables](/oss/python/concepts/runnables);
...
See [this guide](/oss/python/how-to/convert_runnable_to_tool) for more detail.
