...
This [retriever](/oss/python/concepts/retrievers/) uses a combination of semantic [similarity](/oss/python/concepts/embedding_models/#measure-similarity) and a time decay.
