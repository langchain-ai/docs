...
Sometimes, a query analysis technique may allow for selection of which [retriever](/oss/python/concepts/retrievers/) to use. To use this, you will need to add some logic to select the retriever to do. We will show a simple example (using mock data) of how to do that.
