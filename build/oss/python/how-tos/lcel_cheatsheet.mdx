...
This is a quick reference for all the most important [LCEL](/oss/python/concepts/lcel/) primitives. For more advanced usage see the [LCEL how-to guides](/oss/python/how-to/#langchain-expression-language-lcel) and the [full API reference](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html).
