...
- [Using chat models to call tools](/oss/python/how-to/tool_calling)
- [Defining custom tools](/oss/python/how-to/custom_tools/)

</Info>

Some models are capable of [**tool calling**](/oss/python/concepts/tool_calling) - generating arguments that conform to a specific user-provided schema. This guide will demonstrate how to use those tool calls to actually call a function and properly pass the results back to the model.
