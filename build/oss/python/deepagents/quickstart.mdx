...
import ConnectDocsMcpPrompt from '/snippets/python/connect-docs-mcp-prompt.mdx';
import InstallLangchainSkillsPrompt from '/snippets/python/install-langchain-skills-prompt.mdx';
