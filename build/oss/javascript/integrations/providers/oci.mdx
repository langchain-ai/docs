...
See [chat](/oss/javascript/integrations/llms/oci_generative_ai), [complete](/oss/javascript/integrations/chat/oci_generative_ai), and [embedding](/oss/javascript/integrations/text_embedding/oci_generative_ai) usage examples.
...
See [chat](/oss/javascript/integrations/chat/oci_data_science) and [complete](/oss/javascript/integrations/llms/oci_model_deployment_endpoint) usage examples.
