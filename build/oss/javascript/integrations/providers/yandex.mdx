...
See a [usage example](/oss/javascript/integrations/llms/yandex).
...
See a [usage example](/oss/javascript/integrations/chat/yandex).
...
See a [usage example](/oss/javascript/integrations/text_embedding/yandex).
...
See a [usage example with OpenAIWhisperParser](/oss/javascript/integrations/document_loaders/youtube_audio).
