...
See [this notebook](/oss/javascript/integrations/tools/apify_actors) for example usage and a full example of a tool-calling agent with LangGraph in the [Apify LangGraph agent Actor template](https://apify.com/templates/python-langgraph).
...
For a more detailed walkthrough of this loader, see [this notebook](/oss/javascript/integrations/document_loaders/apify_dataset).
