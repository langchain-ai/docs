...
See a [usage example](/oss/javascript/integrations/document_loaders/larksuite/#load-from-document).
...
See a [usage example](/oss/javascript/integrations/document_loaders/larksuite/#load-from-wiki).
