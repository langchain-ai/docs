...
See a [usage example](/oss/javascript/integrations/document_loaders/huawei_obs_directory).
...
See a [usage example](/oss/javascript/integrations/document_loaders/huawei_obs_file).
