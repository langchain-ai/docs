...
See [detail configuration instructions](/oss/javascript/integrations/vectorstores/mongodb_atlas).
...
See a [usage example](/oss/javascript/integrations/vectorstores/mongodb_atlas).
...
The MongoDBAtlasSemanticCache inherits from `MongoDBAtlasVectorSearch` and needs an Atlas Vector Search Index defined to work. Please look at the [usage example](/oss/javascript/integrations/vectorstores/mongodb_atlas) on how to set up the index.
