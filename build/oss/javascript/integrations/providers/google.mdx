...
details in [this guide](/oss/javascript/integrations/chat/google_generative_ai).
...
See a [usage example](/oss/javascript/integrations/text_embedding/google_generative_ai).
...
Access the same Gemini models using the ([legacy](/oss/javascript/concepts/text_llms)) LLM
interface with the `GoogleGenerativeAI` class.

See a [usage example](/oss/javascript/integrations/llms/google_ai).
...
See a [usage example](/oss/javascript/integrations/chat/google_vertex_ai_palm).
...
See a [usage example](/oss/javascript/integrations/llms/google_vertex_ai_palm).
...
You can also use the ([legacy](/oss/javascript/concepts/text_llms)) string-in, string-out LLM
interface.
...
See a [usage example](/oss/javascript/integrations/llms/google_vertex_ai_palm#vertex-model-garden).
...
See a [usage example](/oss/javascript/integrations/text_embedding/google_vertex_ai_palm).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_alloydb).
...
See a [usage example](/oss/javascript/integrations/document_loaders/google_bigquery).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_bigtable).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_cloud_sql_mysql).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_cloud_sql_mssql).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_cloud_sql_pg).
...
See [directory usage example](/oss/javascript/integrations/document_loaders/google_cloud_storage_directory).
```python
from langchain_google_community import GCSDirectoryLoader
```

See [file usage example](/oss/javascript/integrations/document_loaders/google_cloud_storage_file).
```python
...
See [usage example](/oss/javascript/integrations/document_loaders/google_el_carro).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_firestore).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_datastore).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_memorystore_redis).
...
See [usage example](/oss/javascript/integrations/document_loaders/google_spanner).
...
See [usage example and authorization instructions](/oss/javascript/integrations/document_loaders/google_speech_to_text).
...
See a [usage example](/oss/javascript/integrations/document_transformers/google_docai).
...
See [usage example and authorization instructions](/oss/javascript/integrations/document_transformers/google_translate).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_alloydb).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_bigquery_vector_search).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_memorystore_redis).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_spanner).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_firestore).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_cloud_sql_mysql).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_cloud_sql_pg).
...
See a [usage example](/oss/javascript/integrations/vectorstores/google_vertex_ai_vector_search).
...
See [usage example](/oss/javascript/integrations/vectorstores/google_vertex_ai_vector_search/#optional--you-can-also-create-vectore-and-store-chunks-in-a-datastore).
...
See a [usage example](/oss/javascript/integrations/retrievers/google_vertex_ai_search).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_cloud_texttospeech).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_drive).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_finance).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_jobs).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_lens).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_places).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_scholar).
...
See [detailed notebook](/oss/javascript/integrations/tools/google_search).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/google_trends).
...
See [usage example and authorization instructions](/oss/javascript/integrations/tools/gmail).
...
See [usage example and setup instructions](/oss/javascript/integrations/tools/toolbox).
...
See [usage example](/oss/javascript/integrations/memory/google_alloydb).
...
See [usage example](/oss/javascript/integrations/memory/google_sql_pg).
...
See [usage example](/oss/javascript/integrations/memory/google_sql_mysql).
...
See [usage example](/oss/javascript/integrations/memory/google_sql_mssql).
...
See [usage example](/oss/javascript/integrations/memory/google_spanner).
...
See [usage example](/oss/javascript/integrations/memory/google_memorystore_redis).
...
See [usage example](/oss/javascript/integrations/memory/google_bigtable).
...
See [usage example](/oss/javascript/integrations/memory/google_firestore).
...
See [usage example](/oss/javascript/integrations/memory/google_firestore_datastore).
...
See [usage example](/oss/javascript/integrations/memory/google_el_carro).
...
See [usage example and authorization instructions](/oss/javascript/integrations/document_loaders/google_drive).
...
See a [usage example](/oss/javascript/integrations/vectorstores/scann).
...
See [usage example and authorization instructions](/oss/javascript/integrations/retrievers/google_drive).
...
See [usage example and authorization instructions](/oss/javascript/integrations/chat_loaders/gmail).
...
See [usage examples and authorization instructions](/oss/javascript/integrations/tools/searchapi).
...
See a [usage example and authorization instructions](/oss/javascript/integrations/tools/serpapi).
...
See a [usage example and authorization instructions](/oss/javascript/integrations/tools/google_serper).
...
See a [usage example](/oss/javascript/integrations/tools/youtube).
...
See [usage example and authorization instructions](/oss/javascript/integrations/document_loaders/youtube_audio).
...
See a [usage example](/oss/javascript/integrations/document_loaders/youtube_transcript).
