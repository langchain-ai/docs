...
See a [usage example running model on Intel CPU](/oss/javascript/integrations/text_embedding/ipex_llm).
See a [usage example running model on Intel GPU](/oss/javascript/integrations/text_embedding/ipex_llm_gpu).
...
See a [usage example](/oss/javascript/integrations/text_embedding/itrex).
