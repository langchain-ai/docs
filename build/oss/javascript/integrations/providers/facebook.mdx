...
See a [usage example](/oss/javascript/integrations/text_embedding/laser).
...
See a [usage example](/oss/javascript/integrations/document_loaders/facebook_chat).
...
See a [usage example](/oss/javascript/integrations/vectorstores/faiss).
...
See a [usage example](/oss/javascript/integrations/chat_loaders/facebook).
...
See a [usage example](/oss/javascript/integrations/chat_loaders/whatsapp).
