...
See [setup instructions](/oss/javascript/integrations/document_loaders/telegram).

## Document Loader

See a [usage example](/oss/javascript/integrations/document_loaders/telegram).
...
See a [usage example](/oss/javascript/integrations/chat_loaders/telegram).
