...
See a [usage example](/oss/javascript/integrations/vectorstores/docarray_hnsw).

```python
from langchain_community.vectorstores import DocArrayHnswSearch
```
See a [usage example](/oss/javascript/integrations/vectorstores/docarray_in_memory).
...
See a [usage example](/oss/javascript/integrations/retrievers/docarray_retriever).
