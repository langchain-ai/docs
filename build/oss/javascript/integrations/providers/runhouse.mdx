...
For a more detailed walkthrough of the Self-hosted LLMs, see [this notebook](/oss/javascript/integrations/llms/runhouse)
...
For a more detailed walkthrough of the Self-hosted Embeddings, see [this notebook](/oss/javascript/integrations/text_embedding/self-hosted)
