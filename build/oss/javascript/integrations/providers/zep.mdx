...
You can also find Zep Open Source compatible [Retriever](/oss/javascript/integrations/retrievers/zep_memorystore), [Vector Store](/oss/javascript/integrations/vectorstores/zep) and [Memory](/oss/javascript/integrations/memory/zep_memory) examples
...
See a [Perpetual Memory Example here](/oss/javascript/integrations/memory/zep_cloud_chat_message_history).
...
See a [Memory RAG Example here](/oss/javascript/integrations/memory/zep_memory_cloud).
...
See a [usage example](/oss/javascript/integrations/retrievers/zep_cloud_memorystore).
...
See a [usage example](/oss/javascript/integrations/vectorstores/zep_cloud).
