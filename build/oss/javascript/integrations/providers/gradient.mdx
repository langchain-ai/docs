...
See a [usage example](/oss/javascript/integrations/llms/gradient).
...
```
For a more detailed walkthrough of this, see [this notebook](/oss/javascript/integrations/text_embedding/gradient)
