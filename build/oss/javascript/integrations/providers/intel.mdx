...
See a [usage example](/oss/javascript/integrations/text_embedding/optimum_intel).
...
See a [usage example](/oss/javascript/integrations/llms/weight_only_quantization).
