...
See a [usage example](/oss/javascript/integrations/llms/yuan2).
...
See the [installation instructions](/oss/javascript/integrations/chat/yuan2/#setting-up-your-api-server).
...
pip install openai
```
See a [usage example](/oss/javascript/integrations/chat/yuan2).
