...
3. Once you have created a connection, you can use the `PsychicLoader` by following the [example notebook](/oss/javascript/integrations/document_loaders/psychic)
