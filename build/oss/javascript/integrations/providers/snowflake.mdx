...
[HuggingFaceEmbeddings](/oss/javascript/integrations/text_embedding/huggingfacehub) connector:
...
You can use the [`SnowflakeLoader`](/oss/javascript/integrations/document_loaders/snowflake)
