...
See a [usage example](/oss/javascript/integrations/vectorstores/couchbase).
...
See a [usage example](/oss/javascript/integrations/document_loaders/couchbase).
...
See a [usage example](/oss/javascript/integrations/llm_caching/#couchbase-caches).
...
The CouchbaseSemanticCache needs a Search Index defined to work. Please look at the [usage example](/oss/javascript/integrations/vectorstores/couchbase) on how to set up the index.
...
See a [usage example](/oss/javascript/integrations/memory/couchbase_chat_message_history).
