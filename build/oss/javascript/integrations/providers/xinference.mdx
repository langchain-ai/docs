...
[example for xinference LLMs](/oss/javascript/integrations/llms/xinference)

### Embeddings

Xinference also supports embedding queries and documents. See
[example for xinference embeddings](/oss/javascript/integrations/text_embedding/xinference)
