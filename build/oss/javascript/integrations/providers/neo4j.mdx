...
See a [usage example](/oss/javascript/integrations/vectorstores/neo4jvector)
...
See a [usage example](/oss/javascript/integrations/graphs/neo4j_cypher)
...
See a [usage example](/oss/javascript/integrations/graphs/diffbot)

## Memory

See a [usage example](/oss/javascript/integrations/memory/neo4j_chat_message_history).
