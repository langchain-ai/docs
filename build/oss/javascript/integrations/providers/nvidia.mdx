...
- **[`ChatNVIDIA` Model](/oss/javascript/integrations/chat/nvidia_ai_endpoints).**
- **[`NVIDIAEmbeddings` Model for RAG Workflows](/oss/javascript/integrations/text_embedding/nvidia_ai_endpoints).**
