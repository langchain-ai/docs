...
For a more detailed walkthrough of this wrapper, see [this notebook](/oss/javascript/integrations/tools/openweathermap).
...
For more information on tools, see [this page](/oss/javascript/how-to/tools_builtin).
