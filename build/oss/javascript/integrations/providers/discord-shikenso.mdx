...
Below is a snippet showing how you can read and send messages in Discord. For more details, see the [documentation for Discord tools](/oss/javascript/integrations/tools/discord).
...
`DiscordToolkit` groups multiple Discord-related tools into a single interface. For a usage example, see [the Discord toolkit docs](/oss/javascript/integrations/tools/discord).
