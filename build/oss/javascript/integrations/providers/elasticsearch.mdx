...
See a [usage example](/oss/javascript/integrations/text_embedding/elasticsearch).
...
See a [usage example](/oss/javascript/integrations/vectorstores/elasticsearch).
...
See a [usage example](/oss/javascript/integrations/retrievers/elasticsearch_retriever).
...
See a [usage example](/oss/javascript/integrations/retrievers/elastic_search_bm25).
...
See a [usage example](/oss/javascript/integrations/memory/elasticsearch_chat_message_history).
...
See a [usage example](/oss/javascript/integrations/llm_caching/#elasticsearch-caches).
...
See a [usage example](/oss/javascript/integrations/stores/elasticsearch).
