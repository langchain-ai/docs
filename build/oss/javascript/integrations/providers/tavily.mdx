...
See detail on available tools [tavily_search](/oss/javascript/integrations/tools/tavily_search) and [tavily_extract](/oss/javascript/integrations/tools/tavily_extract).
