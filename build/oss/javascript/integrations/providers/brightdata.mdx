...
- [BrightDataSERP](/oss/javascript/integrations/tools/brightdata_serp) - Search engine results collection with geo-targeting
- [BrightDataUnblocker](/oss/javascript/integrations/tools/brightdata_unlocker) - Access ANY public website that might be geo-restricted or bot-protected
- [BrightDataWebScraperAPI](/oss/javascript/integrations/tools/brightdata-webscraperapi) - Extract structured data from 100+ ppoular domains, e.g. Amazon product details and LinkedIn profiles
