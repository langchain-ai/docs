...
For a more detailed walkthrough of the Redis vectorstore wrapper, see [this notebook](/oss/javascript/integrations/vectorstores/redis).
...
For a detailed example of Redis to cache conversation message history, see [this notebook](/oss/javascript/integrations/memory/redis_chat_message_history).
