...
For a more detailed walkthrough of the SKLearnVectorStore wrapper, see [this notebook](/oss/javascript/integrations/vectorstores/sklearn).
...
See a [usage example](/oss/javascript/integrations/retrievers/svm).
