...
[Activeloop Deep Lake Self Query Retrieval](/oss/javascript/integrations/retrievers/self_query/activeloop_deeplake_self_query)
...
See a [usage example](/oss/javascript/integrations/vectorstores/activeloop_deeplake).
