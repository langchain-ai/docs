...
See a [usage example](/oss/javascript/integrations/callbacks/promptlayer).
...
See a [usage example](/oss/javascript/integrations/llms/promptlayer_openai).
...
See a [usage example](/oss/javascript/integrations/chat/promptlayer_chatopenai).
