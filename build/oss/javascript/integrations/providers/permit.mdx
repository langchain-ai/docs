...
See detail on available tools [here](/oss/javascript/integrations/tools/permit).

## Retrievers

See detail on available retrievers [here](/oss/javascript/integrations/retrievers/permit).
