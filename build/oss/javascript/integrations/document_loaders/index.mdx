...
See this guide for a starting point: [How to: load web pages](/oss/javascript/how-to/document_loader_web).
...
See this guide for a starting point: [How to: load PDF files](/oss/javascript/how-to/document_loader_pdf).
