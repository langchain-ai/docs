...
- [Retrievers](/oss/javascript/concepts/retrievers)
...
Below we create a compressor pipeline by first splitting raw webpage documents retrieved from the [Tavily web search API retriever](/oss/javascript/integrations/retrievers/tavily) into smaller chunks, then filtering based on relevance to the query.
...
See the individual sections for deeper dives on specific retrievers, the [broader tutorial on RAG](/oss/javascript/tutorials/rag), or this section to learn how to
[create your own custom retriever over any data source](/oss/javascript/how-to/custom_retriever/).
