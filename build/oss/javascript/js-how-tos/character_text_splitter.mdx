...
Next, check out a [more advanced way of splitting by character](/oss/javascript/how-to/recursive_text_splitter), or the [full tutorial on retrieval-augmented generation](/oss/javascript/tutorials/rag).
