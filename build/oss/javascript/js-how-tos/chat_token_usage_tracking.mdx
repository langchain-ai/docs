...
Next, check out the other how-to guides on chat models in this section, like [how to get a model to return structured output](/oss/javascript/how-to/structured_output) or [how to add caching to your chat models](/oss/javascript/how-to/chat_model_caching).
