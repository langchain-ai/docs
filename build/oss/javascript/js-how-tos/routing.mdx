...
- [Configuring chain parameters at runtime](/oss/javascript/how-to/binding)
- [Prompt templates](/oss/javascript/concepts/prompt_templates)
- [Chat Messages](/oss/javascript/concepts/messages)
...
1. Conditionally return runnables from a [`RunnableLambda`](/oss/javascript/how-to/functions) (recommended)
...
Next, check out the other [how-to guides on runnables](/oss/javascript/how-to/#langchain-expression-language) in this section.
