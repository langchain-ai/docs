...
- [LangChain Tools](/oss/javascript/concepts/tools)
...
If you want to see how to use the model-generated tool call to actually run a tool function [check out this guide](/oss/javascript/how-to/tool_results_pass_to_model/).
...
Tool calling is not universal, but is supported by many popular LLM providers, including [Anthropic](/oss/javascript/integrations/chat/anthropic/), 
[Cohere](/oss/javascript/integrations/chat/cohere/), [Google](/oss/javascript/integrations/chat/google_vertex_ai/), 
[Mistral](/oss/javascript/integrations/chat/mistral/), [OpenAI](/oss/javascript/integrations/chat/openai/), and even for locally-running models via [Ollama](/oss/javascript/integrations/chat/ollama/).

You can find a [list of all models that support tool calling here](/oss/javascript/integrations/chat/).
...
**Note:** If you are finding that the model does not call a desired tool for a given prompt, you can see [this guide on how to force the LLM to call a tool](/oss/javascript/how-to/tool_choice/) rather than letting it decide.
