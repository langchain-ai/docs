...
This functionality requires `@langchain/core>=0.2.16`. Please see here for a [guide on upgrading](/oss/javascript/how-to/installation/#installing-integration-packages).
...
```
We next create a pre-built [LangGraph agent](/oss/javascript/how-to/migrate_agent/) and provide it with the tool:
...
Going further, we can even create a tool from a full [RAG chain](/oss/javascript/tutorials/rag/):
...
- [How to: create custom tools](/oss/javascript/how-to/custom_tools)
- [How to: pass tool results back to model](/oss/javascript/how-to/tool_results_pass_to_model/)
