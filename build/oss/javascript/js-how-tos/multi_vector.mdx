...
- smaller chunks: split a document into smaller chunks, and embed those (e.g. the [`ParentDocumentRetriever`](/oss/javascript/how-to/parent_document_retriever))
...
Next, check out the individual sections for deeper dives on specific retrievers, the [broader tutorial on RAG](/oss/javascript/tutorials/rag), or this section to learn how to
