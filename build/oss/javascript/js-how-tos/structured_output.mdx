...
There are several strategies that models can use under the hood. For some of the most popular model providers, including [Anthropic](/oss/javascript/integrations/platforms/anthropic/), [Google VertexAI](/oss/javascript/integrations/platforms/google/), [Mistral](/oss/javascript/integrations/chat/mistral/), and [OpenAI](/oss/javascript/integrations/platforms/openai/) LangChain implements a common interface that abstracts away these strategies called `.withStructuredOutput`.
...
You can also use tool calling directly to allow the model to choose between options, if your chosen model supports it. This involves a bit more parsing and setup. See [this how-to guide](/oss/javascript/how-to/tool_calling/) for more details.
