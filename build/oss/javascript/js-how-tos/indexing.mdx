...
- [Retrieval-augmented generation (RAG)](/oss/javascript/tutorials/rag/)
...
Compatible Vectorstores: [`PGVector`](/oss/javascript/integrations/vectorstores/pgvector), [`Chroma`](/oss/javascript/integrations/vectorstores/chroma), [`CloudflareVectorize`](/oss/javascript/integrations/vectorstores/cloudflare_vectorize),
[`ElasticVectorSearch`](/oss/javascript/integrations/vectorstores/elasticsearch), [`FAISS`](/oss/javascript/integrations/vectorstores/faiss), [`MariaDB`](/oss/javascript/integrations/vectorstores/mariadb), [`MomentoVectorIndex`](/oss/javascript/integrations/vectorstores/momento_vector_index),
[`Pinecone`](/oss/javascript/integrations/vectorstores/pinecone), [`SupabaseVectorStore`](/oss/javascript/integrations/vectorstores/supabase), [`VercelPostgresVectorStore`](/oss/javascript/integrations/vectorstores/vercel_postgres),
[`Weaviate`](/oss/javascript/integrations/vectorstores/weaviate), [`Xata`](/oss/javascript/integrations/vectorstores/xata)
