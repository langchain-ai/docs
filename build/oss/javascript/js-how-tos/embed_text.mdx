...
<Info>
**Head to [Integrations](/oss/javascript/integrations/text_embedding) for documentation on built-in integrations with text embedding providers.**
...
Next, check out how to [avoid excessively recomputing embeddings with caching](/oss/javascript/how-to/caching_embeddings), or the [full tutorial on retrieval-augmented generation](/oss/javascript/tutorials/rag).
