...
Next, check out the other how-to guides in this section, such as [how to await callbacks in serverless environments](/oss/javascript/how-to/callbacks_serverless).
