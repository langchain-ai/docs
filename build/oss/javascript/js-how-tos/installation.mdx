...
Please also see the section on [installing integration packages](/oss/javascript/how-to/installation/#installing-integration-packages)
...
when resolving direct dependencies, even if you don't intend this. See [this section on installing integration packages](/oss/javascript/how-to/installation/#installing-integration-packages)
...
They can be as specific as [`@langchain/anthropic`](/oss/javascript/integrations/platforms/anthropic/), which contains integrations just for Anthropic models,
