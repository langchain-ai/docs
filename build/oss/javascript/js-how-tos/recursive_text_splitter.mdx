...
Next, check out [specific techinques for splitting on code](/oss/javascript/how-to/code_splitter) or the [full tutorial on retrieval-augmented generation](/oss/javascript/tutorials/rag).
