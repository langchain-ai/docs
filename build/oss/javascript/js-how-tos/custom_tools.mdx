...
Next, you might be interested in learning [how to use a chat model to call tools](/oss/javascript/how-to/tool_calling/).

You can also check out how to create your own [custom versions of other modules](/oss/javascript/how-to/#custom).
