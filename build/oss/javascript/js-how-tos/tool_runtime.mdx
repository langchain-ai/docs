...
You can find a [list of all models that support tool calling](/oss/javascript/integrations/chat/).
...
To see how to invoke the tools, please refer to [how to use a model to call tools](/oss/javascript/how-to/tool_calling/).
:::
```
