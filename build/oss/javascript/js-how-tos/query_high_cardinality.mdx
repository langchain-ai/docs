...
Instead, what we can do is create a [vector store index](/oss/javascript/concepts/vectorstores) over the relevant values and then query that for the N most relevant values,
...
Next, check out some of the other query analysis guides in this section, like [how to use few-shotting to improve performance](/oss/javascript/how-to/query_no_queries).
