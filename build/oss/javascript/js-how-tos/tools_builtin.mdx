...
For a complete list of available ready-made toolkits, visit [Integrations](/oss/javascript/integrations/toolkits/).
...
**[Built-In Tools](/oss/javascript/integrations/tools/)**: For a list of all built-in tools, see [this page](/oss/javascript/integrations/tools/)
    
**[Custom Tools](/oss/javascript/how-to/custom_tools)**: Although built-in tools are useful, it's highly likely that you'll have to define your own tools. See [this guide](/oss/javascript/how-to/custom_tools) for instructions on how to do so.
