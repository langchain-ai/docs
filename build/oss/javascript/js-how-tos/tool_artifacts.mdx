...
- [ToolMessage](/oss/javascript/concepts/messages/#toolmessage)
...
With a [tool-calling model](/oss/javascript/how-to/tool_calling/), we can easily use a model to call our Tool and generate ToolMessages:
...
- [Creating custom tools](/oss/javascript/how-to/custom_tools)
