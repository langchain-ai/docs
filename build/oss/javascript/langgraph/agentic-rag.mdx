...
Build a [retrieval](/oss/javascript/langchain/retrieval) agent with LangGraph that decides when to search a vector store versus answering the user directly.
...
- [Retrieval](/oss/javascript/langchain/retrieval) using
