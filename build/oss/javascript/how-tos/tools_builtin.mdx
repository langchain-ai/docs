...
- [LangChain Toolkits](/oss/javascript/concepts/tools)

</Info>

## Tools

LangChain has a large collection of 3rd party tools. Please visit [Tool Integrations](/oss/javascript/integrations/tools/) for a list of the available tools.
...
Let's try out the [Wikipedia integration](/oss/javascript/integrations/tools/wikipedia/).
