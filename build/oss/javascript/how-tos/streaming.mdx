...
Important LangChain primitives like [chat models](/oss/javascript/concepts/chat_models), [output parsers](/oss/javascript/concepts/output_parsers), [prompts](/oss/javascript/concepts/prompt_templates), [retrievers](/oss/javascript/concepts/retrievers), and [agents](/oss/javascript/concepts/agents) implement the LangChain [Runnable Interface](/oss/javascript/concepts/runnables).
...
<Info>
**For a higher-level overview of streaming techniques in LangChain, see [this section of the conceptual guide](/oss/javascript/concepts/streaming).**
...
Custom functions can be [designed to return generators](/oss/javascript/how-to/functions#streaming), which are able to operate on streams.
...
To learn more, check out the other how-to guides in this section, or the [conceptual guide on Langchain Expression Language](/oss/javascript/concepts/lcel/).
