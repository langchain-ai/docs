...
LangChain provides a user friendly interface for composing different parts of [prompts](/oss/javascript/concepts/prompt_templates/) together. You can do this with either string prompts or chat prompts. Constructing prompts this way allows for easy reuse of components.
