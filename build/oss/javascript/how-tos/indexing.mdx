...
The indexing API lets you load and keep in sync documents from any source into a [vector store](/oss/javascript/concepts/vectorstores/). Specifically, it helps:
