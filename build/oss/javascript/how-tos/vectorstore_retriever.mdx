...
A vector store retriever is a [retriever](/oss/javascript/concepts/retrievers/) that uses a [vector store](/oss/javascript/concepts/vectorstores/) to retrieve documents. It is a lightweight wrapper around the vector store class to make it conform to the retriever [interface](/oss/javascript/concepts/runnables/).
