...
- [Chatbots](/oss/javascript/concepts/messages)
...
For this guide, we'll be using a [tool calling agent](https://langchain-ai.github.io/langgraph/concepts/agentic_concepts/#tool-calling-agent) with a single tool for searching the web. The default will be powered by [Tavily](/oss/javascript/integrations/tools/tavily_search), but you can switch it out for any similar tool. The rest of this section will assume you're using Tavily.
...
First, let's initialize Tavily and an OpenAI [chat model](/oss/javascript/concepts/chat_models/) capable of tool calling:
