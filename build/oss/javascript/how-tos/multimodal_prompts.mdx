...
Here we demonstrate how to use prompt templates to format [multimodal](/oss/javascript/concepts/multimodality/) inputs to models. 
...
Let's use this prompt to pass an image to a [chat model](/oss/javascript/concepts/chat_models/#multimodality):
