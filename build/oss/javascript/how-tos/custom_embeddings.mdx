...
<Note>
**`Embeddings` do not currently implement the [Runnable](/oss/javascript/concepts/runnables/) interface and are also **not** instances of pydantic `BaseModel`.**
