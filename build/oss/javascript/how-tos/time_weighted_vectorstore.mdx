...
This [retriever](/oss/javascript/concepts/retrievers/) uses a combination of semantic [similarity](/oss/javascript/concepts/embedding_models/#measure-similarity) and a time decay.
