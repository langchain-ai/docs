...
We can also configure the individual retrievers at runtime using [configurable fields](/oss/javascript/how-to/configure). Below we update the "top-k" parameter for the FAISS retriever specifically:
