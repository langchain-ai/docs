...
When constructing an [agent](/oss/javascript/concepts/agents/), you will need to provide it with a list of [Tools](/oss/javascript/concepts/tools/) that it can use. Besides the actual function that is called, the Tool consists of several components:
...
1. Functions;
2. LangChain [Runnables](/oss/javascript/concepts/runnables);
...
See [this guide](/oss/javascript/how-to/convert_runnable_to_tool) for more detail.
