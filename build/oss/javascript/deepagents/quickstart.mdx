...
import ConnectDocsMcpPrompt from '/snippets/javascript/connect-docs-mcp-prompt.mdx';
import InstallLangchainSkillsPrompt from '/snippets/javascript/install-langchain-skills-prompt.mdx';
