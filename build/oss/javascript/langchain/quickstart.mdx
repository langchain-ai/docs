...
<CodeGroup>
    ```bash npm
    npm install langchain@next @langchain/anthropic@next zod
    ```

    ```bash pnpm
    pnpm add langchain@next @langchain/anthropic@next zod
    ```

    ```bash yarn
    yarn add langchain@next @langchain/anthropic@next zod
    ```

    ```bash bun
    bun add langchain@next @langchain/anthropic@next zod
    ```
</CodeGroup>
