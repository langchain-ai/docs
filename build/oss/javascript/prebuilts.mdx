...
import prebuiltsTable from '/snippets/prebuilts-table.mdx';
...
![Agent loop: the LLM selects tools and uses their outputs to fulfill a user request](/oss/javascript/images/agent.png)
