<CardGroup cols={2}>
  ...
  <Card title="Connectors" icon="plug-connected" href="/langsmith/javascript/managed-deep-agents-connectors">
    Attach remote MCP servers and load their tools at runtime.
  </Card>
