...
This will load the Studio UI connected to your live deployment, allowing you to create, read, and update the [threads](/oss/python/persistence#threads), [assistants](/langgraph-platform/assistants), and [memory](/oss/python/memory) in that deployment.

## Local development server

To test your locally running application using LangGraph Studio, ensure you have set up your application following [this local application quickstart](/langgraph-platform/local-server).
