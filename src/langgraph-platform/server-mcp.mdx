...
The [Model Context Protocol (MCP)](/langgraph-platform/server-mcp) is an open protocol for describing tools and data sources in a model-agnostic format, enabling LLMs to discover and use them via a structured API.
