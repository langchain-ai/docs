...
---
Before deploying, review the [conceptual guide for the Self-Hosted Data Plane](langgraph-self-hosted-data-plane) deployment option.
...
2. We provide you a [Helm chart](https://github.com/langchain-ai/helm/tree/main/charts/langgraph-dataplane) which you run to setup your Kubernetes cluster. This chart contains a few important components.
  1. `langgraph-listener`: This is a service that listens to LangChain's [control plane](langgraph-control-plane) for changes to your deployments and creates/updates downstream CRDs.
