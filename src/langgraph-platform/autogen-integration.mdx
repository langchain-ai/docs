...
* Enhanced features: Add [persistence](../concepts/persistence), [streaming](../concepts/streaming), [short and long-term memory](../concepts/memory) and more to your AutoGen agents.
* Multi-agent systems: Build [multi-agent systems](../concepts/multi_agent) where individual agents are built with different frameworks.
* Production deployment: Deploy your integrated solution to [LangGraph Platform](../concepts/langgraph_platform) for scalable production use.
