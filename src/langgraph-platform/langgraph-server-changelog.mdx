...
<a id="2025-09-26"></a>
## v0.4.29
- Ensured proper cleanup of pubsub connections for SSE streaming endpoints to prevent resource leaks.
- Introduced a new feature flag, `NEW_PERSISTENCE_ENABLED`, to utilize the updated Python ops layer with Go storage for improved CRUD operations.
