...
<Info>
  **Only for Self-Hosted Data Plane and Self-Hosted Control Plane**
  Custom Redis instances are only available for [Self-Hosted Data Plane](langgraph_self_hosted_data_plane) and [Self-Hosted Control Plane](langgraph_self_hosted_control_plane) deployments.
</Info>
...
See the [Python](../cloud/reference/sdk/python_sdk_ref/#langgraph_sdk.client.RunsClient.stream) and [JS/TS](https://langchain-ai.github.io/langgraphjs/reference/classes/sdk_client.RunsClient.html#stream) SDKs for more details on how to implement resumable streams.
