...
2. Click the **LangGraph Studio** button in the top right corner.
  LangGraph Studio will open to display your graph.
    ...
    ![Sample graph run in LangGraph Studio with a start, one node, and an end ](images/lg_studio.png "Sample graph run in LangGraph Studio")
...
* [LangGraph Platform overview](langgraph_platform)
