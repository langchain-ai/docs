...
|                                                                  | Plus                                                  | Enterprise                                          |
|------------------------------------------------------------------|-------------------------------------------------------|-----------------------------------------------------|
| Deployment Options                                               | Cloud SaaS                                         | <ul><li>Cloud SaaS</li><li>Self-Hosted Data Plane</li><li>Self-Hosted Full Platform</li><li>Standalone Container (Enterprise)</li></ul> |
