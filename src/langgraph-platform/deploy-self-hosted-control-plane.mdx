...
---
Before deploying, review the [conceptual guide for the Self-Hosted Control Plane](langgraph-self-hosted-control-plane) deployment option.
...
1. As part of configuring your Self-Hosted LangSmith instance, you enable the `langgraphPlatform` option. This will provision a few key resources.
  1. `listener`: This is a service that listens to the [control plane](langgraph-control-plane) for changes to your deployments and creates/updates downstream CRDs.
  ...
  4. `host-backend`: This is the [control plane](langgraph-control-plane).
...
6. You create a deployment from the [control plane UI](langgraph-control-plane#control-plane-ui).
