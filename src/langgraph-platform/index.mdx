...
* **[Deployment](/langgraph-platform/deployment-options)**: There are four ways to deploy on LangGraph Platform: [Cloud SaaS](/langgraph-platform/cloud), [Hybrid](/langgraph-platform/hybrid), [Self-Hosted Full Platform](/langgraph-platform/self-hosted-full-platform), and [Standalone Container](/langgraph-platform/standalone-container).
