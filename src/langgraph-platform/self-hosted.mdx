...
<Tip>
  To deploy a [LangGraph Server](/langgraph-platform/langgraph-server), follow the how-to guide for [how to deploy Standalone Server Only](/langgraph-platform/deploy-standalone-server-only).
</Tip>
