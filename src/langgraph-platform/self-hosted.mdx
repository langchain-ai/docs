...
<Tip>
  To deploy a [LangGraph Server](/langgraph-platform/langgraph-server), follow the how-to guide for [how to deploy a Data Plane Only](/langgraph-platform/deploy-data-plane-only).
</Tip>
