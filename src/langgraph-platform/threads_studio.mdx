...
3. To create a new thread, click `+ New Thread` and [submit a run](invoke_studio#graph-mode).
...
3. To create a new thread, click the plus button and [submit a run](invoke_studio#chat-mode).
