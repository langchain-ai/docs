...
<Tip>
  **Prerequisites**
  This guide assumes familiarity with the [LangGraph Platform](langgraph-platform), [Persistence](https://langchain-ai.github.io/langgraph/concepts/persistence/), and [Cross-thread persistence](https://langchain-ai.github.io/langgraph/concepts/persistence/#memory-store) concepts.
</Tip>
