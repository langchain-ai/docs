...
2. **[Standalone Container](/langgraph-platform/self-hosted#standalone-container)**: Deploy standalone instances of a LangGraph Server without the control plane UI
