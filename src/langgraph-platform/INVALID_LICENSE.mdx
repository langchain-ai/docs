...
If you would like a fast managed environment, consider the [Cloud SaaS](langgraph_cloud) deployment option. This requires no additional license key.

<a id="lite"></a>
#### For Standalone Container

If your deployment is unlikely to see more than 1 million node executions per year and don't need Crons and other enterprise features, consider the [Standalone Container](deployment_options) deployment option.
...
For more information on deployment options and their features, see the [Deployment Options](deployment_options) documentation.
