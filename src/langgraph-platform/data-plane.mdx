...
<Info>
  Custom Postgres instances are only available for [Self-Hosted Data Plane](/langgraph-platform/self-hosted-data-plane) and [Self-Hosted Full Platform](/langgraph-platform/self-hosted-full-platform) deployments.
</Info>
...
<Info>
  Custom Redis instances are only available for [Self-Hosted Data Plane](/langgraph-platform/self-hosted-data-plane) and [Self-Hosted Full Platform](/langgraph-platform/self-hosted-full-platform) deployments.
</Info>
...
| Cloud SaaS | Self-Hosted Data Plane | Self-Hosted Full Platform | Standalone Container |
|------------|------------------------|---------------------------|----------------------|
