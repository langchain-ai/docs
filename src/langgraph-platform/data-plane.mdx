...
<Info>
  Custom Postgres instances are only available for [Hybrid](/langgraph-platform/hybrid) and [Self-Hosted Full Platform](/langgraph-platform/self-hosted-full-platform) deployments.
</Info>
...
<Info>
  Custom Redis instances are only available for [Hybrid](/langgraph-platform/hybrid) and [Self-Hosted Full Platform](/langgraph-platform/self-hosted-full-platform) deployments.
</Info>
...
| Cloud SaaS | Hybrid | Self-Hosted Full Platform | Standalone Container |
|------------|------------------------|---------------------------|----------------------|
