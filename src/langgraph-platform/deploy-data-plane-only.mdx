---
title: How to deploy a data plane only
sidebarTitle: Deploy a data plane only
---
...
3. The following environment variables are needed for a data plane only deployment.
