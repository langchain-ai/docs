...
<Tip>
  **API reference**
  For detailed information on the API endpoints and data models, see [LangGraph Platform API reference docs](https://langchain-ai.github.io/langgraph/cloud/reference/api/api-ref.html).
</Tip>
...
| [Deployment options](deployment-options) | Standalone container | Cloud SaaS, Self-Hosted Data Plane, Self-Hosted Control Plane, Standalone container
...
If you're deploying using [LangGraph Platform](langgraph-cloud), these components are managed for you. If you're deploying LangGraph Server on your own infrastructure, you'll need to set up and manage these components yourself.
...
* The [LangGraph Platform API Reference](https://langchain-ai.github.io/langgraph/cloud/reference/api/api-ref.html) provides detailed information on the API endpoints and data models.
