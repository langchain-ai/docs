...
Select the assistant to run and click the "Active" toggle at the top of the modal to activate it. [See here](manage_assistants) for more information on managing assistants.
...
For more information on breakpoints see [here](human_in_the_loop).
