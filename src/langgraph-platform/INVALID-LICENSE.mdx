...
If you would like a fast managed environment, consider the [Cloud SaaS](langgraph-cloud) deployment option. This requires no additional license key.

<a id="lite"></a>
#### For Standalone Container

If your deployment is unlikely to see more than 1 million node executions per year and don't need Crons and other enterprise features, consider the [Standalone Container](deployment-options) deployment option.
