...
<Info>
  **Self-Hosted Deployment**
  Resources for [Self-Hosted Data Plane](/langgraph-platform/self-hosted-data-plane) and [Self-Hosted Full Platform](/langgraph-platform/self-hosted-full-platform) deployments can be fully customized. Deployment types are only applicable for [Cloud SaaS](/langgraph-platform/cloud) deployments.
</Info>
...
<Info>
  A custom Postgres instance can be configured for [Self-Hosted Data Plane](/langgraph-platform/self-hosted-data-plane) and [Self-Hosted Full Platform](/langgraph-platform/self-hosted-full-platform) deployments.
</Info>
