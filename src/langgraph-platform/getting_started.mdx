...
2. [Make conversations private](resource_auth) - Let users have private conversations
3. [Connect an authentication provider](add_auth_server) - Add real user accounts and validate using OAuth2 for production
...
Notice that your [authentication](https://langchain-ai.github.io/langgraph/cloud/reference/sdk/python_sdk_ref#langgraph_sdk.auth.Auth.authenticate) handler does two important things:
...
1. Continue the tutorial by going to [Make conversations private](resource_auth) to learn about resource authorization.
