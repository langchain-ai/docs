...
Currently, LangGraph only addresses this as part of [LangGraph Platform](langgraph_platform), not in the open source.
...
See the [how-to guide](reject_concurrent) for configuring the reject double text option.
...
See the [how-to guide](enqueue_concurrent) for configuring the enqueue double text option.
...
See the [how-to guide](interrupt_concurrent) for configuring the interrupt double text option.
...
See the [how-to guide](rollback_concurrent) for configuring the rollback double text option.
