...
| `skills` | Managed runtime, backed by Context Hub | `skills/**` in the project. See [Context Hub](/langsmith/managed-deep-agents-context-hub). |
| System prompt | Managed runtime, backed by Context Hub | `instructions.md` in the project. See [Context Hub](/langsmith/managed-deep-agents-context-hub). |
