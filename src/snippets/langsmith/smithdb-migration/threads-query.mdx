...
<Tabs>
  ...
  <Tab title="Java">
    <Note>Go and Java never had a dedicated thread-listing method. The closest legacy equivalent is the generic run query, manually grouped by the `thread_id` metadata convention.</Note>
