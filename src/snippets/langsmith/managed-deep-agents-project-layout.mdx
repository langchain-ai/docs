...
my-agent/
  ...
  identity.py | identity.ts                          # Optional: caller authentication and private threads
  ...
  channels/<name>.py | <name>.ts                     # External messaging channels
  slack-app-manifest.json                             # Optional: Slack app settings for --configure-slack
