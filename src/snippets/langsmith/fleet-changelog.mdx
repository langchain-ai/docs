...
- Agent Builder now displays supported schedules in your browser's local time while storing and evaluating them in UTC. Custom cron expressions and unsupported monthly schedules are explicitly labeled as UTC.
