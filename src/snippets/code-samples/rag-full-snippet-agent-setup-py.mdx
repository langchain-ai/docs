<CodeGroup>
    ...
    ```python Ollama
<<<<<<< HEAD:src/snippets/code-samples/rag-full-snippet-setup-py.mdx
...
=======
>>>>>>> 5ff34c86a (update langchain rag tutorial):src/snippets/code-samples/rag-full-snippet-agent-setup-py.mdx
    import bs4
    import requests
    from langchain.agents import create_agent
    from langchain.tools import tool
