...
When calling from a LangGraph agent, tokens are automatically scoped to your specific assistant:
...
When calling from standalone scripts or non-LangGraph agents:
