...
<div class="home-page mx-auto max-w-8xl px-0 lg:px-5" style={{ paddingBottom: "8rem" }}>
    <div class="mdx-content prose prose-gray dark:prose-invert mx-4 pt-10">
        ...
        <h2 class="flex whitespace-pre-wrap group font-semibold">Agents</h2>

        <CardGroup cols={3}>
            <Card title="Agents" icon="hierarchy" href="/langsmith/agents" cta="Learn more">
                The container LangSmith organizes your work around: the traces, datasets, and monitors of one application.
            </Card>
            <Card title="Environments" icon="stack" href="/langsmith/agent-environments" cta="Learn more">
                The four deployments an agent's traces divide into, and how to select one.
            </Card>
            <Card title="Navigate agents" icon="compass" href="/langsmith/navigate-agents" cta="Learn more">
