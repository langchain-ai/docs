...
<div class="home-page mx-auto max-w-8xl px-0 lg:px-5" style={{ paddingBottom: "8rem" }}>
    <div class="mdx-content prose prose-gray dark:prose-invert mx-4 pt-10">
        ...
        <CardGroup cols={2}>
            <Card title="LangSmith setup" icon="server" href="/langsmith/langsmith-setup-overview" cta="Get started">
                Core concepts, hosting on Cloud, BYOC, or Self-hosted, and account setup.
            </Card>
