...
To be alerted when a [watched issue](/langsmith/engine#watch-keep-an-eye-on-an-issue) recurs, click **Alert me via Slack** on the issue, which opens the same **Notifications** section.
