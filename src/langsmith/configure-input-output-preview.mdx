...
sidebarTitle: Configure input & output
---

By default, LangSmith automatically determines what to display in the **Input** and **Output** columns of your **Runs** table. However, you can customize exactly what appears in these columns by configuring custom preview paths for specific trace types.
...
- You have multiple trace types with different data structures.
...
1. Locate **Format** at the top of the runs table.
