...
<Info>
The [organization user role](/langsmith/rbac#organization-user) is only available in organizations on plans with multiple workspaces. In organizations limited to a single workspace, all users are [organization admins](/langsmith/rbac#organiazation-admin). Custom organization-scoped roles are not available.
</Info>
