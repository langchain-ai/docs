...
- GCP EU instance: `LANGSMITH_ENDPOINT=https://eu.api.smith.langchain.com`
- GCP APAC instance: `LANGSMITH_ENDPOINT=https://apac.api.smith.langchain.com`
- AWS US instance: `LANGSMITH_ENDPOINT=https://aws.api.smith.langchain.com`
