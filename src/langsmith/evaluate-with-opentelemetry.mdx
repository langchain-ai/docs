...
<CodeGroup>
```bash pip
pip install -qU langsmith strands-agents strands-agents-tools opentelemetry-sdk opentelemetry-exporter-otlp
```

```bash uv
uv add langsmith strands-agents strands-agents-tools opentelemetry-sdk opentelemetry-exporter-otlp
```
</CodeGroup>
