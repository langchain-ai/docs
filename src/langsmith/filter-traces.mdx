...
<img
    ...
    alt="The Shortcuts panel to the left of the runs table, listing Status, Run Name, Run Type, and Metadata groups with a checkbox beside each value, while the search bar above holds a total_cost greater than 0.1 clause"
/>
