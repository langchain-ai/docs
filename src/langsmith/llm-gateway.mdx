...
To route a single model instead of the whole process, or to see which integrations are supported, see [Use the gateway with LangChain](/langsmith/llm-gateway).
...
- [Use the gateway with LangChain](/langsmith/llm-gateway): route LangChain chat models and Deep Agents with an environment variable or a model prefix.
