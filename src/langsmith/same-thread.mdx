...
You'll see that the second agent will respond using information from the [checkpoint](/oss/langgraph/checkpointers#checkpoints) generated in the thread by the first agent as context.
