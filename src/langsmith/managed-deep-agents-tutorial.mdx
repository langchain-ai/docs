...
This tutorial continues from the [quickstart](/langsmith/managed-deep-agents-quickstart). Use the `research-assistant` project you created there, with your model, instructions, search tool, and a working `mda dev` setup.
