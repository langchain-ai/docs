...
<Note>
To create resource tags, you must have the [workspace admin](/langsmith/rbac#workspace-admin) role. Editors can apply **Application** tags to resources they have update access to, but creating tag keys or applying other tag types requires workspace admin permissions.
</Note>
