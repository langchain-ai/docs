...
You can rename an experiment immediately after running it by editing its name in the Playground table header. ![Edit name in playground](images/rename_in_playground.png)
...
![Edit name in experiments view](images/rename_in_experiments_view.png)