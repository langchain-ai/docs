...
Restricted egress limits sandbox connections to a LangSmith-managed allowlist of hosts and ports. Organizations that are not on an Enterprise plan use restricted egress by default, unless LangSmith has approved an exemption.
