...
For operational notes about supported models, thread retention, rate limits, SDK availability, and support channels during preview, see [Limits and notes](/langsmith/deploy-managed-deep-agent#limits-and-notes) in the deploy guide.
