...
**Enterprise only.** Private Service Connect is available exclusively for Enterprise customers. Contact your account team to enable this feature.
</Callout>
...
**Request access.** Contact your LangChain account team with your GCP project ID. LangChain will add your project to the service attachment's allowed consumer list.
