...
<Note>
This section is only relevant for cloud-managed LangSmith at [https://smith.langchain.com](https://smith.langchain.com), [https://eu.smith.langchain.com](https://eu.smith.langchain.com), [https://aws.smith.langchain.com](https://aws.smith.langchain.com), and [https://apac.smith.langchain.com](https://apac.smith.langchain.com).
...
| ----------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| URL                                 | [https://smith.langchain.com](https://smith.langchain.com)         | [https://eu.smith.langchain.com](https://eu.smith.langchain.com)         | [https://aws.smith.langchain.com](https://aws.smith.langchain.com)        | [https://apac.smith.langchain.com](https://apac.smith.langchain.com)             |
