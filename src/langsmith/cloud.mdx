...
<Note>
Traffic from agents deployed on LangSmith Deployment (LSD) egresses through a separate set of NAT IPs. For that list, refer to [Allowlist IP addresses](/langsmith/deploy-to-cloud#allowlist-ip-addresses) in the Cloud deployment guide.
</Note>
