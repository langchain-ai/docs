...
![Prompt Webhook Diagram](images/prompt-excalidraw.png)
...
2. Go to the **Prompts** section. Here you'll see a list of your prompts.
   ...
   ![LangSmith Prompts section](images/prompt-commit-main.png)
...
4. You'll be presented with a form to configure your webhook:
   ...
   ![LangSmith Webhook configuration modal](images/prompt-commit-webhook.png)
...
![Workflow Diagram showing: User saves prompt in LangSmith, LangSmith sends webhook to FastAPI Server, which interacts with GitHub to update files](images/prompt-sequence-diagram.png)
...
6. **Confirmation:** You should see the new commit appear in your GitHub repository.
   ...
   ![Manifest commited to Github](images/prompt-commit-github.png)
