...
![](images/metadata_edit_button.png)

Your prompt metadata will be updated upon save.

![](images/update_prompt_form.png)
...
![](images/edit_in_playground.png) 
![](images/prompt_playground_edit_commit.png)
