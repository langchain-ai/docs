...
<Note>
If your account is in a region other than GCP US (the default), also set `LANGSMITH_ENDPOINT` to the API URL for your region. Without this, requests fail with an authentication error.
