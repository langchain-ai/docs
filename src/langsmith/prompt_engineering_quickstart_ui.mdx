...
sidebarTitle: Prompt engineering (UI)
---
...
![Gif of the LangSmith UI Prompts section creating a chat-style prompt](images/create_prompt_ui.gif)
...
![Gif of the LangSmith UI selecting model configurations for testing prompts](images/test_prompt_ui.gif)
...
![Gif showing the UI for saving a prompt after testing](images/save_prompt_ui.gif)
...
![Gif showing the LangSmith UI creating a commit on a prompt](images/save_prompt_commit_ui.gif)

You can also tag specific commits to mark important moments in your commit history:

![Gif showing LangSmith UI tagging a specific commit with create tag](images/tag_prompt_ui.gif)
