...
[Managed Deep Agents](/langsmith/managed-deep-agents-overview) includes built-in web search powered by [Parallel](https://parallel.ai). Give your agent access to current information from the web to help answer questions.
