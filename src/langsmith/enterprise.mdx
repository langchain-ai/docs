...
description: LangSmith Enterprise features for deployment options, access control, data privacy, cost controls, and security compliance.
mode: wide
---

This page is a reference hub for enterprise teams. Use it to find documentation on the features that are important for your organization—from how LangSmith is [deployed](#deployment-options) and [who can access what](#access-control), to [how your data is handled](#data-privacy-&-pii) and how to stay in [control of costs](#cost-controls-&-usage).
