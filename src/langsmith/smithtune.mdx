...
If you already have a trajectory dataset, start at step 2.
...
1. Read the data rights and permitted use terms in the README, then acknowledge them before your first run:
