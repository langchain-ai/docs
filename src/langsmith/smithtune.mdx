...
<Tip>
To have your coding agent drive the fine-tuning process end to end, install the [Smithtune skill](https://github.com/langchain-ai/smithtune/blob/main/src/smithtune/skills/smithtune/SKILL.md) from the Smithtune repository.
</Tip>
