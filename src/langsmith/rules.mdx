...
![View automation rules](images/view_automation_rules.png)

## Create a rule

![](images/aq_spot_check_rule.gif)
...
Automation rule filters work the same way as filters applied to traces in the project. For more information on filters, you can refer to [this guide](./filter_traces_in_application)
