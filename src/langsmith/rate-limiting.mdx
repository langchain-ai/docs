...
See the `langchain` @[Python][BaseChatModel.with_retry] and [JS](https://reference.langchain.com/javascript/langchain-core/language_models/chat_models/BaseChatModel) API references for more.
