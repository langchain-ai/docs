...
- **Format Version** (optional): The format version to use for the parquet files. `"v2_beta"` has (1) enhanced datatypes for the columns and (2) a hive-compliant folder structure.
