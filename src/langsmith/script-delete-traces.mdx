...
This script issues DELETE mutations against multiple ClickHouse tables per batch. Large deletions can overwhelm ClickHouse and cause service disruption.
...
If you experience issues after a large deletion, contact support.
