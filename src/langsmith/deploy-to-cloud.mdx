...
<Tabs>
  <Tab title="LangSmith UI">
    ...
    1. Select a deployment type:
       - **Serverless**: Scales to zero after inactivity and works well for background, development, testing, and preview workloads.
...
- [Preview deployments](/langsmith/preview-deployments)
