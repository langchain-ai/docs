...
* [**Evaluators**](/langsmith/evaluation-overview#evaluators): Functions for scoring outputs. These can be [online evaluators](/langsmith/evaluation-overview#online-evaluation) that run on traces in real time or [offline evaluators](/langsmith/evaluation-overview#offline-evaluation) that run on a dataset.
