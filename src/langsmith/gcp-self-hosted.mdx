...
- <Icon icon="sparkles" /> **LLM integration:** Optionally proxy requests to [Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai) for LLM inference.
...
- Capture traces from LLM apps running on [Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai).
