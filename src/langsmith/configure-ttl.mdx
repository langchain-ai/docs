...
- `sweep_limit`: (_Agent server 0.8+_) Sets how many threads the sweeper processes in a single iteration. Defaults to `10000` (Agent server 0.11+) or `1000` (Agent server 0.8-0.10).
