...
In the [LangSmith UI](https://smith.langchain.com), open your agent and export it as a `.zip` file. Then drop the contents into the `fleet/` directory of your starter project:
