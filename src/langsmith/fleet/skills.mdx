...
- **Shared skills**: Shared with the workspace and listed on the [**Skills**](https://smith.langchain.com/agents/skills) page. Shared skills can be added to any agent in the workspace and stay in sync as they are updated. The general-purpose chat also has access to your workspace's shared skills automatically.
