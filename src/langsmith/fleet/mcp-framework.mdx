...
<Note>
If you're using [Agent Builder](/langsmith/fleet/index), you don't need to interact with the Tool Server directly. Agent Builder provides [built-in tools](/langsmith/fleet/tools) and supports [remote MCP servers](/langsmith/fleet/remote-mcp-servers) without requiring Tool Server setup.
