...
1. Click **Set identity** and select the identity you want to use.
    ...
    <Note>
    To use [channels](#channels), you must set the agent identity to **Fixed credentials**.
    </Note>
...
See [Channels and schedules](/langsmith/fleet/channels) for setup instructions and supported channel types.
