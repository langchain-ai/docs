...
Agent Builder includes [starter templates](https://www.langchain.com/templates) to help you create agents quickly. Templates include predefined instructions, [tools](/langsmith/fleet/tools), and [triggers](/langsmith/fleet/essentials#triggers) (if applicable) for common use cases. You can use templates as-is, or as a baseline to customize.

<Tip>
If you're new to Agent Builder, start with the step-by-step [quickstart](/langsmith/fleet/quickstart) to build your first agent using a template.
</Tip>
