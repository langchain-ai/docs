---
title: Templates
description: Start faster with curated Fleet templates and customize tools, prompts, and triggers.
---

LangSmith Fleet includes [starter templates](https://www.langchain.com/templates) to help you create agents quickly. Templates include predefined instructions, [tools](/langsmith/fleet/tools), and [triggers](/langsmith/fleet/essentials#triggers) (if applicable) for common use cases. You can use templates as-is, or as a baseline to customize.
