...
<Info>
The available templates may change over time. To see the current set, open **Templates** in Fleet or the [templates gallery](https://www.langchain.com/templates).
</Info>
