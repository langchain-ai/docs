...
| **Self-hosting** | ✅ [Beta](/langsmith/fleet/self-hosted), [contact sales](https://www.langchain.com/contact-sales) for production readiness details | ❌ | ❌ | ❌ |
...
| ------- | --------- | ----------------- | ---------------- | --------------------------- |
| Cloud-hosted | ✅ | ✅ | ✅ | ✅ |
| Self-hosted | ✅ [Beta](/langsmith/fleet/self-hosted), [contact sales](https://www.langchain.com/contact-sales) for production readiness details | ❌ | ❌ | ❌ |
