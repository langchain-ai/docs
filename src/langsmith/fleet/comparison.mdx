...
- [Deep Agents vs. Claude Agent SDK](/oss/deepagents/comparison) — compare the open-source agent harness that Fleet runs on with Anthropic's SDK.
- [LangChain vs. LangGraph vs. Deep Agents](/oss/concepts/products) — pick the right LangChain layer for code-first agent development.
