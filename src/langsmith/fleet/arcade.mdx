...
<Steps>
  <Step title="Open the Integrations tab">
    Navigate to [Fleet > Integrations](https://smith.langchain.com/agents/tools) and select **Arcade** in the left sidebar.
  </Step>
...
<Steps>
  ...
  <Step title="Connect your account">
    Navigate to [Fleet > Integrations](https://smith.langchain.com/agents/tools), select **Arcade** in the left sidebar, and click **Connect**. Complete the OAuth flow to link your Arcade account.
  </Step>
</Steps>
...
<Steps>
  <Step title="Open configuration">
    Select **Arcade** in the left sidebar of [Fleet > Integrations](https://smith.langchain.com/agents/tools), then click the settings icon to open the **Arcade Workspace Configuration** dialog.
  </Step>
...
To disconnect your personal Arcade account from the workspace, select **Arcade** in the left sidebar of the Integrations tab and click **Disconnect**. This revokes your OAuth token but does not affect the workspace configuration or other users.
