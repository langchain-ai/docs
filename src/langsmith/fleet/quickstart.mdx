...
<Steps>
  ...
  <Step title="Skip channel setup for now">
    When your agent ask you to "Connect the channels you want to use your agent in, like Slack or email.", click **Skip for now**. In a [later step](#3-customize-your-agent), you will connect channels.
  </Step>
