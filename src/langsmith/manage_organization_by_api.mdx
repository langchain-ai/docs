...
description: "LangSmith's API supports programmatic access via API key to all of the actions available in the UI, with only a few exceptions that are ."
---
...
### Membership management[​](#membership-management "Direct link to Membership management")
...
## User-Only Endpoints[​](#user-only-endpoints "Direct link to User-Only Endpoints")
