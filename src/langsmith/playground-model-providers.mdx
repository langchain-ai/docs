...
Before you use this model, ensure you have a [Google Cloud project](https://cloud.google.com/resource-manager/docs/creating-managing-projects) with the [Gemini Enterprise Agent Platform API enabled](https://cloud.google.com/vertex-ai/docs/start/client-libraries).
...
For the current list of available models, refer to the [Gemini Enterprise Agent Platform documentation](https://cloud.google.com/vertex-ai/docs/generative-ai/models).
