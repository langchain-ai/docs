...
In Java use `Evaluation.evaluateAsync()` for non-blocking evaluation. Requires `com.langchain.smith:langsmith-java:0.1.0-beta.11` or later.
...
Function<Map<String, Object>, Map<String, Object>> toxicityClassifier =
    Tracing.traceFunction(
        ...
        TraceConfig.builder().name("toxicity_classifier").build());
```
...
- Java: Requires `com.langchain.smith:langsmith-java:0.1.0-beta.11`
