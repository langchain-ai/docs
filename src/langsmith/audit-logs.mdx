...
| **SSO & authentication** | `create_sso_settings`, `update_sso_settings`, `delete_sso_settings`, `update_login_methods`, `get_sso_settings`, `get_sso_settings_current`, `get_login_methods`, `send_sso_email_confirmation`, `confirm_sso_user_email`, `login` |
...
| **Examples** | `create_example`, `create_examples`, `update_example`, `update_examples`, `delete_example`, `delete_examples`, `read_example`, `read_examples`, `get_example`, `list_examples`, `count_examples`, `sync_examples`, `validate_example`, `validate_examples` |
