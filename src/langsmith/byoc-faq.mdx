...
Yes. With [Bring your own VPC (BYOVPC)](/langsmith/byoc-byovpc), you supply a VPC and subnets. You can create the VPC with the [reference Terraform module](https://github.com/langchain-ai/terraform/tree/main/modules/byoc/aws/byovpc) or use an existing VPC that meets the network requirements. Supply public subnets as well if you require public load balancers.
