...
## Tools that use OAuth (no workspace secret)

Some tools authenticate via OAuth rather than workspace secrets. Configure these providers in your workspace Integrations/OAuth settings.
