...
<CodeGroup>
```bash pip
pip install -qU "langsmith[claude-agent-sdk]" langgraph "langgraph-cli[inmem]"
```

```bash uv
uv add "langsmith[claude-agent-sdk]" langgraph "langgraph-cli[inmem]"
```
</CodeGroup>
...
<CodeGroup>
```bash pip
pip install -qU strands-agents strands-agents-tools langgraph "langsmith[strands-agents]" "langgraph-cli[inmem]"
```

```bash uv
uv add strands-agents strands-agents-tools langgraph "langsmith[strands-agents]" "langgraph-cli[inmem]"
```
</CodeGroup>
...
<CodeGroup>
```bash pip
pip install -qU crewai langgraph langsmith opentelemetry-instrumentation-crewai opentelemetry-instrumentation-openai "langgraph-cli[inmem]"
```

```bash uv
uv add crewai langgraph langsmith opentelemetry-instrumentation-crewai opentelemetry-instrumentation-openai "langgraph-cli[inmem]"
```
</CodeGroup>
...
<CodeGroup>
```bash pip
pip install -qU autogen-agentchat autogen-ext langgraph langsmith opentelemetry-instrumentation-openai "langgraph-cli[inmem]"
```

```bash uv
uv add autogen-agentchat autogen-ext langgraph langsmith opentelemetry-instrumentation-openai "langgraph-cli[inmem]"
```
</CodeGroup>
