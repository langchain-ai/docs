...
### General Notes
- v0.10.0rc1 includes breaking changes for security and correctness. See Security section below for more details.
...
### General Notes
- v0.9.0 is the stable promotion of the v0.9.0rc line, including the previously announced v0.9.0rc1 features: delta channels, event streaming APIs, cron metadata filtering, and checkpointer pool tuning.
- Includes dependency and security maintenance updates.
</Update>
