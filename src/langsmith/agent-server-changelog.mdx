...
- Hardened baggage header parsing to prevent crashes when encountering malformed entries.
- Guarded system IDs in run metadata to close security gaps and ensure proper handling of server-set keys.
</Update>
