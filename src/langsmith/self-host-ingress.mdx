...
* *Subdomain (optional)*: If you would like to serve LangSmith under a URL path, you can specify it here. For example, adding `"langsmith"` will serve the application at `"example.hostname.com/langsmith"`.
