...
<Info>
Billing telemetry **cannot be disabled**. If you need to run without any egress, contact our sales team about an offline (air-gapped) license.
</Info>
