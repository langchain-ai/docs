...
- **Observability and evaluation**
    ...
    - **Annotation queues**: Add RUN and THREAD items via `POST /items`. Item APIs are now public and work from the SDKs, plus minimum thread idle time and ABAC support for `annotation-queues:*` permissions.
