...
- Resolved multiple bugs and performance issues in the Agent Builder, including writing self-hosted agent builder runs to a single project and collapsing subagent tool cards by default.
...
- Optimized the agent builder to reduce network calls.
