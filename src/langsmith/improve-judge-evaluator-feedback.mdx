...
<Check>
  ...
  * [Evaluation concepts](/evaluation/concepts#evaluators)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| In order to get started, you need a [dataset](/evaluation/concepts#datasets) with at least one [experiment](/evaluation/concepts#experiment) You'll need to upload or create datasets via the [SDK](/evaluation/how_to_guides/manage_datasets_programmatically#create-a-dataset) or the [UI](/evaluation/how_to_guides/manage_datasets_in_application#set-up-your-dataset) and run an experiment via the [SDK](/evaluation/how_to_guides/evaluate_llm_application#run-the-evaluation) or the [Playground](/evaluation?mode=ui#5-run-your-evaluation) | In order to get started, you need an application that’s already sending traces to LangSmith. Configure one of our [tracing integrations](/observability/how_to_guides#integrations) to start |
...
![Add to evaluator queue](images/add_to_evaluator_queue.gif)
...
![Evaluator Playground](images/evaluator_pg.gif)
...
![Evaluator Playground](images/alignment_evaluator_pg.gif)
...
![Enable reasoning](images/enable_reasoning.gif)
