...
**+ Agent** above the agent list also reaches this form. It opens the **New Agent** panel, whose **Builder** option, "Build with AI inside LangSmith", opens this tab on a blank form. For the panel's other three options, see [Create an agent](/langsmith/navigate-agents#create-an-agent).
