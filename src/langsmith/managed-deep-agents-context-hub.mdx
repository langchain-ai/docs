...
For the full deploy step list and flags, see the [CLI reference](/langsmith/managed-deep-agents-cli#deploy-projects). For secrets routing and deploy options, see [Deploy an agent](/langsmith/managed-deep-agents-deploy).
