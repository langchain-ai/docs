...
Gateway-proxied LLM calls always land in a fixed `gateway` project, as well as a API-key specific project with the scheme `gateway-<short_api_key>-<api_key_id>`.
