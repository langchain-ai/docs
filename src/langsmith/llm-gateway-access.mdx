...
On any Data Protection policy, you can turn on tracing to save content of your LLM call. When tracing is turned off on a policy, the trace is still charged against your usage totals.
