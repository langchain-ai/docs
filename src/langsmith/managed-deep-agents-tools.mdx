...
Custom tools are application code the agent can call. Unlike [instructions](/langsmith/managed-deep-agents-instructions) and [skills](/langsmith/managed-deep-agents-skills), Managed Deep Agents does not discover them automatically.
