...
Custom tools are application code the agent can call. Unlike [instructions](/langsmith/managed-deep-agents-instructions) and [skills](/langsmith/managed-deep-agents-skills), MDA does not discover them automatically.
