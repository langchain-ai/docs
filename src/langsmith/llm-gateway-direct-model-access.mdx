...
[Gateway Credits models](/langsmith/llm-gateway-langchain-provider) use the standard endpoint rather than a provider-specific path. These hosted models require no provider secret of your own.
