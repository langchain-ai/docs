...
<Steps>
  ...
  <Step title="Configure OAuth provider in LangSmith">
    In LangSmith, go to **Settings > OAuth Providers** and add a new provider:
    - **Name**: For example, `Salesforce`
    - **Provider ID**: Unique string, for example: `salesforce`
    ...
    - **Provider Type**: `salesforce` {/* TODO confirm exact value in Fleet provider registry */}
    - **Token endpoint auth method**: `client_secret_post` {/* TODO confirm */}
