...
Storing a credential to use across your Managed Deep Agents takes one command:
...
The rest of this page covers the two choices around those steps: who owns the credential, and how the service authenticates. Deploy fails when the project declares a connection that is missing from the workspace.
