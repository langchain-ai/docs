...
Add the server in `tools/mcp.py` or `tools/mcp.ts` and reference the connection slug. For more information, see [Connect to MCP servers](/langsmith/managed-deep-agents-mcp-connectors).
