...
The metadata keys and values will appear on all runs in LangSmith and can be used to filter and search traces.
...
<Tip>
Using `CC_LANGSMITH_METADATA` in CI lets you correlate traces back to specific PRs, commits, and authors in LangSmith.
</Tip>
