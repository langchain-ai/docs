...
Muting lets you suppress input/output content and unsafe metadata from traces on a per-thread basis, without disabling tracing entirely. Muting is off by default unless you configure a default below.
