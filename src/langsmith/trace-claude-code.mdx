...
For more information on replicas, see the [LangSmith documentation](/langsmith/log-traces-to-project).

Set `CC_LANGSMITH_RUNS_ENDPOINTS` to a JSON array of replica configurations. This overrides other client settings.
