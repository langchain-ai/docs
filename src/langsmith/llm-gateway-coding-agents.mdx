...
- For bring-your-own-key models, your workspace has the corresponding provider secret. [Gateway Credits models](/langsmith/llm-gateway-langchain-provider) do not require a provider secret.
...
- [Gateway Credits](/langsmith/llm-gateway-langchain-provider): call hosted models without a provider secret.
