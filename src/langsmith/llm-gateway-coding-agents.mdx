...
- Codex CLI
- Gemini CLI
- Cursor (partial support—OpenAI-model traffic only)
- Deep Agents

## Environment variables

All CLI coding agents read from the same shared set of environment variables. Export these in your terminal or add them to ~/.zshrc to persist across sessions:
...
No extra configuration beyond the [environment variables](#environment-variables). For details, refer to the [provider selection docs](/oss/deepagents/cli/providers#provider-reference). Run:
