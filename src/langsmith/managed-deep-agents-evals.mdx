...
MDA can generate a Harbor task from an instruction and a Python or TypeScript test. Run the following command from the Managed Deep Agents project root:
...
The command creates one of the following layouts:
