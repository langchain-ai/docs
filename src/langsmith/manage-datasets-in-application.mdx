...
<Note>
**Add to Dataset** is available for **run** queue items only. [Thread](/langsmith/observability-concepts#threads) items in an annotation queue support rubric feedback and notes, but not dataset export.
</Note>
