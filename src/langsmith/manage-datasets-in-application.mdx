...
If you have a [schema](#create-a-dataset-schema) defined on your dataset, when you click **+ Example** there is an option to <Icon icon="sparkles"/> **Add AI-Generated Examples**. This will use an LLM to create [synthetic](/langsmith/evaluation-concepts#synthetic-data) examples.

In **Generate examples**, do the following:

1. Ensure you've entered your OpenAI API key. Select **API Key** to enter.
...
1. Click **Generate**.
    ...
    ![Generate Synthetic Examples](/langsmith/images/generate-synthetic-examples-create.png)
...
![Generate Synthetic Examples](/langsmith/images/generate-synthetic-examples-pane.png)
