...
An MCP connector adds tools from remote [Model Context Protocol (MCP)](/oss/deepagents/mcp) servers to a managed deep agent. MDA creates the MCP client, loads the tools, and adds them to the agent.
