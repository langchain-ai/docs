...
For connection options, see [Manage connections](/langsmith/managed-deep-agents-connections).
...
| **[MCP endpoint](/langsmith/managed-deep-agents-mcp-endpoint)** | Deployment API | Exposes the agent as a tool to MCP clients |
