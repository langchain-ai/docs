...
The `notion` server uses a user-owned OAuth connection. Create the connection before deployment:
...
For connection scopes, OAuth authorization interrupts, and custom tool examples, see [Manage connections](/langsmith/managed-deep-agents-connections).
