...
- TypeScript: [`ChatPromptTemplate.fromMessages(...)`](https://docs.langchain.com/oss/javascript/reference/overview) → [`client.pushPrompt(...)`](https://docs.smith.langchain.com/reference/js/classes/client.Client#pushprompt)
