...
Run data fields are split between the managed ClickHouse database and your cloud object storage (e.g., S3 or GCS). The table details each run field and where it is stored:
