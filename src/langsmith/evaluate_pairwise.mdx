...
sidebarTitle: Run a pairwise evaluation
---

<Info>
  Concept: [Pairwise evaluations](/evaluation/concepts#pairwise)
</Info>
...
* If you haven't already created experiments to compare, check out the [quick start](/evaluation/) or the [how-to guide](/evaluation/how_to_guides/evaluate_llm_application) to get started with evaluations.
...
![Pairwise Experiments Tab](images/pairwise_from_dataset.png)

Click on a pairwise experiment that you would like to inspect, and you will be brought to the Comparison View:

![Pairwise Comparison View](images/pairwise_comparison_view.png)
...
![Pairwise Filtering](images/filter_pairwise.png)