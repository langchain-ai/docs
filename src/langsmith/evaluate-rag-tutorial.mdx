...
<CodeGroup>
```bash pip
pip install -qU langsmith langchain[openai] langchain-text-splitters bs4 requests
```

```bash uv
uv add langsmith langchain[openai] langchain-text-splitters bs4 requests
```
</CodeGroup>
