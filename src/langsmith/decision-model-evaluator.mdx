...
On a dataset, the default questions compare the run's output to the reference output, for example "Does the output semantically match the reference output?" To use them, map the reference output into the state.
