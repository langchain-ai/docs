...
By default, users can create Personal Access Tokens (PATs) in any organization. For self-hosted customers, an admin may want to globally disable PAT creation across all organizations. This feature flag allows an admin to prevent users from creating new PATs in any organization on the instance.
