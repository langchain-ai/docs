...
To configure webhook subscriptions, open the **Engine Settings** panel on the **Engine** tab of a tracing project or agent environment. See [Configure Engine](/langsmith/engine#configure-engine).
