...
:::python
In Python, `context.channel` is a dictionary. Check the context type before reading it, because direct API runs use an application-defined context.
...
| Direct API run | Whoever your [identity](/langsmith/managed-deep-agents-identity) provider authenticates as a person |
...
For how memory relates to deploy-owned instructions and skills in Context Hub, see [Context Hub](/langsmith/managed-deep-agents-context-hub).
