...
1. In the LangSmith sidebar, click **LLM Gateway** and select **Model Access**.
1. Click **Create model access**.
1. Enter a policy name.
1. Under **Applies to**, select the subject tier (organization, workspace, user, or API key). For any tier other than organization, select the subjects the policy covers.
1. Under **Allowed providers and models**, set each provider to **All models** or **Selected models**.
1. Click **Create model access**.
