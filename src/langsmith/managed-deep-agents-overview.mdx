...
%%{init: {"theme": "base", "flowchart": {"nodeSpacing": 24, "rankSpacing": 40, "padding": 8, "curve": "basis"}, "themeVariables": {"fontSize": "13px", "lineColor": "#40668D", "primaryColor": "#E5F4FF", "primaryTextColor": "#030710", "primaryBorderColor": "#006DDD"}}}%%
flowchart LR
    subgraph you["<b>You provide</b>"]
        Logic(["<b>Business logic</b><br/><div style='text-align:left'><ul style='margin:4px 0 0 0;padding-left:18px'><li>Instructions</li><li>Tools</li><li>Skills</li><li>Model</li></ul></div>"])
    end
    subgraph mda["<b>Managed Deep Agents</b>"]
        direction TB
        Harness("<b>Deep Agents harness</b><br/><div style='text-align:left'><ul style='margin:4px 0 0 0;padding-left:18px'><li>Agent loop</li><li>Filesystem</li><li>Subagents</li></ul></div>")
        Runtime("<b>Managed runtime</b><br/><div style='text-align:left'><ul style='margin:4px 0 0 0;padding-left:18px'><li>Agent Server</li><li>Sandboxes</li><li>Schedules</li></ul></div>")
        Harness --> Runtime
    end
    ...
    style you fill:none,stroke:#40668D,stroke-width:1px,stroke-dasharray:4 3,color:#2F4B68
    style mda fill:none,stroke:#40668D,stroke-width:1px,stroke-dasharray:4 3,color:#2F4B68
```
