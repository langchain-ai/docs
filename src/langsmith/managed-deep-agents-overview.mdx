...
%%{init: {"theme": "base", "flowchart": {"nodeSpacing": 40, "rankSpacing": 60, "padding": 16, "curve": "basis", "htmlLabels": true}, "themeVariables": {"fontSize": "13px", "fontFamily": "Inter, system-ui, sans-serif", "lineColor": "#40668D", "primaryColor": "#E5F4FF", "primaryTextColor": "#0A2540", "primaryBorderColor": "#006DDD"}}}%%
flowchart LR
    subgraph you["<b>You provide</b>"]
        Logic["<b>Business logic</b><br/>• Instructions<br/>• Tools<br/>• Skills<br/>• Model"]
    end
    subgraph mda["<b>Managed Deep Agents</b>"]
        direction TB
        Harness["<b>Deep Agents harness</b><br/>• Agent loop<br/>• Filesystem<br/>• Subagents"]
        Runtime["<b>Managed runtime</b><br/>• Agent Server<br/>• Sandboxes<br/>• Schedules"]
        Harness --> Runtime
    end

    Logic --> mda

    classDef tint    fill:#F2FAFF,stroke:#40668D,stroke-width:1.5px,color:#0A2540
    classDef primary fill:#E5F4FF,stroke:#006DDD,stroke-width:2px,color:#0A2540
    classDef deep    fill:#CFE6FA,stroke:#0A4C8C,stroke-width:2px,color:#0A2540

    class Logic tint
    class Harness primary
    class Runtime deep

    style you fill:none,stroke:#40668D,stroke-width:1px,stroke-dasharray:4 3,color:#0A2540
    style mda fill:none,stroke:#40668D,stroke-width:1px,stroke-dasharray:4 3,color:#0A2540
```
