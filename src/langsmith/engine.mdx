...
- **Preview deployments**: Set the baseline deployment Engine replays issue traces against, and turn on fix verification with preview deployments. See [Validate issues and fixes with experiments](/langsmith/engine-experiments).
...
- [Validate issues and fixes with experiments](/langsmith/engine-experiments): Replay an issue's traces against your deployment and verify Engine's fix on a preview deployment.
