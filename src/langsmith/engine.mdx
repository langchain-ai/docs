...
<Tip>
  To turn off Engine, toggle the same **Enable Engine** setting to off. This will stop all automatic runs of Engine and discontinue future billing in your account.
</Tip>
