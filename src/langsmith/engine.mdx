...
<Note>LangSmith Engine uses **LangChain-managed inference** exclusively. Bring Your Own Key (BYOK) is not supported — you cannot supply your own provider API keys for Engine.</Note>
