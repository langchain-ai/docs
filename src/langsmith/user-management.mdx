...
1. In your IdP: Configure a SAML application with the following details, then copy the metadata URL or XML for step 3.
   ...
   1. Single sign-on URL (or ACS URL):
      - GCP US: [https://auth.langchain.com/auth/v1/sso/saml/acs](https://auth.langchain.com/auth/v1/sso/saml/acs)
      - GCP EU: [https://eu.auth.langchain.com/auth/v1/sso/saml/acs](https://eu.auth.langchain.com/auth/v1/sso/saml/acs)
      - GCP APAC: [https://apac.auth.langchain.com/auth/v1/sso/saml/acs](https://apac.auth.langchain.com/auth/v1/sso/saml/acs)
      - AWS US: [https://aws.auth.langchain.com/auth/v1/sso/saml/acs](https://aws.auth.langchain.com/auth/v1/sso/saml/acs)
   2. Audience URI (or SP Entity ID):
      - GCP US: [https://auth.langchain.com/auth/v1/sso/saml/metadata](https://auth.langchain.com/auth/v1/sso/saml/metadata)
      - GCP EU: [https://eu.auth.langchain.com/auth/v1/sso/saml/metadata](https://eu.auth.langchain.com/auth/v1/sso/saml/metadata)
      - GCP APAC: [https://apac.auth.langchain.com/auth/v1/sso/saml/metadata](https://apac.auth.langchain.com/auth/v1/sso/saml/metadata)
      - AWS US: [https://aws.auth.langchain.com/auth/v1/sso/saml/metadata](https://aws.auth.langchain.com/auth/v1/sso/saml/metadata)
...
1. Fill in `AuthHost`:
    - GCP US: `auth.langchain.com`
    - GCP EU: `eu.auth.langchain.com`
    - GCP APAC: `apac.auth.langchain.com`
    - AWS US: `aws.auth.langchain.com`
...
To change the SCIM group name separator for your organization, use the `PATCH /api/v1/orgs/current/info` [endpoint](https://api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch) (GCP EU: [same path on `eu.api.smith.langchain.com`](https://eu.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch); GCP APAC: [same path on `apac.api.smith.langchain.com`](https://apac.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch); AWS US: [same path on `aws.api.smith.langchain.com`](https://aws.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch)):
...
Use the `PATCH /orgs/current/info` [endpoint](https://api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch) (GCP EU, GCP APAC, and AWS US: same path on [`eu.api.smith.langchain.com`](https://eu.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch), [`apac.api.smith.langchain.com`](https://apac.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch), and [`aws.api.smith.langchain.com`](https://aws.api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch)):
...
1. Under **Admin Credentials**:
   ...
   - **Tenant URL**:
     ...
     - GCP US: `https://api.smith.langchain.com/scim/v2`
     - GCP EU: `https://eu.api.smith.langchain.com/scim/v2`
     - GCP APAC: `https://apac.api.smith.langchain.com/scim/v2`
     - AWS US: `https://aws.api.smith.langchain.com/scim/v2`
