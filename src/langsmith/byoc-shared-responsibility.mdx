...
The BYOC shared responsibility model defines what LangChain manages and what your organization manages in a LangSmith BYOC deployment on AWS. Under this model, sensitive data does not transit LangChain infrastructure during normal operation. The sections below cover this split across platform and infrastructure, data and security, and operations and support.
