...
In self-hosted deployments, Engine uses the model provider for your cloud through LangSmith Intelligence (LSI). It uses Amazon Bedrock on AWS, Vertex AI on GCP, and Azure on Azure.
