...
| `mcp_server` | `mcp-servers:read`, `mcp-servers:invoke`, `mcp-servers:create`, `mcp-servers:update`, `mcp-servers:delete`. See [Fleet tool access control](/langsmith/fleet/access-and-oversight#tool-access-control). |
