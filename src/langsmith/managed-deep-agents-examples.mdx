...
For the packaging rules behind this layout, see [How Managed Deep Agents work](/langsmith/managed-deep-agents-how-it-works#compile) and the [CLI project file reference](/langsmith/managed-deep-agents-cli#project-file-reference).
