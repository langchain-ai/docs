...
<Note>
Sandboxes are currently in beta. [Sign up for the waitlist](https://www.langchain.com/langsmith-sandboxes-waitlist?ref=docs.langchain.com) to get access.
</Note>

From the LangSmith homepage, select **Sandboxes** to manage all your sandbox resources.

![Sandboxes link on the LangSmith homepage](/images/langsmith/sandboxes/sb-first-link.png)
