...
<CodeGroup>
```bash pip
pip install -qU langsmith temporalio opentelemetry-exporter-otlp-proto-http opentelemetry-sdk
```

```bash uv
uv add langsmith temporalio opentelemetry-exporter-otlp-proto-http opentelemetry-sdk
```
</CodeGroup>
</Step>
<Step title="Initialize tracer">
