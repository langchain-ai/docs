...
| ------------------- | -------- | ---------------------------------------------------------------------------- |
| `LANGSMITH_API_KEY` | Yes      | Your LangSmith API key from [Settings](https://smith.langchain.com/settings) |
...
- [Learn about LangSmith tracing concepts](https://docs.langchain.com/langsmith/concepts/tracing)
- [Explore OpenTelemetry semantic conventions](https://docs.langchain.com/langsmith/trace-with-opentelemetry#attribute-mapping)
