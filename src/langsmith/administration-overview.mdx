...
- **Agent-based workspaces** call it an [agent](/langsmith/agents), and an agent's traces divide further into four [environments](/langsmith/agent-environments). Select one from the agent picker in the top bar, or select **All agents** to see every resource in the workspace. For more information, see [Navigate agents](/langsmith/navigate-agents).
