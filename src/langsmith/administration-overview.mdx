...
* **Feedback** is added to any run on the trace (or any trace in the thread), whether through [manual annotation](/langsmith/annotate-traces-inline#annotate-traces-and-runs-inline), automatically using [an online evaluator](/langsmith/online-evaluations) or [via the SDK](/langsmith/attach-user-feedback#log-user-feedback-using-the-sdk).
