...
Use **[Chat](/langsmith/chat)** to analyze traces, runs, threads, and trajectories. Chat helps you understand agent performance, debug issues, and gain insights from conversation threads without manually digging through data.
</Callout>
