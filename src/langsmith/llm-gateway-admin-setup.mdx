...
Skip this step for LangChain-hosted models: they use your LangSmith API key, not provider secrets. Paid hosted models use [Gateway Credits](/langsmith/llm-gateway-credits). SemIf (`semif-qwen3.5-4b`) is free through September 28, 2026, when enabled for your organization. It requires no Gateway Credits purchase or paid-plan upgrade. Continue with step 2 to grant gateway access.
