...
- **PII and secrets redaction:** detect and redact sensitive data before it reaches the model. Refer to [PII and secrets redaction](/langsmith/llm-gateway-data-protection).
