...
Composite scores are attached to a run as feedback, similar to the feedback from a single evaluator.. How you can view them depends on where the evaluation was run:
