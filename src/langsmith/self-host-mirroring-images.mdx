...
For example, if your registry is `myregistry.com`, your platform is `linux/arm64`, and your LangSmith app version is `0.10.66`, run:
...
docker pull langchain/langsmith-backend:0.10.66
docker tag langchain/langsmith-backend:0.10.66 <your-registry>/langsmith-backend:0.10.66
docker push <your-registry>/langsmith-backend:0.10.66
```
