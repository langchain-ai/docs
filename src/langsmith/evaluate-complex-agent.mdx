...
<Info>
[Agent evaluation](/langsmith/evaluation-concepts#core-evaluation-targets) | [Evaluators](/langsmith/evaluation-concepts#evaluators) | [LLM-as-judge evaluators](/langsmith/evaluation-concepts#llm-as-judge)
</Info>
...
* [Final response](/langsmith/evaluation-concepts#targets-for-offline-evaluation): Evaluate the agent's final response.
...
* [Single step](/langsmith/evaluation-concepts#targets-for-offline-evaluation): Evaluate any agent step in isolation (e.g., whether it selects the appropriate first tool for a given step).
...
* [Final response](/langsmith/evaluation-concepts#targets-for-offline-evaluation): The inputs are a prompt and an optional list of tools. The output is the final agent response.
...
* [Single step](/langsmith/evaluation-concepts#targets-for-offline-evaluation): As before, the inputs are a prompt and an optional list of tools. The output is the tool call.
