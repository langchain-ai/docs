...
![View online evaluators](images/view_evaluators.png)
...
View this guide to configure an [LLM-as-a-judge evaluator](/evaluation/how_to_guides/llm_as_judge?mode=ui#pre-built-evaluators-1).
...
![](images/online-eval-custom-code.png)
