...
- [LangChain / LangGraph](/oss/langchain/overview)
- OpenAI Chat Completions (`wrap_openai`)
- OpenAI Responses API, single call (`wrap_openai`)

The **OpenAI Responses API in chaining mode** (`previous_response_id`) sets `ls_agent_type` automatically, but you set `thread_id` yourself. Fore more details, refer to the [OpenAI Responses API with chaining](#openai-responses-api-with-chaining) example.
