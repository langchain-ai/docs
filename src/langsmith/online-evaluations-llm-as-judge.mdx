...
In the [LangSmith UI](https://smith.langchain.com), head to the **Tracing** tab and select a tracing project, or an agent environment. To view existing online evaluators for that project, click on the **Evaluators** tab.

## Add an online evaluator

1. In the [LangSmith UI](https://smith.langchain.com), navigate to the **Tracing** page and select a tracing project, or an agent environment.
