...
description: Create temporary LangSmith deployments for pull requests to test Agent Server changes before merging.
---
...
<Note>
Preview builds are available only for deployments created through the GitHub integration.
</Note>
