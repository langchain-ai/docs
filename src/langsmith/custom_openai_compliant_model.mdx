---
title: Run the playground against an OpenAI-compliant model provider/proxy
sidebarTitle: Run the playground against an OpenAI-compliant model provider/proxy
---
...
![OpenAI Proxy Provider](images/openai_proxy_provider.png)
