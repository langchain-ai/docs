...
Open the [LangSmith UI](https://smith.langchain.com) and navigate to the tracing project named **gateway** in the workspace associated with your API key. You should see a new trace for the call you just made.
