...
- Supported chat models: [Anthropic](/oss/python/integrations/chat/anthropic), [Fireworks](/oss/python/integrations/chat/fireworks), and [OpenAI](/oss/python/integrations/chat/openai).
