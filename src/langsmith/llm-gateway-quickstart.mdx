...
*Note*: if your LangSmith account is on the EU instance, use the EU-hosted LLM Gateway at https://eu.gateway.smith.langchain.com; that gateway is deployed in LangChain's European production environment. There is not automatic region routing. 
