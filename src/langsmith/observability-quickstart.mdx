...
If you're using Anthropic, use the [Anthropic wrapper](/langsmith/wrappers/anthropic) to trace your calls. For other providers, use [the traceable wrapper](/langsmith/annotate-code#use-%40traceable-%2F-traceable).
