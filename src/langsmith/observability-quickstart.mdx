...
Create a directory for your project and install the dependencies in your environment:
...
1. In the [LangSmith UI](https://smith.langchain.com), navigate to the **default** Tracing Project for your workspace (or the workspace you specified in [Step 2](#2-set-up-environment-variables). You'll see the OpenAI call we just instrumented.
...
1. Return to the [LangSmith UI](https://smith.langchain.com), navigate to the **default** Tracing Project for your workspace (or the workspace you specified in [Step 2](#2-set-up-environment-variables). You'll find a trace of the entire app pipeline.
