...
public class App {
    private static final OpenAIClient client = OpenAITracing.wrapOpenAI(OpenAIOkHttpClient.fromEnv());

    private static final Function<String, String> getContext = Tracing.traceFunction(
    ...
    private static final Function<String, String> assistant = Tracing.traceFunction(
        question -> {
