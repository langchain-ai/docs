...
A Managed Deep Agents project starts with an agent entry and optional project folders. For the full file layout and packaging rules, see [the project directory layout](/langsmith/managed-deep-agents-overview#structure-your-agent-project).
...
Focus the agent definition on behavior: model, tools, middleware, interrupts, and other Deep Agents configuration fields that the runtime does not manage.
