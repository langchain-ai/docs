...
This guide explains how to add semantic search to your deployment's cross-thread [store](/oss/langgraph/stores), so that your agent can search for memories and other documents by semantic similarity.
