...
Let's define a simple chain to evaluate. First, install all the required packages with Python:

<CodeGroup>
```bash pip
pip install -qU langsmith langchain[openai]
```

```bash uv
uv add langsmith langchain[openai]
```
</CodeGroup>
