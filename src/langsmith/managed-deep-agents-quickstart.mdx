...
description: Deploy your first Managed Deep Agent with the CLI and run it from code.
---

LangChain hosts [Managed Deep Agents](/langsmith/managed-deep-agents-overview), so you can deploy your first agent and stream a response quickly without setting up infrastructure. This quickstart uses the CLI to deploy and cURL to run a language-neutral smoke test. For Python, TypeScript, and React applications, use the [Managed Deep Agents SDKs](/langsmith/managed-deep-agents-sdk).
...
Run a Managed Deep Agent with cURL to confirm the deployment works. For Python and TypeScript examples, see [Run an agent](/langsmith/managed-deep-agents-invoke) or the [SDK reference](/langsmith/managed-deep-agents-sdk).
