...
Engine uses the model provider for your cloud through LSI: Amazon Bedrock on AWS, Vertex AI on GCP, and Azure on Azure. Provider selection does not change the cloud and region availability listed above.
