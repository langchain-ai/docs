...
1. Any user turns on Engine for a tracing project, or an agent environment from its **Engine** tab. For more information, see [Set up Engine](/langsmith/engine#set-up-engine).
