...
This pipeline will produce a trace that looks something like: ![evaluation_intermediate_trace.png](images/evaluation_intermediate_trace.png)
...
The experiment will contain the results of the evaluation, including the scores and comments from the evaluators: ![evaluation_intermediate_experiment.png](images/evaluation_intermediate_experiment.png)
