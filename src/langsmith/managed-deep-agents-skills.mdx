...
A later deployment syncs the project copies again and removes deployed skill files that no longer exist locally. Keep the local skill files aligned with any changes you want to preserve in the next deployment.
