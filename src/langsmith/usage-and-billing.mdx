...
* **Run Rules and Evaluators**: Traces that use these features may be [auto-upgraded](#data-retention-auto-upgrades) depending on the retention setting for the rule or evaluator.
* **Feedback and Annotation Queues**: Feedback submitted in the LangSmith UI and manually adding runs to annotation queues do not change trace retention by default.
