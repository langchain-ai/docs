...
- [How to send custom cost data](#other-runs-sending-costs)
...
<Note>
The table comes with pricing information for most OpenAI, Anthropic, and Gemini models. You can [add prices for other models](/langsmith/cost-tracking#llm-calls-automatically-track-costs-based-on-token-counts), or [overwrite pricing for default models](/langsmith/cost-tracking#llm-calls-automatically-track-costs-based-on-token-counts) if you have custom pricing.
</Note>
