...
This page is the **channel** (conversation ingress/egress). It is not the GitHub **connector** (sandbox checkouts) or Connect-with-GitHub OAuth under [identity](/langsmith/managed-deep-agents-identity).
