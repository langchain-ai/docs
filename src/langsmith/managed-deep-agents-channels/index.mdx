...
The GitHub channel uses an installation/service actor and does not require Connect-with-GitHub. For Slack app setup, secrets, Event Subscriptions, and Connect-with-Slack, see [Slack](/langsmith/managed-deep-agents-channels/slack). For GitHub App webhooks, see the [GitHub connector](/langsmith/managed-deep-agents-connectors/github#receive-github-app-webhooks).
