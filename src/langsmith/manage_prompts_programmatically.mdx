...
When pulling a prompt, you can also specify a specific commit hash or [commit tag](/prompt_engineering/how_to_guides/prompt_tags) to pull a specific version of the prompt.
