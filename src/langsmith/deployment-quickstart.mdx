...
- (Optional) [Docker](https://docs.docker.com/get-docker/) installed and running — required only for local builds. If Docker is not available, `langgraph deploy` triggers a remote build automatically.
