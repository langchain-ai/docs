...
// :snippet-start: evaluate-rag-indexing-js
// :codegroup-tab: TypeScript
...
// :snippet-start: evaluate-rag-generation-js
// :codegroup-tab: TypeScript
...
// :snippet-start: evaluate-rag-dataset-js
// :codegroup-tab: TypeScript
...
// :snippet-start: evaluate-rag-correctness-js
// :codegroup-tab: TypeScript
...
// :snippet-start: evaluate-rag-relevance-js
// :codegroup-tab: TypeScript
// Grade prompt
...
// :snippet-start: evaluate-rag-groundedness-js
// :codegroup-tab: TypeScript
// Grade prompt
...
// :snippet-start: evaluate-rag-retrieval-relevance-js
// :codegroup-tab: TypeScript
// Grade prompt
...
// :snippet-start: evaluate-rag-run-evaluation-js
// :codegroup-tab: TypeScript
...
// :remove-start:
if (!vectorStore || !ragBot || !experimentResults) {
  throw new Error("Expected RAG evaluation setup to complete");
}
console.log("✓ evaluate-rag-tutorial");
// :remove-end:
