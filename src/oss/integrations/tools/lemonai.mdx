...
#### (Optional) Define your Lemon AI Functions Define your Lemon AI Functions")
...
```
import osfrom langchain_openai import OpenAIfrom lemonai import execute_workflow
```
