...
|---------|-------------|---------|--------|
| [Azure Blob Backend](/oss/integrations/backends/azure-blob-storage) | Azure Blob Storage implementation of the Deep Agents `BackendProtocol`. Persist agent workspace files, memories, and artifacts in a blob container. | `langchain-azure-storage` | [`langchain-ai/langchain-azure`](https://github.com/langchain-ai/langchain-azure/tree/main/libs/azure-storage) |
