...
[![Open In Colab](/images/oss/integrations/memory/google_firestore_datastore/assets/colab-badge.svg)](https://colab.research.google.com/github/googleapis/langchain-google-datastore-python/blob/main/oss/chat_message_history.ipynb)
...
* [Create a Datastore database](https://cloud.google.com/datastore/oss/manage-databases)
...
```
# enable Datastore API!gcloud services enable datastore.googleapis.com
```
...
```
from langchain_google_datastore import DatastoreChatMessageHistorychat_history = DatastoreChatMessageHistory(    session_id="user-session-id", collection="HistoryMessages")chat_history.add_user_message("Hi!")chat_history.add_ai_message("How can I help you?")
```
...
The client is created by default using the available environment variables. A [custom client](https://cloud.google.com/python/oss/reference/datastore/latest/client) can be passed to the constructor.
