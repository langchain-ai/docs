...
<Info>
  The Google Cloud VertexAI integration is separate from the [Google PaLM integration](/src/oss/integrations/chat/google_generative_ai). Google has chosen to offer an enterprise version of PaLM through GCP, and this supports the models made available through there.
</Info>
