...
| ------------------------------------------------------ | ---------------------- | ---------------------------------------------------------------------------------------------- | ----- | ------------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [ModelScope](/src/oss/integrations/providers/modelscope) | ModelScopeChatEndpoint | [langchain-modelscope-integration](https://pypi.org/project/langchain-modelscope-integration/) | ❌     | ❌            | ![PyPI - Downloads](/images/oss/integrations/chat/modelscope_chat_endpoint/pypi/dm/langchain-modelscope-integration) | ![PyPI - Version](/images/oss/integrations/chat/modelscope_chat_endpoint/pypi/v/langchain-modelscope-integration) |
