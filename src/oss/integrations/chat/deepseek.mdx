...
This will help you get started with DeepSeek's hosted [chat models](/src/oss/concepts/chat_models). For detailed documentation of all ChatDeepSeek features and configurations head to the [API reference](https://python.langchain.com/api_reference/deepseek/chat_models/langchain_deepseek.chat_models.ChatDeepSeek.html).

<Check>
  DeepSeek's models are open source and can be run locally (e.g. in [Ollama](/src/oss/integrations/chat/ollama)) or on other inference providers (e.g. [Fireworks](/src/oss/integrations/chat/fireworks), [Together](/src/oss/integrations/chat/together)) as well.
</Check>
