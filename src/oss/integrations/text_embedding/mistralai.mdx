...
```
import getpassimport osif not os.getenv("MISTRALAI_API_KEY"):    os.environ["MISTRALAI_API_KEY"] = getpass.getpass("Enter your MistralAI API key: ")
```
...
```
from langchain_mistralai import MistralAIEmbeddingsembeddings = MistralAIEmbeddings(    model="mistral-embed",)
```
...
```
[-0.04443359375, 0.01885986328125, 0.0180511474609375, -0.0086517333984375, 0.049652099609375, -0.00[-0.02032470703125, 0.02606201171875, 0.051605224609375, -0.0281982421875, 0.055755615234375, 0.0019
```
