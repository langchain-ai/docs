...
See the main [Redis cache docs](/src/oss/integrations/caches/redis_llm_caching) for detail.

### Standard cache

Use [Redis](/src/oss/integrations/providers/redis) to cache prompts and responses.
...
Use [Redis](/src/oss/integrations/providers/redis) to cache prompts and responses and evaluate hits based on semantic similarity.
...
[MongoDB Atlas](https://www.mongodb.com/oss/atlas/) is a fully-managed cloud database available in AWS, Azure, and GCP. It has native support for Vector Search on the MongoDB document data. Use [MongoDB Atlas Vector Search](/src/oss/integrations/providers/mongodb_atlas) to semantically cache prompts and responses.
...
Use [Momento](/src/oss/integrations/providers/momento) to cache prompts and responses.
