...
For [Redis sentinel setups](https://redis.io/oss/management/sentinel/) the connection scheme is "redis+sentinel". This is an unofficial extensions to the official IANA registered protocol schemes as long as there is no connection url for Sentinels available.
...
**API Reference:**[RedisSemanticCache](https://python.langchain.com/api_reference/community/cache/langchain_community.cache.RedisSemanticCache.html)
...
**API Reference:**[Redis](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.redis.base.Redis.html)

For a more detailed walkthrough of the Redis vectorstore wrapper, see [this notebook](/src/oss/integrations/vectorstores/redis).
...
For a detailed example of Redis to cache conversation message history, see [this notebook](/src/oss/integrations/memory/redis_chat_message_history).
