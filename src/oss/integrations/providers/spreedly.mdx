...
See [setup instructions](/src/oss/integrations/document_loaders/spreedly).

## Document Loader

See a [usage example](/src/oss/integrations/document_loaders/spreedly).

```
from langchain_community.document_loaders import SpreedlyLoader
```

**API Reference:**[SpreedlyLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.spreedly.SpreedlyLoader.html)
