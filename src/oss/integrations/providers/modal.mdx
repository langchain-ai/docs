...
Deploy the web endpoint to Modal cloud with the [`modal deploy`](https://modal.com/oss/reference/cli/deploy) CLI command. Your web endpoint will acquire a persistent URL under the `modal.run` domain.
...
**API Reference:**[Modal](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.modal.Modal.html)
