...
See [this guide](/src/oss/how_to/local_llms) for more details on how to use `Ollama` with LangChain.
...
See the notebook example [here](/src/oss/integrations/llms/ollama).
...
See the notebook example [here](/src/oss/integrations/text_embedding/ollama).
