...
See a [usage example](/src/oss/integrations/document_loaders/huawei_obs_directory).
...
See a [usage example](/src/oss/integrations/document_loaders/huawei_obs_file).
