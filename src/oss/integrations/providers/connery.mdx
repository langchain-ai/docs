...
> [Connery SDK](https://github.com/connery-io/connery-sdk) is an NPM package that includes both an SDK and a CLI, designed for the development of plugins and actions.
>
...
>
> See the use cases and examples in the [Connery SDK documentation](https://sdk.connery.io/oss/use-cases/)

## Toolkit

See [usage example](/src/oss/integrations/tools/connery).
