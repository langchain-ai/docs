...
See a [usage example](/oss/integrations/document_loaders/unstructured_file) to see how you can use this loader for both partitioning locally and remotely with the serverless Unstructured API.
...
See a [usage example](/oss/how_to/document_loader_html).
...
See a [usage example](/oss/how_to/document_loader_pdf/#layout-analysis-and-extraction-of-text-from-images).
