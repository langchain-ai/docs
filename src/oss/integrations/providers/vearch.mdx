...
Vearch also can used as vectorstore. Most details in [this notebook](/src/oss/integrations/vectorstores/vearch)

```
from langchain_community.vectorstores import Vearch
```

**API Reference:**[Vearch](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.vearch.Vearch.html)
