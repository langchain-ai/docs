...
**API Reference:**[Clarifai](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.clarifai.Clarifai.html)

For more details, the docs on the Clarifai LLM wrapper provide a [detailed walkthrough](/src/oss/integrations/llms/clarifai).
...
**API Reference:**[ClarifaiEmbeddings](https://python.langchain.com/api_reference/community/embeddings/langchain_community.embeddings.clarifai.ClarifaiEmbeddings.html)

See a [usage example](/src/oss/integrations/document_loaders/couchbase).
...
**API Reference:**[Clarifai](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.clarifai.Clarifai.html)

For more details, the docs on the Clarifai vector store provide a [detailed walkthrough](/src/oss/integrations/vectorstores/clarifai).
