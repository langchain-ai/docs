...
See a [usage example running model on Intel CPU](/oss/integrations/text_embedding/ipex_llm). See a [usage example running model on Intel GPU](/oss/integrations/text_embedding/ipex_llm_gpu).
