...
See a [usage example](/oss/integrations/text_embedding/optimum_intel). We also offer a full tutorial notebook "rag\_with\_quantized\_embeddings.ipynb" for using the embedder in a RAG pipeline in the cookbook dir.
