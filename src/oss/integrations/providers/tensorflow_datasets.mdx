...
See a [usage example](/src/oss/integrations/document_loaders/tensorflow_datasets).

```
from langchain_community.document_loaders import TensorflowDatasetLoader
```

**API Reference:**[TensorflowDatasetLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tensorflow_datasets.TensorflowDatasetLoader.html)
