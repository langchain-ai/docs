...
**API Reference:**[SemaDB](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.semadb.SemaDB.html)

You can follow a tutorial on how to use the wrapper in [this notebook](/src/oss/integrations/vectorstores/semadb).
