...
See a [usage example](/src/oss/integrations/document_loaders/blackboard).

```
from langchain_community.document_loaders import BlackboardLoader
```

**API Reference:**[BlackboardLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.blackboard.BlackboardLoader.html)
