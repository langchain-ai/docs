...
See a [usage example](/src/oss/integrations/vectorstores/usearch).

```
from langchain_community.vectorstores import USearch
```

**API Reference:**[USearch](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.usearch.USearch.html)
