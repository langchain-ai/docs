...
See a [usage example](/src/oss/integrations/document_loaders/discord).
...
**API Reference:**[DiscordChatLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.discord.DiscordChatLoader.html)

## Chat Loader

See a [usage example](/src/oss/integrations/chat_loaders/discord).
