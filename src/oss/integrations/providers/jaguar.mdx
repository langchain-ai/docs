...
export OPENAI\_API\_KEY="......" export JAGUAR\_API\_KEY="......"
...
For more details of the Jaguar API, please refer to [this notebook](/src/oss/integrations/vectorstores/jaguar)
