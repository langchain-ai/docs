...
Zep offers an open source version with a self-hosted option. Please refer to the [Zep Open Source](https://github.com/getzep/zep) repo for more information. You can also find Zep Open Source compatible [Retriever](/oss/integrations/retrievers/zep_memorystore), [Vector Store](/oss/integrations/vectorstores/zep) and [Memory](/oss/integrations/memory/zep_memory) examples
