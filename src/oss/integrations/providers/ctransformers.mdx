...
```
llm = CTransformers(model='/path/to/ggml-gpt-2.bin', model_type='gpt2')print(llm.invoke('AI is going to'))
```
...
For a more detailed walkthrough of this, see [this notebook](/src/oss/integrations/llms/ctransformers).
