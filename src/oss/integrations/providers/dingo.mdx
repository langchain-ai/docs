...
**API Reference:**[Dingo](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.dingo.Dingo.html)

For a more detailed walkthrough of the DingoDB wrapper, see [this notebook](/src/oss/integrations/vectorstores/dingo)
