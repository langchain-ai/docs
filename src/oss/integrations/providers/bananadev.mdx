...
> [Banana](https://www.banana.dev/) provided serverless GPU inference for AI models, a CI/CD build pipeline and a simple Python framework (`Potassium`) to server your models.
...
```
# Return the results as a dictionaryresult = {'outputs': result}
```
...
**API Reference:**[Banana](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.bananadev.Banana.html)

See a [usage example](/src/oss/integrations/llms/banana).
