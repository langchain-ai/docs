...
See a [usage example](/src/oss/integrations/chat/azure_chat_openai)
...
```
from langchain_azure_ai.chat_models import AzureAIChatCompletionsModelllm = AzureAIChatCompletionsModel(    model_name="gpt-4o",    api_version="2024-05-01-preview",)
```
...
See a [usage example](/src/oss/integrations/chat/azure_ai)

### Azure ML Chat Online Endpoint

See the documentation [here](/src/oss/integrations/chat/azureml_chat_endpoint) for accessing chat models hosted with [Azure Machine Learning](https://azure.microsoft.com/en-us/products/machine-learning/).

## LLMs

### Azure ML

See a [usage example](/src/oss/integrations/llms/azure_ml).

```
from langchain_community.llms.azureml_endpoint import AzureMLOnlineEndpoint
```

**API Reference:**[AzureMLOnlineEndpoint](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.azureml_endpoint.AzureMLOnlineEndpoint.html)

### Azure OpenAI

See a [usage example](/src/oss/integrations/llms/azure_openai).
...
See a [usage example](/src/oss/integrations/text_embedding/azureopenai)

```
from langchain_openai import AzureOpenAIEmbeddings
```

**API Reference:**[AzureOpenAIEmbeddings](https://python.langchain.com/api_reference/openai/embeddings/langchain_openai.embeddings.azure.AzureOpenAIEmbeddings.html)
...
See a [usage example](/src/oss/integrations/document_loaders/azure_ai_data).

```
from langchain.document_loaders import AzureAIDataLoader
```

**API Reference:**[AzureAIDataLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.azure_ai_data.AzureAIDataLoader.html)

### Azure AI Document Intelligence

> [Azure AI Document Intelligence](https://aka.ms/doc-intelligence) (formerly known as `Azure Form Recognizer`) is machine-learning based service that extracts texts (including handwriting), tables, document structures, and key-value-pairs from digital or scanned PDFs, images, Office and HTML files.
>
...
See a [usage example](/src/oss/integrations/document_loaders/azure_document_intelligence).
...
See a [usage example for the Azure Blob Storage](/src/oss/integrations/document_loaders/azure_blob_storage_container).
...
See a [usage example for the Azure Files](/src/oss/integrations/document_loaders/azure_blob_storage_file).
...
See a [usage example](/src/oss/integrations/document_loaders/microsoft_onedrive).
...
See a [usage example](/src/oss/integrations/document_loaders/microsoft_word).
...
See a [usage example](/src/oss/integrations/document_loaders/microsoft_sharepoint).

```
from langchain_community.document_loaders.sharepoint import SharePointLoader
```

**API Reference:**[SharePointLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.sharepoint.SharePointLoader.html)
...
See a [usage example](/src/oss/integrations/document_loaders/microsoft_onenote).

```
from langchain_community.document_loaders.onenote import OneNoteLoader
```

**API Reference:**[OneNoteLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.onenote.OneNoteLoader.html)
...
See a [usage example](/src/oss/integrations/document_loaders/url/#playwright-url-loader).
...
See [detail configuration instructions](/src/oss/integrations/vectorstores/azure_cosmos_db).
...
See a [usage example](/src/oss/integrations/vectorstores/azure_cosmos_db).

```
from langchain_community.vectorstores import AzureCosmosDBVectorSearch
```

**API Reference:**[AzureCosmosDBVectorSearch](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.azure_cosmos_db.AzureCosmosDBVectorSearch.html)
...
See [detail configuration instructions](/src/oss/integrations/vectorstores/azure_cosmos_db_no_sql).
...
See a [usage example](/src/oss/integrations/vectorstores/azure_cosmos_db_no_sql).
...
See a [usage example](/src/oss/integrations/memory/postgres_chat_message_history). Simply use the [connection string](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-python?tabs=cmd%2Cpassword#add-authentication-code) from your Azure Portal.

Since Azure Database for PostgreSQL is open-source Postgres, you can use the [LangChain's Postgres support](/src/oss/integrations/vectorstores/pgvector) to connect to Azure Database for PostgreSQL.
...
See [detail configuration instructions](/src/oss/integrations/vectorstores/sqlserver).
...
See a [usage example](/src/oss/integrations/vectorstores/sqlserver).

```
from langchain_sqlserver import SQLServer_VectorStore
```

**API Reference:**[SQLServer\_VectorStore](https://python.langchain.com/api_reference/sqlserver/vectorstores/langchain_sqlserver.vectorstores.SQLServer_VectorStore.html)

### Azure AI Search

[Azure AI Search](https://learn.microsoft.com/azure/search/search-what-is-azure-search) is a cloud search service that gives developers infrastructure, APIs, and tools for information retrieval of vector, keyword, and hybrid queries at scale. See [here](/src/oss/integrations/vectorstores/azuresearch) for usage examples.

```
from langchain_community.vectorstores.azuresearch import AzureSearch
```

**API Reference:**[AzureSearch](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.azuresearch.AzureSearch.html)
...
See a [usage example](/src/oss/integrations/retrievers/azure_ai_search).

```
from langchain_community.retrievers import AzureAISearchRetriever
```

**API Reference:**[AzureAISearchRetriever](https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.azure_ai_search.AzureAISearchRetriever.html)
...
You need to [enable pgvector extension](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/how-to-use-pgvector) in your database to use Postgres as a vector store. Once you have the extension enabled, you can use the [PGVector in LangChain](/src/oss/integrations/vectorstores/pgvector) to connect to Azure Database for PostgreSQL.

See a [usage example](/src/oss/integrations/vectorstores/pgvector). Simply use the [connection string](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-python?tabs=cmd%2Cpassword#add-authentication-code) from your Azure Portal.

## Tools

### Azure Container Apps dynamic sessions

We need to get the `POOL_MANAGEMENT_ENDPOINT` environment variable from the Azure Container Apps service. See the instructions [here](/src/oss/integrations/tools/azure_dynamic_sessions/#setup).
...
See a [usage example](/src/oss/integrations/tools/azure_dynamic_sessions).

```
from langchain_azure_dynamic_sessions import SessionsPythonREPLTool
```

**API Reference:**[SessionsPythonREPLTool](https://python.langchain.com/api_reference/azure_dynamic_sessions/tools/langchain_azure_dynamic_sessions.tools.sessions.SessionsPythonREPLTool.html)

### Bing Search

Follow the documentation [here](/src/oss/integrations/tools/bing_search) to get a detail explanations and instructions of this tool.

The environment variable `BING_SUBSCRIPTION_KEY` and `BING_SEARCH_URL` are required from Bing Search resource.

```
from langchain_community.tools.bing_search import BingSearchResultsfrom langchain_community.utilities import BingSearchAPIWrapperapi_wrapper = BingSearchAPIWrapper()tool = BingSearchResults(api_wrapper=api_wrapper)
```

**API Reference:**[BingSearchResults](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.bing_search.tool.BingSearchResults.html) | [BingSearchAPIWrapper](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.bing_search.BingSearchAPIWrapper.html)
...
See a [usage example](/src/oss/integrations/tools/azure_ai_services).

```
from langchain_community.agent_toolkits import azure_ai_services
```

**API Reference:**[azure\_ai\_services](https://python.langchain.com/api_reference/community/agent_toolkits/langchain_community.agent_toolkits.azure_ai_services.azure_ai_services.html)
...
See a [usage example](/src/oss/integrations/tools/azure_cognitive_services).

```
from langchain_community.agent_toolkits import AzureCognitiveServicesToolkit
```

**API Reference:**[AzureCognitiveServicesToolkit](https://python.langchain.com/api_reference/community/agent_toolkits/langchain_community.agent_toolkits.azure_cognitive_services.AzureCognitiveServicesToolkit.html)
...
```
from langchain_community.tools.azure_cognitive_services import (    AzureCogsFormRecognizerTool,    AzureCogsImageAnalysisTool,    AzureCogsSpeech2TextTool,    AzureCogsText2SpeechTool,    AzureCogsTextAnalyticsHealthTool,)
```

**API Reference:**[AzureCogsFormRecognizerTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.azure_cognitive_services.form_recognizer.AzureCogsFormRecognizerTool.html) | [AzureCogsImageAnalysisTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.azure_cognitive_services.image_analysis.AzureCogsImageAnalysisTool.html) | [AzureCogsSpeech2TextTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.azure_cognitive_services.speech2text.AzureCogsSpeech2TextTool.html) | [AzureCogsText2SpeechTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.azure_cognitive_services.text2speech.AzureCogsText2SpeechTool.html) | [AzureCogsTextAnalyticsHealthTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.azure_cognitive_services.text_analytics_health.AzureCogsTextAnalyticsHealthTool.html)
...
See a [usage example](/src/oss/integrations/tools/office365).
...
```
from langchain_community.tools.office365 import O365CreateDraftMessagefrom langchain_community.tools.office365 import O365SearchEmailsfrom langchain_community.tools.office365 import O365SearchEventsfrom langchain_community.tools.office365 import O365SendEventfrom langchain_community.tools.office365 import O365SendMessage
```

**API Reference:**[O365CreateDraftMessage](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.office365.create_draft_message.O365CreateDraftMessage.html) | [O365SearchEmails](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.office365.messages_search.O365SearchEmails.html) | [O365SearchEvents](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.office365.events_search.O365SearchEvents.html) | [O365SendEvent](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.office365.send_event.O365SendEvent.html) | [O365SendMessage](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.office365.send_message.O365SendMessage.html)
...
See a [usage example](/src/oss/integrations/tools/powerbi).

```
from langchain_community.agent_toolkits import PowerBIToolkitfrom langchain_community.utilities.powerbi import PowerBIDataset
```

**API Reference:**[PowerBIToolkit](https://python.langchain.com/api_reference/community/agent_toolkits/langchain_community.agent_toolkits.powerbi.toolkit.PowerBIToolkit.html) | [PowerBIDataset](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.powerbi.PowerBIDataset.html)
...
```
from langchain_community.tools.powerbi.tool import InfoPowerBIToolfrom langchain_community.tools.powerbi.tool import ListPowerBIToolfrom langchain_community.tools.powerbi.tool import QueryPowerBITool
```

**API Reference:**[InfoPowerBITool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.powerbi.tool.InfoPowerBITool.html) | [ListPowerBITool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.powerbi.tool.ListPowerBITool.html) | [QueryPowerBITool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.powerbi.tool.QueryPowerBITool.html)
...
See a [usage example](/src/oss/integrations/tools/playwright).

```
from langchain_community.agent_toolkits import PlayWrightBrowserToolkit
```

**API Reference:**[PlayWrightBrowserToolkit](https://python.langchain.com/api_reference/community/agent_toolkits/langchain_community.agent_toolkits.playwright.toolkit.PlayWrightBrowserToolkit.html)
...
```
from langchain_community.tools.playwright import ClickToolfrom langchain_community.tools.playwright import CurrentWebPageToolfrom langchain_community.tools.playwright import ExtractHyperlinksToolfrom langchain_community.tools.playwright import ExtractTextToolfrom langchain_community.tools.playwright import GetElementsToolfrom langchain_community.tools.playwright import NavigateToolfrom langchain_community.tools.playwright import NavigateBackTool
```

**API Reference:**[ClickTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.playwright.click.ClickTool.html) | [CurrentWebPageTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.playwright.current_page.CurrentWebPageTool.html) | [ExtractHyperlinksTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.playwright.extract_hyperlinks.ExtractHyperlinksTool.html) | [ExtractTextTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.playwright.extract_text.ExtractTextTool.html) | [GetElementsTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.playwright.get_elements.GetElementsTool.html) | [NavigateTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.playwright.navigate.NavigateTool.html) | [NavigateBackTool](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.playwright.navigate_back.NavigateBackTool.html)
...
See a [usage example](/src/oss/integrations/graphs/azure_cosmosdb_gremlin).

```
from langchain_community.graphs import GremlinGraphfrom langchain_community.graphs.graph_document import GraphDocument, Node, Relationship
```

**API Reference:**[GremlinGraph](https://python.langchain.com/api_reference/community/graphs/langchain_community.graphs.gremlin_graph.GremlinGraph.html) | [GraphDocument](https://python.langchain.com/api_reference/community/graphs/langchain_community.graphs.graph_document.GraphDocument.html) | [Node](https://python.langchain.com/api_reference/community/graphs/langchain_community.graphs.graph_document.Node.html) | [Relationship](https://python.langchain.com/api_reference/community/graphs/langchain_community.graphs.graph_document.Relationship.html)
...
See a [usage example](/src/oss/integrations/tools/bing_search).

```
from langchain_community.utilities import BingSearchAPIWrapper
```

**API Reference:**[BingSearchAPIWrapper](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.bing_search.BingSearchAPIWrapper.html)
...
```
pip install langchain-experimental openai presidio-analyzer presidio-anonymizer spacy Fakerpython -m spacy download en_core_web_lg
```

See [usage examples](https://python.langchain.com/v0.1/oss/guides/productionization/safety/presidio_data_anonymization).

```
from langchain_experimental.data_anonymizer import PresidioAnonymizer, PresidioReversibleAnonymizer
```

**API Reference:**[PresidioAnonymizer](https://python.langchain.com/api_reference/experimental/data_anonymizer/langchain_experimental.data_anonymizer.presidio.PresidioAnonymizer.html) | [PresidioReversibleAnonymizer](https://python.langchain.com/api_reference/experimental/data_anonymizer/langchain_experimental.data_anonymizer.presidio.PresidioReversibleAnonymizer.html)
