...
For a more detailed walkthrough of this wrapper, see [this notebook](/src/oss/integrations/tools/wolfram_alpha).
...
```
from langchain_community.agent_toolkits.load_tools import load_toolstools = load_tools(["wolfram-alpha"])
```
