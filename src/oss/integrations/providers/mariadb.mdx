...
This page covers how to use the [MariaDB](https://github.com/mariadb/) ecosystem within LangChain. It is broken into two parts: installation and setup, and then references to specific PGVector wrappers.
...
For a more detailed walkthrough of the MariaDB wrapper, see [this notebook](/src/oss/integrations/vectorstores/mariadb)
