...
> DeepInfra provides [examples](https://deepinfra.com/oss/advanced/langchain) of integration with LangChain.
...
See a [usage example](/src/oss/integrations/llms/deepinfra).
...
See a [usage example](/src/oss/integrations/text_embedding/deepinfra).
...
See a [usage example](/src/oss/integrations/chat/deepinfra).
