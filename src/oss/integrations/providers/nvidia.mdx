...
* **[`ChatNVIDIA` Model](/src/oss/integrations/chat/nvidia_ai_endpoints).**
* **[`NVIDIAEmbeddings` Model for RAG Workflows](/src/oss/integrations/text_embedding/nvidia_ai_endpoints).**
