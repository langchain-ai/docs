...
For a more detailed walkthrough of the SKLearnVectorStore wrapper, see [this notebook](/src/oss/integrations/vectorstores/sklearn).
...
See a [usage example](/src/oss/integrations/retrievers/svm).
