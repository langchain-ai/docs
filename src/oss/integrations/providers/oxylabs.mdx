...
[langchain-oxylabs](https://pypi.org/project/langchain-oxylabs/) implements tools enabling LLMs to interact with Oxylabs Web Scraper API.
...
See details on available tools [here](/src/oss/integrations/tools/oxylabs).
