...
There exists an Gradient LLM wrapper, which you can access with See a [usage example](/src/oss/integrations/llms/gradient).
...
For a more detailed walkthrough of this, see [this notebook](/src/oss/integrations/text_embedding/gradient)
