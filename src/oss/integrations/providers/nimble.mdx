...
See a [usage example](/src/oss/integrations/retrievers/nimble).

```
from langchain_nimble import NimbeSearchRetriever
```

Note that authentication is required, please refer to the [Setup section in the documentation](/src/oss/integrations/retrievers/nimble/#setup).
