...
To use the Linkup provider, you first need a valid API key, which you can find by signing-up [here](https://app.linkup.so/sign-up). You will also need the `langchain-linkup` package, which you can install using pip:
...
See a [usage example](/src/oss/integrations/retrievers/linkup_search).
...
See a [usage example](/src/oss/integrations/tools/linkup_search).
