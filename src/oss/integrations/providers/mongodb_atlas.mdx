...
See [detail configuration instructions](/src/oss/integrations/vectorstores/mongodb_atlas).
...
See a [usage example](/src/oss/integrations/vectorstores/mongodb_atlas).
