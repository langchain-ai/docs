...
> [WhyLabs](https://docs.whylabs.ai/oss/) is an observability platform designed to monitor data pipelines and ML applications for data quality regressions, data drift, and model performance degradation. Built on top of an open-source package called `whylogs`, the platform enables Data Scientists and Engineers to:
>
...
* Org and Dataset [https://docs.whylabs.ai/oss/whylabs-onboarding](https://docs.whylabs.ai/oss/whylabs-onboarding#upload-a-profile-to-a-whylabs-project)
...
**API Reference:**[WhyLabsCallbackHandler](https://python.langchain.com/api_reference/community/callbacks/langchain_community.callbacks.whylabs_callback.WhyLabsCallbackHandler.html)
