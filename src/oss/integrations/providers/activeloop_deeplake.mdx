...
`Activeloop Deep Lake` supports `SelfQuery Retrieval`: [Activeloop Deep Lake Self Query Retrieval](/src/oss/integrations/retrievers/self_query/activeloop_deeplake_self_query)
...
See a [usage example](/src/oss/integrations/vectorstores/activeloop_deeplake).
