...
* Get your [API key](https://support.airtable.com/oss/creating-and-using-api-keys-and-access-tokens).
...
See an [example](/src/oss/integrations/document_loaders/airtable).
