...
This builds on top of ideas in the [ContextualCompressionRetriever](/oss/how_to/contextual_compression). Overall structure of this document came from [Cohere Reranker documentation](/oss/integrations/retrievers/cohere-reranker).
