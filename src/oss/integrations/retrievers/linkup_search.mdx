...
```
# import os# os.environ["LINKUP_API_KEY"] = ""  # Fill with your API key# os.environ["OPENAI_API_KEY"] = ""  # Fill with your API key
```
...
```
query = "Who won the latest US presidential elections?"retriever.invoke(query)
```
...
Like other retrievers, LinkupSearchRetriever can be incorporated into LLM applications via [chains](/src/oss/how_to/sequence).

We will need a LLM or chat model:

```
import ChatModelTabs from "@theme/ChatModelTabs";<ChatModelTabs customVarName="llm" />
```
