...
We can also incorporate retrievers into [chains](/oss/how_to/sequence) to build larger applications, such as a simple [RAG](/oss/tutorials/rag) application. For demonstration purposes, we instantiate an OpenAI chat model as well.
