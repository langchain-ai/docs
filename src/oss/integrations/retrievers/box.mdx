...
This will help you get started with the Box [retriever](/src/oss/concepts/retrievers). For detailed documentation of all BoxRetriever features and configurations head to the [API reference](https://python.langchain.com/api_reference/box/retrievers/langchain_box.retrievers.box.BoxRetriever.html).
...
Like other retrievers, BoxRetriever can be incorporated into LLM applications via [chains](/src/oss/how_to/sequence).
