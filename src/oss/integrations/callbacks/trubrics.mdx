...
Here are two examples of how to use the `TrubricsCallbackHandler` with Langchain [LLMs](/oss/how_to/#llms) or [Chat Models](/oss/how_to/#chat-models). We will use OpenAI models, so set your `OPENAI_API_KEY` key here:
