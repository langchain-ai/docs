...
This notebook goes over how to use [Firestore](https://cloud.google.com/firestore) to [save, load and delete langchain documents](/oss/how_to/#document-loaders) with `FirestoreLoader` and `FirestoreSaver`.
