...
In the below example we'll use the `AsyncChromiumLoader` to load the page, and then the [`Html2TextTransformer`](/src/oss/integrations/document_transformers/html2text) to strip out the HTML tags and other semantic information.
