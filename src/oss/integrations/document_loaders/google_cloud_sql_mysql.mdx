...
This notebook goes over how to use [Cloud SQL for MySQL](https://cloud.google.com/sql/mysql) to [save, load and delete langchain documents](/oss/how_to/#document-loaders) with `MySQLLoader` and `MySQLDocumentSaver`.
