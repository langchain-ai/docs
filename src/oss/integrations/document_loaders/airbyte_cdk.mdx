...
Note: `AirbyteCDKLoader` is deprecated. Please use [`AirbyteLoader`](/src/oss/integrations/document_loaders/airbyte) instead.
...
**API Reference:**[AirbyteCDKLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.airbyte.AirbyteCDKLoader.html)
