...
This notebook goes over how to use [Memorystore for Redis](https://cloud.google.com/memorystore/oss/redis/memorystore-for-redis-overview) to [save, load and delete langchain documents](/oss/how_to/#document-loaders) with `MemorystoreDocumentLoader` and `MemorystoreDocumentSaver`.
