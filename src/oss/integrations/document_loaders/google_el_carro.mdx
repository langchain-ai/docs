...
This guide goes over how to use El Carro Langchain integration to [save, load and delete langchain documents](/oss/how_to/#document-loaders) with `ElCarroLoader` and `ElCarroDocumentSaver`. This integration works for any Oracle database, regardless of where it is running.
