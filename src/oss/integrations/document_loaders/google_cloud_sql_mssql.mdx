...
This notebook goes over how to use [Cloud SQL for SQL server](https://cloud.google.com/sql/sqlserver) to [save, load and delete langchain documents](/src/oss/how_to/#document-loaders) with `MSSQLLoader` and `MSSQLDocumentSaver`.
