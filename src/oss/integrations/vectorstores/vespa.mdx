...
To use this vector store as a [LangChain retriever](/src/oss/how_to/#retrievers) simply call the `as_retriever` function, which is a standard vector store method:
