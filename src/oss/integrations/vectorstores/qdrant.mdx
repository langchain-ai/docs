...
* A [dense embeddings](https://python.langchain.com/oss/integrations/text_embedding/) value should be provided to the `embedding` parameter.
...
For detailed documentation of all `QdrantVectorStore` features and configurations head to the API reference: [https://python.langchain.com/api\_reference/qdrant/qdrant/langchain\_qdrant.qdrant.QdrantVectorStore.html](https://python.langchain.com/api_reference/qdrant/qdrant/langchain_qdrant.qdrant.QdrantVectorStore.html)
