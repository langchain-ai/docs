...
[![Open In Colab](/images/oss/integrations/vectorstores/google_cloud_sql_mysql/assets/colab-badge.svg)](https://colab.research.google.com/github/googleapis/langchain-google-cloud-sql-mysql-python/blob/main/oss/vector_store.ipynb)
...
* [Create a Cloud SQL instance.](https://cloud.google.com/sql/oss/mysql/connect-instance-auth-proxy#create-instance) (version must be >= **8.0.36** with **cloudsql\_vector** database flag configured to "On")
* [Create a Cloud SQL database.](https://cloud.google.com/sql/oss/mysql/create-manage-databases)
* [Add a User to the database.](https://cloud.google.com/sql/oss/mysql/create-manage-users)
...
For existing instances, you may need to perform a [self-service maintenance update](https://cloud.google.com/sql/oss/mysql/self-service-maintenance) to update your maintenance version to **MYSQL\_8\_0\_36.R20240401.03\_00** or greater. Once updated, [configure your database flags](https://cloud.google.com/sql/oss/mysql/flags) to have the new **cloudsql\_vector** flag to "On".
...
You can use any [LangChain embeddings model](/oss/integrations/text_embedding). You may need to enable the Vertex AI API to use `VertexAIEmbeddings`.

We recommend pinning the embedding model's version for production, learn more about the [Text embeddings models](https://cloud.google.com/vertex-ai/oss/generative-ai/model-reference/text-embeddings).
...
Speed up vector search queries by applying a vector index. Learn more about [MySQL vector indexes](https://github.com/googleapis/langchain-google-cloud-sql-mysql-python/blob/main/langchain_google_cloud_sql_mysql/indexes.py).
