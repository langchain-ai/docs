...
<Warning>
  You are currently on a page documenting the use of Together AI models as [text completion models](/src/oss/concepts/text_llms). Many popular Together AI models are [chat completion models](/src/oss/concepts/chat_models).

  You may be looking for [this page instead](/src/oss/integrations/chat/together).
</Warning>

[Together AI](https://www.together.ai/) offers an API to query [50+ leading open-source models](https://docs.together.ai/oss/inference-models) in a couple lines of code.
