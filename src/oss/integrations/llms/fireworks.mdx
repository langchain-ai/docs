...
<Warning>
  You are currently on a page documenting the use of Fireworks models as [text completion models](/src/oss/concepts/text_llms). Many popular Fireworks models are [chat completion models](/src/oss/concepts/chat_models).

  You may be looking for [this page instead](/src/oss/integrations/chat/fireworks).
</Warning>
