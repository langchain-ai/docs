...
[Baseten](https://baseten.co) is a [Provider](/src/oss/integrations/providers/baseten) in the LangChain ecosystem that implements the LLMs component.
...
**API Reference:**[Baseten](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.baseten.Baseten.html)

```
# Load the modelmistral = Baseten(model="MODEL_ID", deployment="production")
```

```
# Prompt the modelmistral("What is the Mistral wind?")
```
