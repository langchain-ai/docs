...
<Warning>
  You are currently on a page documenting the use of OpenAI [text completion models](/src/oss/concepts/text_llms). The latest and most popular OpenAI models are [chat completion models](/src/oss/concepts/chat_models).

  Unless you are specifically using `gpt-3.5-turbo-instruct`, you are probably looking for [this page instead](/src/oss/integrations/chat/openai).
</Warning>
