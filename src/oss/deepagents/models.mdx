...
- **Open-weight models** (we recommend [Baseten](/oss/integrations/providers/baseten) and [Fireworks](/oss/integrations/providers/fireworks) for hardware performance): GLM-5, Kimi-K2.5, MiniMax-M2.5
