...
<Note>
  Older OpenAI, Anthropic, and Google models not listed above tend to perform worse in our eval suite. If you want to use them, we recommend that you benchmark them on your particular use case.
</Note>
