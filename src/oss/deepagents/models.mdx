...
<Note>
  Older OpenAI, Anthropic, and Google models not listed above tend to perform worse on agentic tasks and are not recommended unless you've benchmarked them for your specific use case.
</Note>
