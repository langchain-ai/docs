...
Dynamic subagents require configured [subagents](/oss/deepagents/subagents) and [interpreter](/oss/deepagents/interpreters) middleware. Install and wire up the interpreter first, then add subagents to the agent.
