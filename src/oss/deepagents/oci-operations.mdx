---
title: Operating Deep Agents on OCI
sidebarTitle: Operations
description: Configure, operate, and troubleshoot Deep Agents with OCI services
---

:::python

For OCI agent setup, see
[Deep Agents on OCI](/oss/deepagents/oci).

For datastore configuration and Oracle Database persistence, see
[OCI retrieval](/oss/deepagents/oci-retrieval) and
[OCI persistence](/oss/deepagents/oci-persistence).
...
- **`interrupt_before/after` vs `interrupt_on`** are path-specific and
  ...
  [parameter reference](/oss/deepagents/oci#langgraph-options)).
