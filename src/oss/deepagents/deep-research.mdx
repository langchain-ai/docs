...
The spawned sub-agents will conduct web searches with Tavily, fetching full webpage content for analysis. You can also use [You.com](https://you.com) as an alternative search provider.
...
- Multi-step planning with the [built-in planning tool](/oss/deepagents/harness#task-planning)
...
- [Tavily](https://www.tavily.com/) or [You.com](https://you.com) for web search (optional - free tier sufficient)
