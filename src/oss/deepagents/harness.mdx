...
- Can use [default `general-purpose` subagent](/oss/deepagents/subagents#default-subagent) (enabled by default) or add [custom subagents](/oss/deepagents/subagents#using-subagent)
