...
| Type | Extensions |
| ---- | ---------- |
| [Image](/oss/langchain/messages#multimodal:imagecontentblock) | `.png`, `.jpg`, `.jpeg`, `.gif`, `.webp`, `.heic`, `.heif` |
| [Video](/oss/langchain/messages#multimodal:videocontentblock) | `.mp4`, `.mpeg`, `.mov`, `.avi`, `.flv`, `.mpg`, `.webm`, `.wmv`, `.3gpp` |
| [Audio](/oss/langchain/messages#multimodal:audiocontentblock) | `.wav`, `.mp3`, `.aiff`, `.aac`, `.ogg`, `.flac` |
| [File](/oss/langchain/messages#multimodal:filecontentblock) | `.pdf`, `.ppt`, `.pptx` |
