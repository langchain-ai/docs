...
To handle long-running tasks, deep agents make use of effective context management. For a comprehensive guide to context engineering in Deep Agents—input context, runtime context, compression, isolation, and long-term memory—see [Context engineering](/oss/deepagents/context-engineering).
