...
The virtual filesystem is used by several other harness capabilites such as skills, memory, code execution, and context management.
...
Input context consists of sources of information provided to your deep agent at startup which is added ot the prompt.
...
You can also confiure deep agents to use [long-term memory](#long-term-memory) to allow them to store information across different threads and conversations.
