...
Deep agents also include built-in middleware like `SkillsMiddleware` for loading [agent skills](https://agentskills.io/). See [`SkillsMiddleware`](/oss/deepagents/skills#skillsmiddleware) for details.
