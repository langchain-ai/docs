...
- [`write_todos`](/oss/deepagents/harness#to-do-list-tracking) – Update the agent's to-do list
- [`ls`](/oss/deepagents/harness#file-system-access) – List all files in the agent's filesystem
- [`read_file`](/oss/deepagents/harness#file-system-access) – Read a file from the agent's filesystem
- [`write_file`](/oss/deepagents/harness#file-system-access) – Write a new file in the agent's filesystem
- [`edit_file`](/oss/deepagents/harness#file-system-access) – Edit an existing file in the agent's filesystem
- [`task`](/oss/deepagents/harness#task-delegation-subagents) – Spawn a subagent to handle a specific task

On top of the default tools, you can add custom tools.
