...
- [Middleware](#middleware), including [custom middleware](#custom-middleware) for tools, hooks, and cross-cutting concerns
- [Subagents](#subagents)
...
<Tip>
    Need behavior that isn't covered by the built-in options? Deep Agents support [custom middleware](#custom-middleware), so you can plug in your own tools, hooks, retries, fallbacks, PII detection, logging, and other cross-cutting concerns alongside the defaults.
</Tip>
