...
:::python
<Info>
Using Oracle Cloud Infrastructure? See [Deep Agents on OCI](/oss/deepagents/oci) for the `langchain-oci` factory, OCI Generative AI models, and Oracle-backed retrieval.
</Info>
:::
...
<CardGroup cols={2}>
    ...
    <Card title="OCI" icon="cloud" href="/oss/deepagents/oci">
        Build Deep Agents with Oracle Cloud Infrastructure
    </Card>
