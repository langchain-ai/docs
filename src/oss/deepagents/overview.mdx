...
- Control where your deep agent can write to in the filesystem by configuring the deep agent's [memory](/oss/deepagents/long-term-memory)
- If your deep agent can write to your filesystem's disk, we recommend you enable [human-in-the-loop workflows](/oss/deepagents/human-in-the-loop) to require human approval before execution of sensitive tool operations.
