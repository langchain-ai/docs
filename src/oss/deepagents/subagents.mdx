...
graph TD
    ...
    Delegate -->|task description| Isolated["Isolated subagent:<br/>starts from nothing, re-reviews the diff"]
    Delegate -->|parent history + task description| Fork["Forked subagent:<br/>already knows the issues, writes comments directly"]
```
