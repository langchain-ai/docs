...
:::python
<Note>
    The example below uses [Tavily](https://www.tavily.com/) for web search. You can substitute any search API, including [You.com](/oss/integrations/providers/you).
</Note>
...
:::js
<Note>
    The example below uses [Tavily](https://www.tavily.com/) for web search. You can substitute any search API, including [You.com](/oss/integrations/providers/youdotcom).
</Note>
