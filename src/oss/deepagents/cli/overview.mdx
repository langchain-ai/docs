...
<Steps>
    <Step title="Set model credentials for your provider" icon="key">
        ...
        <Tabs>
            ...
            <Tab title="Other">
                The CLI works with any LLM that supports tool calling. See [Model providers](/oss/deepagents/cli/providers) for the full list of supported providers and their required environment variables.
