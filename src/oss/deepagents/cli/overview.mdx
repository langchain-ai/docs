...
* <Icon icon="search" size={16} /> **Web search** - search the web for up-to-date information and documentation. Requires a [Tavily](https://tavily.com) API key in `TAVILY_API_KEY` — see [Enable web search](/oss/deepagents/cli/configuration#enable-web-search-with-tavily).
