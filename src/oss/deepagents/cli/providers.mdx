...
2. **Set credentials**
    ...
    To configure model parameters, see [Model parameters](/oss/deepagents/cli/providers#model-parameters).

    You can also scope credentials to the CLI with the [`DEEPAGENTS_CLI_` prefix](/oss/deepagents/cli/configuration#deepagents_cli_-prefix).
