...
The `/model` selector dynamically builds its list from installed provider packages. Not every model shows up — expand below for the full criteria and troubleshooting.
