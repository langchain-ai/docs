...
You can implement a fully custom backend to connect Deep Agents to any storage system — databases, object stores, virtual filesystems, and more. Community-built backends are listed on the [backends integrations page](/oss/python/integrations/backends).
