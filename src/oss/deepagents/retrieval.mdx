...
:::python
<Info>
For an OCI implementation of agentic retrieval over Oracle Autonomous Database or OpenSearch, including routed multi-store search and hybrid retrieval, see [Deep Agents on OCI retrieval](/oss/deepagents/oci-retrieval).
</Info>
:::
