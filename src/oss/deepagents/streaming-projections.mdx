...
<Note>
Interested in lower-level Pregel stream modes and the existing Deep Agents streaming guide? See the [Mode Streaming page](/oss/deepagents/streaming).
</Note>
...
- [LangChain streaming projections](/oss/langchain/streaming-projections) covers general agent message and tool-call streaming concepts.
...
- [LangGraph Projection Streaming](/oss/langgraph/streaming/projection-streaming) covers the underlying graph streaming model.
