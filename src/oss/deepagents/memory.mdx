...
| **Information type** | What kind of information is it? | [Episodic](#episodic-memory) (past experiences), [procedural](#skills-as-procedural-memory) (instructions and skills), or [semantic](/oss/concepts/memory#semantic-memory) (facts) |
...
For a complete guide on defining, organizing, and using skills, see the [Skills](/oss/deepagents/skills) documentation.
