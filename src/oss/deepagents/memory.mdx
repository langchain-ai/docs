...
1. **Configure memory.** Pass file paths to `memory=` and optional [skills](/oss/deepagents/skills) to `skills=`. A [backend](/oss/deepagents/backends) controls storage and access.
