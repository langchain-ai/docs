...
<Tip>
    **Using LangSmith Gateway**
    ...
    The [LangSmith Gateway](/langsmith/llm-gateway) routes most major providers through LangSmith. You can [bring your own provider keys](/langsmith/llm-gateway-quickstart#1-make-your-first-request), or use [Gateway Credits](/langsmith/llm-gateway-langchain-provider#make-a-call) to access models without a provider key.
</Tip>
