...
[LangSmith](https://smith.langchain.com) provides you with visibility into your agent's execution, allowing you to view planning steps, tool calls, subagent delegation, and LLM responses.
