...
<Tip>
    **Using an AI coding assistant?**
    ...
    - Install the [LangChain Docs MCP server](/use-these-docs) (`https://docs.langchain.com/mcp`) to give your agent access to up-to-date LangChain guides, tutorials, and how-tos.
    - Install the [LangChain API Reference MCP server](/use-these-docs) (`https://reference.langchain.com/mcp`) to give your agent access to API reference docs — classes, methods, and parameters. Adding both is recommended for the best coding experience.
