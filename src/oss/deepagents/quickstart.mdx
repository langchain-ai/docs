...
3. **Manages context** by using file system tools ([`write_file`](/oss/deepagents/harness#file-system-access), [`read_file`](/oss/deepagents/harness#file-system-access)) to offload large search results
