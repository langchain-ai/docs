...
<Tip>
    **Using LangSmith Gateway**
    ...
    The [LangSmith Gateway](/langsmith/llm-gateway-quickstart#using-langchain-and-deep-agents) routes most major providers through LangSmith using your LangSmith API key. Use [Gateway Credits](/langsmith/llm-gateway-langchain-provider#make-a-call) to access models without a provider key.
</Tip>
