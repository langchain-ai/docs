...
<Prompt
    description="Build the Deep Agents research quickstart"
    icon="sparkles"
    actions={["copy"]}
>
...
<Tip>
    **Using LangSmith Gateway**
    ...
    The [LangSmith Gateway](/langsmith/llm-gateway) routes most major providers through LangSmith. You can [bring your own provider keys](/langsmith/llm-gateway-quickstart#make-a-call), or use [Gateway Credits](/langsmith/llm-gateway-credits) to access models without a provider key.
</Tip>
