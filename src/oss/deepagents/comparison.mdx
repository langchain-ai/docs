...
<Info>
    Deep agents are used in production by [OpenSWE](https://github.com/langchain-ai/open-swe) and [LangSmith Fleet](/langsmith/fleet/index).
</Info>
...
Deep Agents support both, and let you pick a [backend](/oss/deepagents/backends#quickstart) to wire them together. In practice, this means you can:
