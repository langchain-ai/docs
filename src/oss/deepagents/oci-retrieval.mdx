---
title: OCI retrieval for Deep Agents
sidebarTitle: Retrieval
description: Retrieve documents for Deep Agents from Oracle Autonomous Database and OpenSearch
---
...
For generic retrieval patterns, see
[Retrieval](/oss/deepagents/retrieval) and
[RAG](/oss/deepagents/rag).
...
- Pass any LangChain `Embeddings` implementation via `embedding_model=` to opt
  ...
  [Operations](/oss/deepagents/oci-operations#bring-your-own-model)).
