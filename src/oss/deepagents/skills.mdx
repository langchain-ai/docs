...
Functional skills are skills that expose code modules to an [interpreter](/oss/deepagents/interpreters). Regular skills give the agent instructions and context. Functional skills also give the agent importable functions it can call from interpreter code.
