...
:::python
Each skill source path must point to a directory that contains skill directories. Python does not discover a source path that points directly to a skill directory containing `SKILL.md`.
:::

:::js
Each skill source path can point either to a directory that contains skill directories or directly to a skill directory containing `SKILL.md`.
:::
