---
title: OCI persistence for Deep Agents
sidebarTitle: Persistence
description: Persist Deep Agent state, memory, and files in Oracle Database
---

:::python

For an overview of the OCI integration, see
[Deep Agents on OCI](/oss/deepagents/oci).

For generic Deep Agents storage and production guidance, see
[Backends](/oss/deepagents/backends) and
[Going to production](/oss/deepagents/going-to-production).
...
[`langgraph-oracledb` README](https://github.com/oracle/langchain-oracle/blob/main/libs/langgraph-oracledb/README.md) for index
configuration.
*/}
...
[Core guide](/oss/deepagents/oci#the-two-build-paths).)
...
[`samples/11-deepagents/persistence_oracle_example.py`](https://github.com/fede-kamel/langchain-oracle/blob/docs/deepagents-exhaustive-docs/samples/11-deepagents/persistence_oracle_example.py).
*/}
