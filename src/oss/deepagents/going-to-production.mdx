...
:::python
For self-hosted persistence in Oracle Database, use `OracleSaver` from `langgraph-oracledb`. See [Persist Deep Agents on Oracle Database](/oss/deepagents/oci-persistence) for setup, pooling, async usage, and checkpoint inspection.
:::
</Tip>
