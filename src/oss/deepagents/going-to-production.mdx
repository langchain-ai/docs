...
| Path | Use when |
| --- | --- |
| [Managed Deep Agents API](/langsmith/managed-deep-agents-api) | You want the managed private preview API for creating and invoking Managed Deep Agents. |
...
The `deepagents deploy` CLI path is deprecated and remains documented for existing CLI users in [Deploy with Managed Deep Agents](/oss/deepagents/deploy). For standard LangSmith Deployment setup, see the [LangSmith Deployments quickstart](/langsmith/deployment-quickstart).
