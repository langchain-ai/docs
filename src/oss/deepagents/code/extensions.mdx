...
description: Customize dcode with Python tools, middleware, storage routes, and shutdown hooks
---

Python extensions customize the dcode agent server without modifying dcode itself. Use them to register model tools, LangChain middleware, virtual storage routes, and shutdown hooks.
