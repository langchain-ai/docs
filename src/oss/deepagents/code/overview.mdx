...
* <Icon icon="target-arrow" size={16} /> **[Goals and rubrics](/oss/deepagents/code/goals-and-rubrics)** - define measurable objectives or grading criteria so the agent can check whether work is done.
