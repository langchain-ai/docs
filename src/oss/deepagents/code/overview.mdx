...
<AccordionGroup>
    <Accordion title="Command-line options" icon="flag">
        ...
        | `--sandbox TYPE`       | Remote sandbox for code execution: `none` (default), `langsmith`, `agentcore`, `modal`, `daytona`, `runloop`, `e2b`. LangSmith is included; AgentCore/Modal/Daytona/Runloop install as extras; E2B installs as a package. See [Use remote sandboxes](/oss/deepagents/code/remote-sandboxes) |
