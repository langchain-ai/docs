...
Rates are in USD per million tokens. Restart Deep Agents Code after editing the file. Custom rates apply only when the main catalog does not include the model.
