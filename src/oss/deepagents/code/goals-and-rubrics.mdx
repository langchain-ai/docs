...
<Accordion title="Review behavior by approval mode">
    ...
    - **Auto**: Opens the review by default. Set [`goals.auto_accept_criteria = true`](/oss/deepagents/code/config-file#goal-criteria-review) to apply generated criteria automatically.
