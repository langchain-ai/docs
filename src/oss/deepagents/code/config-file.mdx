...
<ResponseField name="enabled" type="boolean" default="true" post={["optional"]}>
    Enable Python extension discovery. Set `DEEPAGENTS_CODE_EXTENSIONS` to override this value. Both settings require `DEEPAGENTS_CODE_EXPERIMENTAL=1` before starting Deep Agents Code.
</ResponseField>
