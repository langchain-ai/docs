...
**Harness profiles** define defaults for a provider or model. They customize prompts, tools, middleware, and the general-purpose subagent. Deep Agents applies them whenever you select a matching model.
