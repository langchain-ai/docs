...
- [Long-term memory](/oss/deepagents/memory) for TODO
...
When you later create the agent and specify this file as part of the [memory](/oss/deepagents/memory) parameter, it gets loaded this into the system prompt so brand voice and research expectations apply to every run.
