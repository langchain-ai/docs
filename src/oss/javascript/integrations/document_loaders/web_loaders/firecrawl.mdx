...
This notebook provides a quick overview for getting started with `FireCrawlLoader` [document loaders](/oss/integrations/document_loaders/). For detailed documentation of all `FireCrawlLoader` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
| :--- | :--- | :---: | :---: |  :---: |
| [`FireCrawlLoader`](https://docs.langchain.com/oss/javascript/reference/overview) | [`@langchain/community`](https://docs.langchain.com/oss/javascript/reference/overview) | 🟠 (see details below) | beta | ✅ |
...
For detailed documentation of all `FireCrawlLoader` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
