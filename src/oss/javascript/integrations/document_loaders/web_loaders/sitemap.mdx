...
This notebook goes over how to use the [`SitemapLoader`](https://docs.langchain.com/oss/javascript/reference/overview) class to load sitemaps into `Document`s.
