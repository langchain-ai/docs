...
| :--- | :--- | :---: | :---: |  :---: |
| [`CheerioWebBaseLoader`](https://docs.langchain.com/oss/javascript/reference/overview) | @langchain/community | ✅ | ✅ | ❌ |
...
For detailed documentation of all `CheerioWebBaseLoader` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
