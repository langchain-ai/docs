...
This notebook provides a quick overview for getting started with `LangSmithLoader` [document loaders](/oss/integrations/document_loaders/). For detailed documentation of all `LangSmithLoader` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
| :--- | :--- | :---: | :---: |  :---: |
| [`LangSmithLoader`](https://docs.langchain.com/oss/javascript/reference/overview) | [`@langchain/community`](https://docs.langchain.com/oss/javascript/reference/overview) | ✅ | beta | ✅ |
...
For detailed documentation of all `LangSmithLoader` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview)
