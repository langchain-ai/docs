...
| :--- | :--- | :---: | :---: |  :---: |
| [`ApifyDatasetLoader`](https://docs.langchain.com/oss/javascript/reference/overview) | [`@langchain/community`](https://docs.langchain.com/oss/javascript/reference/overview) | ❌ | ❌ | ✅ |
