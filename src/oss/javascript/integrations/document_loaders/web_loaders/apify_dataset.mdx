...
- **Access to a thousand pre-built Actors** for various platforms (social media, e-commerce, search engines, etc.)
...
- **Pay-Per-Event pricing** for transparent, predictable costs in agent deployments
...
The Apify Store contains 3,000+ pre-built Actors. Here are examples of other popular Actors you can use with the document loader:
