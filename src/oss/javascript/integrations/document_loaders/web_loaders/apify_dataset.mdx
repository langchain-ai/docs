...
- **Access to 10,000+ pre-built Actors** for various platforms (social media, e-commerce, search engines, etc.)
...
The Apify Store contains 10,000+ pre-built Actors. Here are examples of other popular Actors you can use with the document loader:
