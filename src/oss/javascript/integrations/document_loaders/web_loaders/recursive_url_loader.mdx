...
This notebook provides a quick overview for getting started with `RecursiveUrlLoader` [document loaders](/oss/integrations/document_loaders/). For detailed documentation of all `RecursiveUrlLoader` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
| :--- | :--- | :---: | :---: |  :---: |
| [`RecursiveUrlLoader`](https://docs.langchain.com/oss/javascript/reference/overview) | [`@langchain/community`](https://docs.langchain.com/oss/javascript/reference/overview) | ✅ | beta | ❌ |
...
For detailed documentation of all RecursiveUrlLoader features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
