...
[Long-term memory](/oss/langchain/long-term-memory) lets your agent store and recall information across different conversations and sessions. This guide shows how to use [MongoDB Atlas](https://www.mongodb.com/docs/atlas/) as the persistent store backend.
...
For more information about store operations, see the [Stores](/oss/langgraph/stores) guide.
...
- [Long-term memory](/oss/langchain/long-term-memory)
- [Stores](/oss/langgraph/stores)
- [Store integrations](/oss/integrations/long-term-memory)
- [Short-term memory with MongoDB Atlas](/oss/integrations/memory/mongodb-short-term-memory)
