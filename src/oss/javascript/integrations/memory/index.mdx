...
Memory integrations provide persistent backends for [short-term memory](/oss/langchain/short-term-memory) and [long-term memory](/oss/langchain/long-term-memory).
