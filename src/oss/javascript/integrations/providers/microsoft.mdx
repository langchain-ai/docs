...
<Tip>
    **Recommended sample: Azure OpenAI starter kit**

    Start with [Azure-Samples/langchain-azure-openai-starter](https://github.com/Azure-Samples/langchain-azure-openai-starter), a production-ready LangChain and Azure OpenAI app template that lets developers deploy directly to Azure with a single `azd` command.
</Tip>
