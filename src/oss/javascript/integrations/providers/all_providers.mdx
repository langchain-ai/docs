...
<Columns cols={3}>
  <Card
    ...
    icon="route"
  >
    Classify state into typed decisions and calibrated probabilities with Jev.
  </Card>
</Columns>
...
<Columns cols={3}>
  ...
  <Card
    title="aiworker"
    href="https://github.com/ai-worker227/aiworker-examples/tree/main/langchain"
    icon="link"
  >
    Paid data tools (DeFi yields, page-to-Markdown, Base token and wallet checks, Polymarket odds, history and backtests, fact checks, headline search) built from aiworker's live OpenAPI catalogue; each call pays itself in USDC over the x402 protocol from the agent's wallet, no API key.
  </Card>
  ...
  <Card
    ...
    href="https://github.com/zerohourzulu/continuity/blob/main/packages/remote-tools/README.md#langchain-tools"
    icon="link"
  >
  ...
  <Card
    title="Corsair"
    href="https://docs.corsair.dev/mcp-adapters/langchain"
    icon="link"
  >
    Exposes 200+ service integrations (Slack, GitHub, Gmail, Linear, Stripe, and others) to LangChain agents as tools. OAuth runs server-side and credentials stay in the developer's own database.
  </Card>
  ...
  <Card
    title="Pushary"
    href="https://github.com/Pushary/pushary-langgraph"
    icon="link"
  >
  ...
  <Card
    title="SIGNA"
    href="https://github.com/codexvritra/signa/tree/main/sdk/langchain"
    icon="link"
  >
  ...
  <Card
    title="Sato Hub"
    href="https://github.com/satohubai/sato-hub-integrations/tree/main/packages/satohub-langchain-tools#readme"
    icon="link"
  >
    Four keyless tools over Sato Hub's daily-rebuilt index of onchain-agent building blocks: search listings, run a Preflight lookup on a repo, package, MCP endpoint or token, get a swap-venue recommendation with the fee stated, and turn a goal into a build plan of listed projects.
  </Card>
...
<Columns cols={3}>
  ...
  <Card
    title="FoxNose"
    href="https://github.com/FoxNoseTech/langchain-foxnose-js#readme"
    icon="link"
  >
...
<Columns cols={3}>
  <Card
    title="OpenInference"
    href="https://arize.com/docs/ax/integrations/python-agent-frameworks/langchain/langchain-tracing"
    icon="link"
  >
