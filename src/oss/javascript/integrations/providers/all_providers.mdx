...
<Columns cols={3}>
  ...
  >
    Oracle Cloud Infrastructure Generative AI through LangChain.js.
  </Card>
...
<Columns cols={3}>
  ...
  <Card
    title="Oracle Cloud Infrastructure (OCI)"
    href="/oss/integrations/embeddings/oci_generative_ai"
  >
    Text embeddings through OCI Generative AI.
  </Card>
