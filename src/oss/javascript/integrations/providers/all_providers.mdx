...
<Columns cols={3}>
  ...
  <Card
    ...
    icon="link"
  >
    aiworker sells small data routes to agents, paid per call in USDC over the x402 protocol on Base and Solana (no account, no API key): DeFi yields and protocol snapshots, page-to-Markdown, Base token safety cards,  and more.
  </Card>
