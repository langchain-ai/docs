...
| :--- | :--- | :---: | :---: | :---: |
| [`ExaSearchResults`](https://docs.langchain.com/oss/javascript/reference/overview) | [`@langchain/exa`](https://npmjs.com/package/@langchain/exa) | ❌ | ✅ |  ![NPM - Version](https://img.shields.io/npm/v/@langchain/exa?style=flat-square&label=%20&) |
...
For detailed documentation of all `ExaSearchResults` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview)
