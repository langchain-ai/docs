...
This will help you getting started with `OpenApiToolkit` [OpenAPI toolkit](/oss/integrations/tools/openapi). For detailed documentation of all `OpenApiToolkit` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
For detailed documentation of all `OpenApiToolkit` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
