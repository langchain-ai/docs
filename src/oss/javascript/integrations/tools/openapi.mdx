...
This will help you getting started with `OpenApiToolkit` [OpenAPI toolkit](/oss/integrations/tools/openapi). `OpenApiToolkit` now lives in `@langchain/classic`. For migration details, see the [LangChain v1 migration guide](/oss/migrate/langchain-v1#langchainclassic).
