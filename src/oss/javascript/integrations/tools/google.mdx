...
If you are using Gemini Enterprise Agent Platform (`platformType: "gcp"`), you can ground responses using an Agent Search on Gemini Enterprise Agent Platform data store.
...
For more information, see [Google's Agent Search on Gemini Enterprise Agent Platform grounding documentation](https://cloud.google.com/vertex-ai/generative-ai/docs/grounding/ground-with-vertex-ai-search).
