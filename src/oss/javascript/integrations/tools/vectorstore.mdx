...
This will help you getting started with `VectorStoreToolkit` [toolkits](/oss/langchain/tools#toolkits). For detailed documentation of all `VectorStoreToolkit` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
For detailed documentation of all `VectorStoreToolkit` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
