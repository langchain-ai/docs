...
This will help you getting started with `AzionRetriever` [retrieval](/oss/langchain/retrieval). For detailed documentation of all `AzionRetriever` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).

### Integration details

| Retriever | Self-host | Cloud offering | Package | [Py support] |
| :--- | :---: | :---: | :---: | :---: |
[AzionRetriever](https://docs.langchain.com/oss/javascript/reference/overview) | ❌ | ❌ | @langchain/community | ❌ |
...
For detailed documentation of all `AzionRetriever` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
