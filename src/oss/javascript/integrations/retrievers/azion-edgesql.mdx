...
This will help you getting started with `AzionRetriever` [retrieval](/oss/langchain/retrieval). For detailed documentation of all `AzionRetriever` features and configurations head to the [API reference](https://api.js.langchain.com/classes/_langchain_community.retrievers_azion_edgesql.AzionRetriever.html).
