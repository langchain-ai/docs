---
title: "TavilySearchAPIRetriever (Legacy) integration"
...
<Note>
For new projects, we recommend the [TavilySearch](/oss/integrations/tools/tavily_search) tool in the `@langchain/tavily` package. This retriever still works but is part of the legacy `@langchain/community` package.
</Note>
