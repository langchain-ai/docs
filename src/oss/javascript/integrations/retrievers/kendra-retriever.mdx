...
This will help you getting started with `AWSKendraRetriever` [retrieval](/oss/langchain/retrieval). For detailed documentation of all `AWSKendraRetriever` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).

### Integration details

| Retriever | Source | Package |
| :--- | :--- | :---: |
[AWSKendraRetriever](https://docs.langchain.com/oss/javascript/reference/overview) | Various AWS resources | [`@langchain/aws`](https://www.npmjs.com/package/@langchain/aws) |
...
For detailed documentation of all `AmazonKendraRetriever` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
