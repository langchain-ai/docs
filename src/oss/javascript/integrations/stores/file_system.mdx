...
This will help you get started with [`LocalFileStore`](/oss/integrations/stores). For detailed documentation of all `LocalFileStore` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
| :--- | :--- | :---: | :---: |  :---: | :---: |
| [`LocalFileStore`](https://docs.langchain.com/oss/javascript/reference/overview) | [langchain](https://docs.langchain.com/oss/javascript/reference/overview) | ✅ | ✅ | ![NPM - Downloads](https://img.shields.io/npm/dm/langchain?style=flat-square&label=%20&) | ![NPM - Version](https://img.shields.io/npm/v/langchain?style=flat-square&label=%20&) |
...
For detailed documentation of all `LocalFileStore` features and configurations, head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview)
