...
All [`BaseStores`](https://docs.langchain.com/oss/javascript/reference/overview) are **generic** and support the following interface, where `K` represents the key type and `V` represents the value type:
...
You can also implement your own custom store by extending the @[`BaseStore`] class. See the [store interface documentation](https://docs.langchain.com/oss/javascript/reference/overview) for more details.
