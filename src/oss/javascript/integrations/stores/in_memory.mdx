...
This will help you get started with [InMemoryStore](/oss/integrations/stores). For detailed documentation of all `InMemoryStore` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
For detailed documentation of all `InMemoryStore` features and configurations, head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview)
