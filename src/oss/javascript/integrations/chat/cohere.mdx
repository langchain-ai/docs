...
This will help you getting started with `ChatCohere` [chat models](/oss/langchain/models). For detailed documentation of all `ChatCohere` features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain_cohere.ChatCohere.html).
