...
This will help you getting started with `ChatCohere` [chat models](/oss/langchain/models). For detailed documentation of all `ChatCohere` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| [`ChatCohere`](https://docs.langchain.com/oss/javascript/reference/overview) | [`@langchain/cohere`](https://www.npmjs.com/package/@langchain/cohere) | beta | ✅ | ![NPM - Downloads](https://img.shields.io/npm/dm/@langchain/cohere?style=flat-square&label=%20&) | ![NPM - Version](https://img.shields.io/npm/v/@langchain/cohere?style=flat-square&label=%20&) |
...
For detailed documentation of all `ChatCohere` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
