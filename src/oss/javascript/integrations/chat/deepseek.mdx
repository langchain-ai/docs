...
This will help you getting started with `ChatDeepSeek` [chat models](/oss/langchain/models). For detailed documentation of all `ChatDeepSeek` features and configurations head to the [API reference](https://api.js.langchain.com/classes/_langchain_deepseek.ChatDeepSeek.html).
