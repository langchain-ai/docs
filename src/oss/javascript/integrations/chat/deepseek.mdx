...
This will help you getting started with `ChatDeepSeek` [chat models](/oss/langchain/models). For detailed documentation of all `ChatDeepSeek` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
For detailed documentation of all `ChatDeepSeek` features and configurations head to the API reference: https://docs.langchain.com/oss/javascript/reference/overview
