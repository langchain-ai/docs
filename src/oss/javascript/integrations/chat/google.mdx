...
[Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai) service.
...
Gemini Enterprise Agent Platform also supports [Express Mode](https://cloud.google.com/vertex-ai/docs/start/introduction-unified-platform#express-mode),
...
When using [Gemini Enterprise Agent Platform Express Mode](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/start/express-mode/overview), you will also need to specify the platform
...
an Agent Search on Gemini Enterprise Agent Platform data store.
