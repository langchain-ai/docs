...
<Tip>
You can also access Google's `gemini` family of models via the LangChain `VertexAI` and `VertexAI-web` integrations. See the [Gemini Enterprise Agent Platform docs](/oss/integrations/chat/google_vertex_ai).
</Tip>
