...
This will help you getting started with IBM watsonx.ai [chat models](/oss/langchain/models). For detailed documentation of all `IBM watsonx.ai` features and configurations head to the [IBM watsonx.ai](https://docs.langchain.com/oss/javascript/reference/overview).
...
For detailed documentation of all `IBM watsonx.ai` features and configurations head to the API reference: [API docs](https://docs.langchain.com/oss/javascript/reference/overview)
