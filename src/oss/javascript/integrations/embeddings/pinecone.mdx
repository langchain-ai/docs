...
This will help you get started with PineconeEmbeddings [embedding models](/oss/integrations/embeddings) using LangChain. For detailed documentation on `PineconeEmbeddings` features and configuration options, please refer to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
For detailed documentation of all `PineconeEmbeddings` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
