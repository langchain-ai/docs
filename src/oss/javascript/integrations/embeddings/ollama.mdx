...
This will help you get started with Ollama [embedding models](/oss/integrations/embeddings) using LangChain. For detailed documentation on `OllamaEmbeddings` features and configuration options, please refer to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview).
...
| :--- | :--- | :---: | :---: |  :---: | :---: |
| [`OllamaEmbeddings`](https://docs.langchain.com/oss/javascript/reference/overview) | [`@langchain/ollama`](https://npmjs.com/@langchain/ollama) | ✅ | ✅ | ![NPM - Downloads](https://img.shields.io/npm/dm/@langchain/ollama?style=flat-square&label=%20&) | ![NPM - Version](https://img.shields.io/npm/v/@langchain/ollama?style=flat-square&label=%20&) |
...
For detailed documentation of all `OllamaEmbeddings` features and configurations head to the [API reference](https://docs.langchain.com/oss/javascript/reference/overview)
