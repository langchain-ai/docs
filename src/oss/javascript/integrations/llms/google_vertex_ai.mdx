...
<Warning>
**You are currently on a page documenting the use of Gemini Enterprise Agent Platform models as text completion models. Many popular models available on Gemini Enterprise Agent Platform are [chat completion models](/oss/langchain/models).**
