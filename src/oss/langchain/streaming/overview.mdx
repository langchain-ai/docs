...
You can stream these thinking / reasoning tokens as they're generated by filtering [standard content blocks](/oss/langchain/messages#standard-content-blocks) for the `type` `"reasoning"`.
