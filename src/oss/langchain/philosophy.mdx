---
title: Philosophy
description: LangChain exists to be the easiest place start building with LLMs, while also being flexible and production-ready.
mode: wide
---
...
The main issue with building agents is getting them to be reliable, and LangSmith, which provided observability and evals, was built to solve that need. LangChain was updated to integrate seamlessly with LangSmith.
</Card>
