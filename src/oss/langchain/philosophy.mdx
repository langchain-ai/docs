...
<Card title="October 24, 2022: LangChain launched as a Python package" horizontal>
    A month before ChatGPT, LangChain was launched as a Python package. It consisted of two main components: LLM abstractions, and high level "chains" for common use cases.
