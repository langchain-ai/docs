...
Start with [Deep Agents](/oss/deepagents/overview/) for a "batteries-included" agent with automatic context compression, a virtual filesystem, and subagent-spawning. Deep Agents are built on LangChain [agents](/oss/langchain/agents) — use LangChain directly if you want to customize your own. Use [LangGraph](/oss/langgraph/overview), our low-level orchestration framework, for advanced needs combining deterministic and agentic workflows.
</Tip>
