...
<CodeGroup>
    ...
    # Initialize the agent with a US Cross-Region Inference Profile for Claude 4.6.
    # Note: For worldwide routing without data residency constraints, 'global.' can be used instead.
    agent = create_agent(
