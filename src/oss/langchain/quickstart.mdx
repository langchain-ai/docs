...
```
  ...
  <Tab title="Other">
    See the full list of supported providers and model integrations:
    - [Supported providers](/oss/integrations/providers/overview)
    - [Chat model integrations](/oss/integrations/chat)
  </Tab>
</Tabs>
