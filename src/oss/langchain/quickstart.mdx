...
If this is your first time working with LangChain, we recommend you start by creating a deep agent.
...
<Steps>
    ...
    <Step title="Define response format">
        Optionally, define a [structured response format](/oss/langchain/structured-output) if you need the agent responses to match a specific schema.
