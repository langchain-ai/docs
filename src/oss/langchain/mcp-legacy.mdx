---
title: Model Context Protocol (MCP) with langchain-mcp-adapters
sidebarTitle: MCP (langchain-mcp-adapters)
...
:::python
<Warning>
This page documents the standalone [`langchain-mcp-adapters`](https://github.com/langchain-ai/langchain-mcp-adapters) package. LangChain now ships MCP support in the built-in `langchain.mcp` namespace, built on FastMCP. See the [current MCP documentation](/oss/langchain/mcp) and the [migration guide](/oss/migrate/langchain-mcp-adapters).
</Warning>
