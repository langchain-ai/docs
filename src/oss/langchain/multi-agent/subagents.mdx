---
title: Subagents
description: Build multi-agent systems where a main agent coordinates specialized subagents as tools, providing centralized control and context isolation.
---
