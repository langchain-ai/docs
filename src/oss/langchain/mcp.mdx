...
Use a local URL for servers you run yourself, or a hosted URL for a public server. LangChain provides two public MCP servers you can use without an API key — [LangChain Docs](/use-these-docs) (`https://docs.langchain.com/mcp`) for guides and tutorials, and [LangChain API Reference](/use-these-docs) (`https://reference.langchain.com/mcp`) for API reference docs. Adding both is recommended when building coding agents.
...
client = MultiServerMCPClient(
    {
        "docs-langchain": {
            "transport": "http",
            "url": "https://docs.langchain.com/mcp",      # Guides, tutorials, how-tos
        },
        "reference-langchain": {
            "transport": "http",
            "url": "https://reference.langchain.com/mcp", # API reference: classes, methods, params
        },
    }
)
