...
<Columns cols={2}>
  ...
  <Card title="Sequential constraints" icon="lock">
...
| Pattern | Distributed development | Parallelization | Multi-turn | Direct user interaction |
|---------|:-----------------------:|:---------------:|:----------:|:-----------------------:|
| [**Subagents**](#subagents) | ⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐ | — |
| [**Handoffs**](#handoffs) | — | — | ⭐⭐⭐ | ⭐⭐⭐ |
| [**Skills**](#skills) | ⭐⭐ | — | — | ⭐⭐⭐ |
...
- **Distributed development**: Can different teams develop and maintain components independently?
- **Parallelization**: Can multiple agents execute concurrently?
- **Multi-turn**: Does the pattern support multi-turn conversations with state across turns?
- **Direct user interaction**: Can subagents/components converse directly with the user?
