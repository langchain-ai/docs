...
<Columns cols={2}>
    <Card title="Anthropic" href="/oss/integrations/providers/anthropic#middleware" icon="message" arrow>
        Prompt caching, bash tool, text editor, memory, and file search middleware for Claude models.
    </Card>
    <Card title="OpenAI" href="/oss/integrations/providers/openai#middleware" icon="robot" arrow>
