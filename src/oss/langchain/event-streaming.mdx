...
See [Custom projections](/oss/langgraph/streaming/custom-projections) for the transformer contract.

## Related

- [Pregel Streaming](/oss/langchain/streaming) covers low-level Pregel stream modes.
- [Custom projections](/oss/langgraph/streaming/custom-projections) covers application-specific projections.
