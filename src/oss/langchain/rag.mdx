...
<Note>
    If you have completed the [semantic search tutorial](/oss/langchain/knowledge-base), you can use the retriever function to execute a search from it and skip to [RAG agent](#rag-agent).
</Note>
