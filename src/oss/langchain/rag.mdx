...
RAG applications run indexing, retrieval, and generation in sequence. When you run the examples in this tutorial, [LangSmith](/langsmith/observability) logs a trace for each query so you can inspect retrieval, tool calls, and model responses.
...
<Note>
    If you have completed the [semantic search tutorial](/oss/langchain/knowledge-base), you can use the function to execute a search from it and skip to [RAG agent](#rag-agent).
</Note>
