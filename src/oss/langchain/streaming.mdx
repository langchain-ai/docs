...
The following example uses a fake chat model and no tools so you can run it without API credentials. Use a real model and tools when you build your app.
