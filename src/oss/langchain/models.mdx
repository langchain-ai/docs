...
This page covers how to use [models](/oss/models) in LangChain. If you're looking for provider-specific integrations, head over to the [integrations page](/oss/integrations/providers).
