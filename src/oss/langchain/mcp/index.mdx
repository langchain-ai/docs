...
import McpQuickstartJs from '/snippets/code-samples/mcp-quickstart-js.mdx';
import McpDocsServerPy from '/snippets/code-samples/mcp-docs-server-py.mdx';
import McpDocsServerJs from '/snippets/code-samples/mcp-docs-server-js.mdx';
import McpTransportsPy from '/snippets/code-samples/mcp-transports-py.mdx';
import McpTransportsJs from '/snippets/code-samples/mcp-transports-js.mdx';
...
<Note>
This guide assumes you're using `@langchain/mcp-adapters>=2`. If you're using an older version of `@langchain/mcp-adapters`, you can either read the pre-v1 docs or read the [migration guide](/oss/migrate/langchain-mcp-adapters).
</Note>
:::
