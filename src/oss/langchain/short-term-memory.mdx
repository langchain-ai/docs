...
In production, using a database-backed checkpointer is recommended. Postgres-backed checkpointer, as an example, can be installed using the following script:
