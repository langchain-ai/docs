...
graph LR
  ...
  O["Open-ended<br/>UI created elsewhere"]
...
For details, see [Declarative generative UI](/oss/langchain/frontend/declarative-generative-ui).
...
which documents the same three approaches and the techniques within each.
</Info>
