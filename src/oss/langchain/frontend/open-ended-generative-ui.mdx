...
<Info>
CopilotKit documents open-ended generative UI as [MCP Apps](https://docs.copilotkit.ai/generative-ui/mcp-apps),
part of its [generative UI overview](https://docs.copilotkit.ai/concepts/generative-ui-overview).
</Info>
