...
description: Render UI invented outside your application, such as sandboxed MCP server apps, at the open end of the generative UI spectrum
---

## Overview

Open-ended generative UI is the agent-invented end of the
...
This position gives the widest expressive range: the agent owns the canvas. A
...
position, the least deterministic, slower, and more expensive to run, and untrusted
...
[declarative](/oss/langchain/frontend/generative-ui) or
