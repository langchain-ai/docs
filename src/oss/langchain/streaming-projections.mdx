...
<Note>
Interested in streaming Pregel modes such as `updates`, `messages`, or `custom` directly? See the [Mode Streaming page](/oss/langchain/streaming).
</Note>
...
- [Mode Streaming](/oss/langchain/streaming) covers low-level Pregel stream modes.
