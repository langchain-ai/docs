...
You've now learned how to prompt a model to return XML. Next, check out the [broader guide on obtaining structured output](/oss/how_to/structured_output) for other related techniques.
