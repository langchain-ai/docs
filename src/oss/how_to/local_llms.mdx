...
![Image description](/images/oss/how_to/local_llms/assets/images/OSS_LLM_overview-9444c9793c76bd4785a5b0cd020c14ef.png)
...
![Image description](/images/oss/how_to/local_llms/assets/images/llama-memory-weights-aaccef5df087e993b0f46277500039b6.png)
...
![Image description](/images/oss/how_to/local_llms/assets/images/llama_t_put-c6f0ea201a6dd508999170325cd6804a.png)

### Formatting prompts

Some providers have [chat model](/src/oss/concepts/chat_models) wrappers that takes care of formatting your input prompt for the specific local model you're using. However, if you are prompting local models with a [text-in/text-out LLM](/src/oss/concepts/text_llms) wrapper, you may need to use a prompt tailored for your specific model.
...
See the [`llama.cpp`](/src/oss/integrations/llms/llamacpp) setup [here](https://github.com/abetlen/llama-cpp-python/blob/main/oss/install/macos.md) to enable this.
...
We can use model weights downloaded from [GPT4All](/src/oss/integrations/llms/gpt4all) model explorer.
...
Given an `llm` created from one of the models above, you can use it for [many use cases](/src/oss/how_to/#use-cases).

For example, you can implement a [RAG application](/src/oss/tutorials/rag) using the chat models demonstrated here.
