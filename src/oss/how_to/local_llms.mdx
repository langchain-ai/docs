...
See the [`llama.cpp`](/oss/integrations/llms/llamacpp) setup [here](https://github.com/abetlen/llama-cpp-python/blob/main/oss/install/macos.md) to enable this.
...
Given an `llm` created from one of the models above, you can use it for [many use cases](/oss/how_to/#use-cases).
