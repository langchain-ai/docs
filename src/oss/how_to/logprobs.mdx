...
Next, check out the other how-to guides chat models in this section, like [how to get a model to return structured output](/oss/how_to/structured_output) or [how to track token usage](/oss/how_to/chat_token_usage_tracking).
