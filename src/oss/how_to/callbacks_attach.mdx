...
<Info>
  ...
  * [Attach runtime arguments to a Runnable](/oss/how_to/binding)
</Info>
...
Next, check out the other how-to guides in this section, such as how to [pass callbacks in at runtime](/oss/how_to/callbacks_runtime).
