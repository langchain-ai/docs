...
In order to force our LLM to select a specific [tool](/src/oss/concepts/tools), we can use the `tool_choice` parameter to ensure certain behavior. First, let's define our model and tools:
