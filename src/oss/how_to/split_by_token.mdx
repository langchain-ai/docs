...
Language models have a [token](/src/oss/concepts/tokens) limit. You should not exceed the token limit. When you [split your text](/src/oss/concepts/text_splitters) into chunks it is therefore a good idea to count the number of tokens. There are many tokenizers. When you count tokens in your text you should use the same tokenizer as used in the language model.
...
[Hugging Face](https://huggingface.co/oss/tokenizers/index) has many tokenizers.
