...
<Info>
  ...
  * [Configuring chain parameters at runtime](/src/oss/how_to/configure)
...
1. Conditionally return runnables from a [`RunnableLambda`](/src/oss/how_to/functions) (recommended)
