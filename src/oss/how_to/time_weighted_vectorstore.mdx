...
This [retriever](/src/oss/concepts/retrievers) uses a combination of semantic [similarity](/src/oss/concepts/embedding_models/#measure-similarity) and a time decay.
