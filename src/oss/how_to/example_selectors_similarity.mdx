...
This object selects [examples](/src/oss/concepts/example_selectors) based on similarity to the inputs. It does this by finding the examples with the embeddings that have the greatest cosine similarity with the inputs.
