...
<Info>
  ...
  * [Binding runtime arguments](/oss/how_to/binding)
</Info>
...
* A `configurable_fields` method. This lets you configure particular fields of a runnable.
  * This is related to the [`.bind`](/oss/how_to/binding) method on runnables, but allows you to specify parameters for a given step in a chain at runtime rather than specifying them beforehand.
...
If using [init\_chat\_model](/oss/how_to/chat_models_universal_init) to create a chat model, you can specify configurable fields in the constructor:
...
* Using [.bind()](/oss/how_to/binding) as a simpler way to set a runnable's runtime parameters
