...
Next, check out the other how-to guides on prompt templates in this section, the related how-to guide on [few shotting with text completion models](/oss/how_to/few_shot_examples), or the other [example selector how-to guides](/oss/how_to/example_selectors).
