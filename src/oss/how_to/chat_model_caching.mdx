...
LangChain provides an optional caching layer for [chat models](/oss/concepts/chat_models). This is useful for two main reasons:
...
Next, check out the other how-to guides chat models in this section, like [how to get a model to return structured output](/oss/how_to/structured_output) or [how to create your own custom chat model](/oss/how_to/custom_chat_model).
