...
LangChain provides an optional caching layer for [chat models](/src/oss/concepts/chat_models). This is useful for two main reasons:
...
Next, check out the other how-to guides chat models in this section, like [how to get a model to return structured output](/src/oss/how_to/structured_output) or [how to create your own custom chat model](/src/oss/how_to/custom_chat_model).
