...
Here we demonstrate how to use prompt templates to format [multimodal](/src/oss/concepts/multimodality) inputs to models.
...
Let's use this prompt to pass an image to a [chat model](/src/oss/concepts/chat_models/#multimodality):
