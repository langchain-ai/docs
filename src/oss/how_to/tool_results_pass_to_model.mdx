...
<Info>
  ...
  * [Using chat models to call tools](/src/oss/how_to/tool_calling)
  * [Defining custom tools](/src/oss/how_to/custom_tools)
</Info>

Some models are capable of [**tool calling**](/src/oss/concepts/tool_calling) - generating arguments that conform to a specific user-provided schema. This guide will demonstrate how to use those tool calls to actually call a function and properly pass the results back to the model.

![Diagram of a tool call invocation](/images/oss/how_to/tool_results_pass_to_model/assets/images/tool_invocation-7f277888701ee431a17607f1a035c080.png)

![Diagram of a tool call result](/images/oss/how_to/tool_results_pass_to_model/assets/images/tool_results-71b4b90f33a56563c102d91e7821a993.png)
