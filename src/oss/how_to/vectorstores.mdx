---
title: "How to create and query vector stores"
---

<Info>
  Head to [Integrations](/src/oss/integrations/vectorstores) for documentation on built-in integrations with 3rd-party vector stores.
</Info>
