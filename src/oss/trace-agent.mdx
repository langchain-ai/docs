...
Traces are a series of steps that your application takes to go from input to output. Each of these individual steps is represented by a run. You can use [LangSmith](https://smith.langchain.com/) to visualize these execution steps. To use it, [enable tracing for your application](./enable-tracing). This enables you to do the following:
...
To enable [tracing](../concepts/tracing) for your application, set the following environment variables:
...
* [Graph runs in LangSmith](./run-id-langsmith)
