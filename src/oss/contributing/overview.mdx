...
<AccordionGroup>
    ...
    <Accordion title="Add a new integration" icon="plug-connected">
        {/* <Columns cols={2}>
            ...
            <Card title="LangGraph" icon="topology-ring" href="/oss/contributing/integrations-langgraph" arrow>Guide to adding a new LangGraph integration</Card>
            <Card title="Deep Agents" icon="robot" href="/oss/contributing/integrations-deepagents" arrow>Guide to adding a new Deep Agents integration</Card>
        </Columns> */}
        <Card title="LangChain" icon="link" href="/oss/contributing/integrations-langchain" arrow>Guide to adding a new LangChain integration</Card>
    </Accordion>
</AccordionGroup>
