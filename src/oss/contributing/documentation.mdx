...
<AccordionGroup>
    ...
    <Accordion title="When to create new reference documentation">
        - New integrations that meet the [hosted-guide eligibility criteria](/oss/contributing/publish-langchain#eligibility-for-hosted-guides) (50,000+ monthly downloads or featured)
