...
<Tabs>
    ...
    <Tab title="Middleware">
        Middleware lets you customize agent behavior by hooking into model calls, tool calls, and agent lifecycle events. Middleware classes subclass the @[`Middleware`] base class.
    ...
    <Tab title="Checkpointers">
        ...
        <Warning>
            The checkpointer integration guide is currently WIP. In the meantime, see existing checkpointer integrations in the [LangGraph repo](https://github.com/langchain-ai/langgraph/tree/main/libs/checkpoint).
        </Warning>
    </Tab>
    <Tab title="Sandboxes">
