...
<CardGroup>
    <Card title="Chat models" icon="message" href="href" arrow/>
    <Card title="Tools/toolkits" icon="wrench" href="href" arrow/>
    <Card title="Retrievers" icon="magnifying-glass" href="href" arrow/>
    <Card title="Vector stores" icon="database" href="href" arrow/>
    <Card title="Embedding models" icon="layer-group" href="href" arrow/>
</CardGroup>
