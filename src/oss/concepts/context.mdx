...
---
Test mintlify ai agent on a branch.
Test mintlify ai agent.
Trigger publish agian to see if mint can publish after toggling on docs.json is in a subfolder
Test, this is used to test whether mintlify automatically pulls the change and republishes the doc.
