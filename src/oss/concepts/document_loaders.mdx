...
<Info>
  * [Document loaders API reference](/src/oss/how_to/#document-loaders)
</Info>
...
You can find available integrations on the [Document loaders integrations page](/src/oss/integrations/document_loaders).
...
* [How-to guides for document loaders](/src/oss/how_to/#document-loaders)
...
* [Document loaders integrations](/src/oss/integrations/document_loaders)
