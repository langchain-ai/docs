...
<Info>
  ...
  Embedding models can also be [multimodal](/src/oss/concepts/multimodality) though such models are not currently supported by LangChain.
</Info>
...
![Conceptual Overview](/images/oss/concepts/embedding_models/assets/images/embeddings_concept-975a9aaba52de05b457a1aeff9a7393a.png)
...
<Info>
  * See the full list of [LangChain embedding model integrations](/src/oss/integrations/text_embedding).
  * See these [how-to guides](/src/oss/how_to/embed_text) for working with embedding models.
</Info>

### Integrations

LangChain offers many embedding model integrations which you can find [on the embedding models](/src/oss/integrations/text_embedding) integrations page.
...
The choice of similarity metric should be chosen based on the model. As an example, [OpenAI suggests cosine similarity for their embeddings](https://platform.openai.com/oss/guides/embeddings/which-distance-function-should-i-use), which can be easily implemented:
