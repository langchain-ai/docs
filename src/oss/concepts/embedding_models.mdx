...
<Info>
  ...
  Embedding models can also be [multimodal](/oss/concepts/multimodality) though such models are not currently supported by LangChain.
</Info>
...
<Info>
  * See the full list of [LangChain embedding model integrations](/oss/integrations/text_embedding).
  * See these [how-to guides](/oss/how_to/embed_text) for working with embedding models.
</Info>

### Integrations

LangChain offers many embedding model integrations which you can find [on the embedding models](/oss/integrations/text_embedding) integrations page.
