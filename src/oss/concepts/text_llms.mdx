...
<Check>
  You are probably looking for the [Chat Model Concept Guide](/oss/concepts/chat_models) page for more information.
</Check>
...
Users should be using almost exclusively the newer [Chat Models](/oss/concepts/chat_models) as most model providers have adopted a chat like interface for interacting with language models.
