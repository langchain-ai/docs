...
<Info>
  See our conceptual guide on [retrieval](/oss/concepts/retrieval).
</Info>
...
As an example, here's a simple RAG workflow that passes information from a [retriever](/oss/concepts/retrievers) to a [chat model](/oss/concepts/chat_models):
...
<Info>
  ...
  * See our [RAG how-to guides](/oss/how_to/#qa-with-rag).
  * See our RAG [tutorials](/oss/tutorials).
