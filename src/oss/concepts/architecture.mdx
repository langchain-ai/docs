...
![Diagram outlining the hierarchical organization of the LangChain framework, displaying the interconnected parts across multiple layers.](/images/oss/concepts/architecture/svg/langchain_stack_112024.svg "LangChain Framework Overview")![Diagram outlining the hierarchical organization of the LangChain framework, displaying the interconnected parts across multiple layers.](/images/oss/concepts/architecture/svg/langchain_stack_112024_dark.svg "LangChain Framework Overview")
...
* A list [integrations packages](/src/oss/integrations/providers)
...
For more information, see the [LangServe documentation](/src/oss/langserve).
