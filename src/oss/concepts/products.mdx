...
sidebarTitle: Frameworks, Runtimes, Harnesses
...
[LangChain](/oss/langchain/overview) is an agent framework which provides abstractions structured content blocks, the agent loop, and middleware.
...
Other examples of agent frameworks include Vercel’s AI SDK, CrewAI, OpenAI Agents SDK, Google ADK, LlamaIndex, and many more.
...
Other examples of agent runtimes include Temporal, Inngest, and other durable execution engines.
...
Other examples of agent harnesses include Claude Agent SDK, Manus, and other coding CLIs.
