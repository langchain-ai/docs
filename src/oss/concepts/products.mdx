...
| - | --------- | ------- | ------- |
| Value add | <ul><li>Abstractions</li><li>Integrations</li></ul> | <ul><li>Durable execution</li><li>Streaming</li><li>HITL</li><li>Persistence</li></ul> | <ul><li>Predefined tools</li><li>Prompts</li><li>Subagents</li></ul> |
| When to use | <ol><li>Getting started quickly</li><li>Standardizing how a team builds</li></ol> | <ol><li>Low-level control</li><li>Long running, stateful workflows and agents</li></ol> | <ol><li>More autonomous agents</li><li>Agents faced with complex, non-deterministic tasks</li></ol> |
| Other options | Vercel’s AI SDK, CrewAI, OpenAI Agents SDK, Google ADK, LlamaIndex | Temporal, Inngest | Claude Agent SDK, Manus |
