...
| Deployment          | Self-managed                                              | <ul><li>Cloud SaaS</li><li>Free self-hosted</li><li>Enterprise (paid self-hosted)</li></ul>                              |
...
Yes! You can use the [development version of LangGraph Server](/oss/local-server) to run the backend locally.
