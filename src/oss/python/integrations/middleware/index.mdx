...
| [task-steering](https://github.com/edvinhallvaxhiu/task-steering) | Implicit state-machine middleware for ordered task pipelines with per-task tool scoping, dynamic prompt injection, and composable completion validation. | [`edvinhallvaxhiu/task-steering`](https://github.com/edvinhallvaxhiu/task-steering) |
