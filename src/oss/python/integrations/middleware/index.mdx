...
|-----------|-------------|--------|
| [Pydantic Monty Code Interpreter](https://github.com/shane-rand/langchain-monty)|Provides Code Interpretation inside Pydantic's Monty Runtime|[`langchain-monty`](https://github.com/shane-rand/langchain-monty)|
