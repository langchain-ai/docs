...
| [advisor-middleware](https://github.com/emanueleielo/advisor-middleware) | Pairs a fast executor model with a powerful advisor model that intervenes only on critical decisions for better performance at lower cost. | [`emanueleielo/advisor-middleware`](https://github.com/emanueleielo/advisor-middleware) |
