...
| [langchain-router](https://github.com/johanity/langchain-router) | Phase-based model routing. Routes execution turns to a fast model, keeps the primary model for planning and recovery. | [`johanity/langchain-router`](https://github.com/johanity/langchain-router) |
