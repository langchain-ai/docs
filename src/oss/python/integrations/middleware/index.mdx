...
| [TealTiger](https://github.com/agentguard-ai/tealtiger/tree/main/packages/langchain-tealtiger) | Deterministic governance middleware. Policy enforcement, cost limits, tool allowlisting, FREEZE rules, and SARIF audit evidence with no LLM in the governance path. | [`agentguard-ai/tealtiger`](https://github.com/agentguard-ai/tealtiger/tree/main/packages/langchain-tealtiger) |
