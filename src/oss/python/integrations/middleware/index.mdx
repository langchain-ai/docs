...
| [text2sql-framework](https://github.com/Text2SqlAgent/text2sql-framework) | Exposes an `execute_sql` tool for your agent to explore your database and then write/execute SQL. Scored 95% on the Spider benchmark with Sonnet 4.6. | [`Text2SqlAgent/text2sql-framework`](https://github.com/Text2SqlAgent/text2sql-framework) |
