...
Middleware integrations and model-specific harness profiles for NVIDIA services and models. Use them to route calls across LangChain chat models or optimize Deep Agents behavior for NVIDIA Nemotron 3 Ultra. Learn more about [middleware](/oss/langchain/middleware/overview).
...
Configure `NVIDIA_API_KEY` as described in the [ChatNVIDIA setup guide](/oss/integrations/chat/nvidia_ai_endpoints#access-the-nvidia-api-catalog).
