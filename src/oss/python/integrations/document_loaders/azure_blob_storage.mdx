...
Below shows how to override the default loader used to parse blobs as PDFs using the [PyPDFLoader](https://reference.langchain.com/python/langchain-classic/document_loaders):
