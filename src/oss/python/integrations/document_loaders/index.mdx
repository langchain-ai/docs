...
|----------------|-------------|----------------|------------------------|
| [Azure Blob Storage](/oss/integrations/document_loaders/azure_blob_storage) | Load documents from Azure Blob Storage containers or individual blobs | ✅ | [`langchain-ai/langchain-azure`](https://github.com/langchain-ai/langchain-azure/tree/main/libs/azure-storage) |
