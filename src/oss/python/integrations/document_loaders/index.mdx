...
| [DomPruner](/oss/python/integrations/document_loaders/dompruner) | DOM AST pruning — loads web pages as compact Markdown with 97%+ token reduction, no API key | Package |
