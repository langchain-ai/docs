---
title: Gemini Enterprise Agent Platform reranker integration
description: Integrate with the Gemini Enterprise Agent Platform reranker document transformer using LangChain Python.
integration:
  name: Gemini Enterprise Agent Platform reranker
...
# Initialize GCP project for Gemini Enterprise Agent Platform
...
The embeddings are created using the [Vertex Embeddings API](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/embeddings/get-text-embeddings#supported_models) model - `textembedding-gecko@003`
