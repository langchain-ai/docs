...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><p><strong>Chat Model:</strong><br><pre>
{
  "messages": [
    {"content": "..."}
  ]
...
<strong>Legacy Model:</strong><br><pre>
{
  "prompts": ["..."]
}
</pre></p></td>
      ...
      <td><p><pre>
{
  "usage": {
    "total_tokens": 20
      ...
      <td><p><pre>"The weather is sunny."</pre></p></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><p><strong>Input String:</strong><br><pre>
"city='Paris'"
</pre></p></td>
      <td><p><pre>{}</pre></p></td>
    </tr>
    <tr>
      ...
      <td><p><strong>Output String:</strong><br><pre>
"25°C, Sunny"
</pre></p></td>
      <td><p><pre>{}</pre></p></td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      <td><p><pre>RETRIEVER_START</pre></p></td>
      <td><p><strong>Query String:</strong><br><pre>
"What is the capital of France?"
</pre></p></td>
    </tr>
    <tr>
      <td><p><pre>RETRIEVER_END</pre></p></td>
      <td><p><strong>Documents List:</strong><br><pre>
[
  {
    ...
    <tr>
      <td><p><pre>RETRIEVER_ERROR</pre></p></td>
      <td><p><pre>null (See error_message column)</pre></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td><p><pre>AGENT_ACTION</pre></p></td>
      <td><p><pre>
{
  "tool": "Calculator",
  "input": "2 + 2"
    ...
    <tr>
      <td><p><pre>AGENT_FINISH</pre></p></td>
      <td><p><pre>
{
...
<table>
  ...
  <tbody>
    <tr>
      <td><p><pre>TEXT</pre></p></td>
      <td><p><strong>Arbitrary Text:</strong><br><pre>
"Some logging text..."
</pre></p></td>
    </tr>
  </tbody>
