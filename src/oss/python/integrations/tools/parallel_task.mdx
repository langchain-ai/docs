...
| :--- | :--- | :--- | :--- |
| [`ParallelTaskRunTool`](https://github.com/parallel-web/langchain-parallel) | `BaseTool` | `lite-fast` | [`langchain-parallel`](https://pypi.org/project/langchain-parallel/) |
| [`ParallelDeepResearch`](https://github.com/parallel-web/langchain-parallel) | `Runnable` | `pro-fast` | [`langchain-parallel`](https://pypi.org/project/langchain-parallel/) |
| [`ParallelTaskGroup`](https://github.com/parallel-web/langchain-parallel) | Plain class | `lite-fast` | [`langchain-parallel`](https://pypi.org/project/langchain-parallel/) |
| [`ParallelEnrichment`](https://github.com/parallel-web/langchain-parallel) | `Runnable` | `core-fast` | [`langchain-parallel`](https://pypi.org/project/langchain-parallel/) |
...
For detailed documentation, head to the [`ParallelTaskRunTool`](https://github.com/parallel-web/langchain-parallel), [`ParallelDeepResearch`](https://github.com/parallel-web/langchain-parallel), [`ParallelTaskGroup`](https://github.com/parallel-web/langchain-parallel), or [`ParallelEnrichment`](https://github.com/parallel-web/langchain-parallel) API references, or the [Parallel Task API guides](https://docs.parallel.ai/task-api/task-quickstart).
