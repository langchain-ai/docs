...
| :--- | :--- | :---: | :---: | :---: |
| `YouTubeMetadataTool` | [langchain-scrapingbee](https://pypi.org/project/langchain-scrapingbee/) | ✅ | ❌ |  ![PyPI - Version](https://img.shields.io/pypi/v/langchain-scrapingbee?style=flat-square&label=%20) |
