...
Web search needs `langchain-aws` 1.7.9 or later and `bedrock-agentcore` 1.23.0 or later. The examples on this page were run against `langchain-aws` 1.7.9 with `bedrock-agentcore` 1.23.1.
