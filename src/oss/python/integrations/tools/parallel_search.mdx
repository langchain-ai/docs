...
| :--- | :--- | :---: | :---: | :---: |
| [`ParallelSearchTool`](https://github.com/parallel-web/langchain-parallel) | [`langchain-parallel`](https://pypi.org/project/langchain-parallel/) | ❌ | ❌ | <a href="https://pypi.org/project/langchain-parallel/" target="_blank"><img src="https://img.shields.io/pypi/v/langchain-parallel?style=flat-square&label=%20&color=orange" alt="PyPI - Latest version" noZoom height="100" class="rounded" /></a> |
...
[`SourcePolicy`](https://github.com/parallel-web/langchain-parallel) mirrors the API's `include_domains` / `exclude_domains` / `after_date`. Use it for type safety; raw dicts are also accepted.
...
For detailed documentation, head to the [`ParallelSearchTool`](https://github.com/parallel-web/langchain-parallel) API reference or the [Parallel Search reference](https://docs.parallel.ai/api-reference/search/search).
