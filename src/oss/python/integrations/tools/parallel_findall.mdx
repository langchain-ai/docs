...
| :--- | :--- | :---: | :---: | :---: |
| [`ParallelFindAllTool`](https://github.com/parallel-web/langchain-parallel) | [`langchain-parallel`](https://pypi.org/project/langchain-parallel/) | ❌ | ❌ | <a href="https://pypi.org/project/langchain-parallel/" target="_blank"><img src="https://img.shields.io/pypi/v/langchain-parallel?style=flat-square&label=%20&color=orange" alt="PyPI - Latest version" noZoom height="100" class="rounded" /></a> |
...
For detailed documentation, head to the [`ParallelFindAllTool`](https://github.com/parallel-web/langchain-parallel) API reference or the [Parallel FindAll API guides](https://docs.parallel.ai/findall-api/findall-quickstart).
