...
1. Foundation models - A curated set of common foundation models such as DBRX, Llama3, and Mixtral-8x7B. These endpoints are ready to use in your Databricks workspace without any setup.
