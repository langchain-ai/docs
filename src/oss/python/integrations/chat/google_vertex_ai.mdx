...
Gemini Enterprise Agent Platform exposes all foundational models available in Google Cloud, like `gemini-3.1-pro-preview`, `gemini-3.7-flash`, etc. For a full and updated list of available models visit [Gemini Enterprise Agent Platform documentation](https://cloud.google.com/vertex-ai/generative-ai/docs/models).

<Info>
    **Gemini Enterprise Agent Platform vs. Gemini API**

    The Gemini Enterprise Agent Platform integration is separate from the [Google Gemini API](/oss/integrations/chat/google_generative_ai/). This page showcases an enterprise version of Gemini through Google Cloud Platform (GCP).
</Info>
