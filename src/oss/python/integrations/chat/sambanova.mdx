...
To access ChatSambaNova models you will need to create a [SambaCloud](https://cloud.sambanova.ai/) account, get an API key, install the `langchain_sambanova` integration package.
