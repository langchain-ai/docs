...
This page will help you get started with Crusoe AI [chat models](/oss/python/langchain/models). For detailed documentation of all ChatCrusoe features and configurations, head to the [API reference](https://python.langchain.com/api_reference/crusoe/chat_models/langchain_crusoe.chat_models.ChatCrusoe.html).
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| [ChatCrusoe](https://python.langchain.com/api_reference/crusoe/chat_models/langchain_crusoe.chat_models.ChatCrusoe.html) | [langchain-crusoe](https://pypi.org/project/langchain-crusoe/) | ❌ | beta | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-crusoe?style=flat-square&label=%20&color=blue) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-crusoe?style=flat-square&label=%20&color=orange) |
...
For detailed documentation of all ChatCrusoe features and configurations, head to the API reference: [python.langchain.com/api_reference/crusoe/chat_models/langchain_crusoe.chat_models.ChatCrusoe.html](https://python.langchain.com/api_reference/crusoe/chat_models/langchain_crusoe.chat_models.ChatCrusoe.html)
