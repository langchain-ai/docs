...
|-|-|-|
| [Alephant AI](https://alephant.io/) | [`ChatAlephantAI`](/oss/integrations/chat/alephantai) | AI gateway for cost control, bring-your-own-key routing, and access to models across multiple providers |
