...
|-|-|-|
| [Alephant AI](https://alephant.io/) | [`ChatOpenAI via alephantai`](/oss/integrations/chat/alephantai) | OpenAI-compatible gateway with session metadata and usage/cost attribution |
...
<Card
    title="Alephant AI"
    icon="link"
    href="/oss/integrations/chat/alephantai"
    arrow="true"
    cta="View guide"
/>
