...
See the [`ChatParallel`](https://github.com/parallel-web/langchain-parallel) API reference for the full set of available parameters.
...
For detailed documentation, head to the [`ChatParallel`](https://github.com/parallel-web/langchain-parallel) API reference or the [Parallel chat API quickstart](https://docs.parallel.ai/chat-api/chat-quickstart).
