...
- [ ] Set `integration` frontmatter (`name` is the LangChain class; omit `pypi` for N/A downloads; omit capability keys that the page does not document). Do not set `featured: true` unless a maintainer asks you to.
