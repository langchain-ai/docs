...
Optional: to enable automated tracing of your model calls, set your [LangSmith](/langsmith/observability) API key:
...
Create a tool with the @[`@tool`] decorator. For details, see [Customize tool properties](/oss/langchain/tools#customize-tool-properties).
...
Gemma 3 requires Ollama 0.6 or later.
