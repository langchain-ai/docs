...
Integrate with LangChain's RAG patterns:
...
# Ask questions
answer = await qa_chain.ainvoke({"query": "What is CockroachDB?"})
print(answer["result"])
```

For more RAG patterns, see:
- [LangChain RAG tutorials](/oss/python/langchain/rag)
- [Question answering with RAG](https://python.langchain.com/docs/how_to/#qa-with-rag)
