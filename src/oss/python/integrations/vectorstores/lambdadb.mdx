...
>[LambdaDB]() is a serverless-native search engine designed for building accurate, secure, and scalable AI applications.
...
For detailed documentation of all LambdaDBVectorStore features and configurations, head to the [API reference](https://python.langchain.com/api_reference/lambdadb/vectorstores.html).
