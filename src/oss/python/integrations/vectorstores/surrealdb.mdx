...
- [Retrieval conceptual docs](https://docs.langchain.com/oss/python/langchain/retrieval)

---

## API reference

For detailed documentation of all `SurrealDBVectorStore` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/vectorstores/surrealdb/SurrealDBStore).
