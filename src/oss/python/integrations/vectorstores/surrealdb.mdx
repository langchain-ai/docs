...
integration:
  name: SurrealDBVectorStore
  pypi: langchain-surrealdb
---
...
- [Retrieval docs](/oss/deepagents/retrieval)
...
For detailed documentation of all `SurrealDBVectorStore` features and configurations head to the @[API reference][SurrealDBStore].
