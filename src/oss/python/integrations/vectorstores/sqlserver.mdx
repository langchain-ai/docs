...
For a full list of the different searches you can execute on an Azure SQL vector store, please refer to the [API reference](https://reference.langchain.com/python/langchain-sqlserver).
...
Read more about [LangChain RAG tutorials and terminologies](/oss/deepagents/rag).
...
For detailed documentation of SQLServer Vectorstore features and configurations head to the @[API reference][SQLServer_VectorStore]
