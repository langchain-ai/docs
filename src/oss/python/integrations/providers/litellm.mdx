...
See the [LiteLLM chat guide](/oss/integrations/chat/litellm) for full usage details, including streaming, tool calling, structured output, and grounding on Gemini Enterprise Agent Platform.
