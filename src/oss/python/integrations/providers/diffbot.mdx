...
[Diffbot](https://www.diffbot.com) turns the public web into structured data. Its APIs cover the [Knowledge Graph](https://docs.diffbot.com/reference/dql-quickstart) (queryable with DQL), web search, structured page extraction, NLP entity recognition, crawling, and a retrieval-augmented LLM endpoint.
...
A `BaseRetriever` over the Diffbot Knowledge Graph. The query string is a [DQL](https://docs.diffbot.com/reference/dql-quickstart) expression.
