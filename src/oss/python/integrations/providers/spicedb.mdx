...
- [`SpiceDBRetriever`](/oss/python/integrations/retrievers/spicedb): Wraps any LangChain retriever with SpiceDB authorization filtering

### Tools

- [`SpiceDBPermissionTool`](/oss/python/integrations/tools/spicedb): LangChain tool for checking single permissions in agent workflows
- [`SpiceDBBulkPermissionTool`](/oss/python/integrations/tools/spicedb): LangChain tool for checking permissions for multiple resources at once
...
- [LangChain SpiceDB Tools](/oss/python/integrations/tools/spicedb)
- [LangChain SpiceDB Retriever](/oss/python/integrations/retrievers/spicedb)
