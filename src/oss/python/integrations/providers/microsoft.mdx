...
<Note>
    When models in your hosted graph use the Responses API, use `output_version="responses/v1"` or leave it unset. This is the default in `langchain-openai` 1.0.0 or later, unless overridden by `LC_OUTPUT_VERSION`. This applies to both Responses and Invocations hosting protocols.
</Note>
