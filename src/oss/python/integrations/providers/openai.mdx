...
<Columns cols={2}>
    ...
    <Card title="OpenAIEmbeddings" href="/oss/integrations/text_embedding/openai" cta="Get started" icon="stack-2" arrow>
        OpenAI embedding models.
    </Card>
    <Card title="AzureOpenAIEmbeddings" href="/oss/integrations/text_embedding/azure_openai" cta="Get started" icon="brand-windows" arrow>
