...
You will need an [OpenAI API Key](https://platform.openai.com/account/api-keys) and a [SerpApi API Key](https://serpapi.com/dashboard)/[cloro API key](https://dashboard.cloro.dev/) to run the following examples
