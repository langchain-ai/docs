...
We will use the SerpApi to retrieve search results from Google. To acquire the SerpApi key, please go to [serpapi.com/manage-api-key](https://serpapi.com/manage-api-key). Alternatively, you can use [cloro](https://dashboard.cloro.dev/) or [Serper](https://serper.dev/).
