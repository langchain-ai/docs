...
<Columns cols={3}>
    ...
    <Card
        title="agentstate"
        href="https://skamalj.github.io/agentstate-reducer/"
        icon="link"
    >
        DynamoDB, Cosmos DB and Firestore checkpointers with bounded history and a long-term memory hook, plus semantic-search stores.
    </Card>
    ...
    <Card
        title="CTRLRun"
        href="https://docs.ctrlrun.dev/guides/langchain-middleware"
        icon="link"
    >
        Execution safety for AI agents. Middleware that checks every tool call against a policy before it runs, holds the consequential ones for a human, and leaves a receipt.
    </Card>
    ...
    <Card
        title="OpenInference"
        href="/oss/integrations/callbacks/openinference"
        icon="link"
    >
