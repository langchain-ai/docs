...
>
> You can obtain a free SambaCloud API key [here](http://cloud.sambanova.ai?utm_source=sambanova&utm_medium=external&utm_campaign=cloud_signup)
...
If you are a SambaCloud user request an [API key](http://cloud.sambanova.ai/apis?utm_source=sambanova&utm_medium=external&utm_campaign=cloud_signup) and set it as an environment variable:
