...
<Columns cols={1}>
    <Card title="GoogleGenerativeAI" href="/oss/integrations/llms/google_ai" cta="Get started" icon="cursor-text" arrow>
...
<Columns cols={2}>
    <Card title="ChatVertexAI" icon="messages" href="/oss/integrations/chat/google_vertex_ai" cta="Get started" arrow>
...
<Columns cols={2}>
    ...
    <Card title="VertexAI" icon="cursor-text" href="/oss/integrations/llms/google_vertex_ai" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="VertexAIEmbeddings" icon="stack-2" href="/oss/integrations/text_embedding/google_vertex_ai" cta="Get started" arrow>
