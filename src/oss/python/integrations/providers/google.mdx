...
<AccordionGroup>
    <Accordion title="Google Generative AI (Gemini API & Gemini Enterprise Agent Platform)">
        Access Google Gemini models via the **[Gemini Developer API](https://ai.google.dev/)** or **[Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai)**. The backend is selected automatically based on your configuration.
    ...
    <Accordion title="Google Cloud (Gemini Enterprise Agent Platform Services)">
...
Access Google Gemini models via the [Gemini Developer API](https://ai.google.dev/gemini-api/docs) or [Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai) using the unified `langchain-google-genai` package.
...
<Note>
    **For Gemini models**, use [`ChatGoogleGenerativeAI`](/oss/integrations/chat/google_generative_ai) from `langchain-google-genai`. The classes below focus on **Gemini Enterprise Agent Platform services** not available in the consolidated SDK.
</Note>
...
<Columns cols={2}>
    ...
    <Card title="Vector Search on Gemini Enterprise Agent Platform" href="/oss/integrations/vectorstores/google_vertex_ai_vector_search" cta="Get started" arrow>
    ...
    <Card title="Vector Search on Gemini Enterprise Agent Platform + Datastore" href="/oss/integrations/vectorstores/google_vertex_ai_vector_search#optional--you-can-also-create-vector-and-store-chunks-in-a-datastore" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="Agent Search on Gemini Enterprise Agent Platform" icon="search" href="/oss/integrations/retrievers/google_vertex_ai_search" cta="Get started" arrow>
        Generative AI powered search vian Agent Search on Gemini Enterprise Agent Platform.
    </Card>
