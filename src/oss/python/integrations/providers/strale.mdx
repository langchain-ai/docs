...
[Strale](https://strale.io) is a capability marketplace that lets AI agents buy and execute capabilities at runtime, including company data lookups, compliance checks, web scraping, document extraction, and more, via a single API call.
