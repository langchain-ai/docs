...
import IntegrationDownloads from '/snippets/oss/python-embeddings-downloads.mdx';
import IntegrationFeatured from '/snippets/oss/python-embeddings-featured.mdx';
