...
1. Foundation models - A curated set of common embedding models such as BAAI General Embedding (BGE). These endpoints are ready to use in your Databricks workspace without any setup.
