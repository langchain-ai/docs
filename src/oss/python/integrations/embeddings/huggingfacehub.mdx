...
See the dedicated [Sentence Transformers guide](/oss/integrations/embeddings/sentence_transformers) for model selection, GPU configuration, and query/document prompts.
