...
>[Agent Search on Gemini Enterprise Agent Platform](https://cloud.google.com/enterprise-search) (formerly known as `Enterprise Search` on `Generative AI App Builder`) is a part of the [Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai) machine learning platform offered by `Google Cloud`.
>
...
This notebook demonstrates how to configure `Agent Search on Gemini Enterprise Agent Platform` and use the Agent Search on Gemini Enterprise Agent Platform [retriever](/oss/deepagents/retrieval). The Agent Search on Gemini Enterprise Agent Platform retriever encapsulates the [Python client library](https://cloud.google.com/generative-ai-app-builder/docs/libraries#client-libraries-install-python) and uses it to access the [Search Service API](https://cloud.google.com/python/docs/reference/discoveryengine/latest/google.cloud.discoveryengine_v1beta.services.search_service).
