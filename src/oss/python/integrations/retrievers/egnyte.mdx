...
integration:
  ...
  pypi: langchain-egnyte
---

This will help you get started with the Egnyte [retriever](/oss/deepagents/retrieval). For detailed documentation of all `EgnyteRetriever` features and configurations head to the [API reference](https://github.com/egnyte/egnyte-langchain-connector).
