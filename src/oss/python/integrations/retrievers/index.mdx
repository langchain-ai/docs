...
| [`MongoDBAtlasHybridSearchRetriever`](/oss/integrations/retrievers/mongodb_atlas) | ❌ | ✅ | [`langchain-mongodb`](https://reference.langchain.com/python/langchain-mongodb/retrievers/MongoDBAtlasHybridSearchRetriever) |
