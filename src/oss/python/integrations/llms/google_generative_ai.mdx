...
A guide on using [Google Generative AI](https://developers.generativeai.google/) models with LangChain. Note: It's separate from Gemini Enterprise Agent Platform [integration](/oss/integrations/llms/google_vertex_ai).
