...
<Warning>
**You are currently on a page documenting the use of Gemini Enterprise Agent Platform text completion models. Many models available through Google Cloud are [chat completion models](/oss/langchain/models).**

You may be looking for [this page instead](/oss/integrations/chat/google_vertex_ai/).
</Warning>

**Note:** This is separate from the `Google Generative AI` integration, it exposes [Generative AI on Gemini Enterprise Agent Platform](https://cloud.google.com/vertex-ai/docs/generative-ai/learn/overview) on `Google Cloud`.

Gemini Enterprise Agent Platform exposes all foundational models available in Google Cloud.

For a full and updated list of available models visit [Gemini Enterprise Agent Platform documentation](https://cloud.google.com/vertex-ai/generative-ai/docs/models)
...
The `VertexAI` class supports all [LLM](/oss/langchain/models) functionality.
...
For an updated list of available models visit [Gemini Enterprise Agent Platform documentation](https://cloud.google.com/vertex-ai/docs/generative-ai/model-reference/overview)
...
Gemini Enterprise Agent Platform Model Garden [exposes](https://cloud.google.com/vertex-ai/docs/start/explore-models) open-sourced models that can be deployed and served on Gemini Enterprise Agent Platform.
...
If you have successfully deployed a model from Gemini Enterprise Agent Platform Model Garden, you can find a corresponding Gemini Enterprise Agent Platform [endpoint](https://cloud.google.com/vertex-ai/docs/general/deployment#what_happens_when_you_deploy_a_model) in the console or via API.
...
[Official documentation](https://cloud.google.com/vertex-ai/generative-ai/docs/open-models/use-llama) for more information about Llama on [Gemini Enterprise Agent Platform Model Garden](https://cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models)

To use Llama on Gemini Enterprise Agent Platform Model Garden you must first [deploy it to Gemini Enterprise Agent Platform endpoint](https://cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models#deploy-a-model)
...
To use Falcon on Gemini Enterprise Agent Platform Model Garden you must first [deploy it to Gemini Enterprise Agent Platform endpoint](https://cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models#deploy-a-model)
...
To use Gemma on Gemini Enterprise Agent Platform Model Garden you must first [deploy it to Gemini Enterprise Agent Platform endpoint](https://cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models#deploy-a-model)
