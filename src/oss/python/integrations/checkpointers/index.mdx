...
| [ScyllaDB](/oss/integrations/providers/scylladb#langgraph-checkpointer) | [`langgraph-checkpoint-scylladb`](https://pypi.org/project/langgraph-checkpoint-scylladb/) | [scylladb/langchain-scylladb](https://github.com/scylladb/langchain-scylladb/tree/main/libs/langgraph-checkpoint-scylladb) |
