...
| [Amazon DynamoDB (agentstate)](/oss/integrations/providers/agentstate) | [`langgraph-dynamodb-checkpoint`](https://pypi.org/project/langgraph-dynamodb-checkpoint/) | [skamalj/langgraph_dynamodb_checkpoint](https://github.com/skamalj/langgraph_dynamodb_checkpoint) |
| [Azure Cosmos DB NoSQL (agentstate)](/oss/integrations/providers/agentstate) | [`langgraph-checkpoint-cosmosdb`](https://pypi.org/project/langgraph-checkpoint-cosmosdb/) | [skamalj/langgraph_checkpoint_cosmosdb](https://github.com/skamalj/langgraph_checkpoint_cosmosdb) |
| [Google Firestore (agentstate)](/oss/integrations/providers/agentstate) | [`langgraph-checkpoint-firestore`](https://pypi.org/project/langgraph-checkpoint-firestore/) | [skamalj/langgraph_checkpoint_firestore](https://github.com/skamalj/langgraph_checkpoint_firestore) |
