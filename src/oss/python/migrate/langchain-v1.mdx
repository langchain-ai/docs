...
<Note>
For a comprehensive guide on using `init_chat_model`, including working examples, common mistakes, and best practices, see the [Initialize chat models](/oss/python/langchain/init-chat-model) guide.
</Note>
