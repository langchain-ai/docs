...
See the [LangGraph configuration file reference](../cloud/reference/cli#configuration-file) for details on all supported keys in the JSON file.

<Tip>
  The [LangGraph CLI](./langgraph_cli) defaults to using the configuration file `langgraph.json` in the current directory.
</Tip>
