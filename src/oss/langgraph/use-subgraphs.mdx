...
<Tabs>
  ...
  <Tab title="Multiple subgraph calls in parrallel">
...
<Tab title="Multiple subgraph calls in sequence">

If you are sure that multiple subgraph calls will not execute in parallel, you can disable checkpointers
