...
In this tutorial we will build a [retrieval](/oss/deepagents/retrieval) agent using LangGraph.
...
- [Retrieval](/oss/deepagents/retrieval) using [document loaders](/oss/integrations/document_loaders), [text splitters](/oss/integrations/splitters), [embeddings](/oss/integrations/embeddings), and [vector stores](/oss/integrations/vectorstores)
