...
<CardGroup cols={3}>
<Card title="Docs" icon="pencil" href="https://oracle.github.io/agent-spec/index.html">
<Card title="Code" icon="file-code" href="https://oracle.github.io/agent-spec/index.html">
<Card title="Usage Examples" icon="wrench" href="https://oracle.github.io/agent-spec/index.html">
</CardGroup>

* <Icon icon="pencil" /> [**Docs**](https://oracle.github.io/agent-spec/adapters/langgraph.html)
* <Icon icon="file-code" /> [**Code**](https://github.com/oracle/agent-spec/tree/main/pyagentspec/src/pyagentspec/adapters/langgraph)
* <Icon icon="wrench" /> [**Usage Examples**](https://github.com/oracle/agent-spec/tree/main/adapters_examples/langgraph)