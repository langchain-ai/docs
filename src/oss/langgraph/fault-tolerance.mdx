...
:::js
Configure retries, timeouts, and error handlers per node via @[`addNode`] options. For graph-wide **`retryPolicy`** and **`cachePolicy`** defaults, see [`setNodeDefaults`](#graph-defaults).
:::
