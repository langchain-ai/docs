...
Note: While the type is `tuple[str, ...]`, it may be serialized as a list when converted to JSON (e.g., `['1', 'memories']`).
:::
...
Note: While the type is `tuple`, it may be serialized as a list when converted to JSON (e.g., `['1', 'memories']`).
:::
