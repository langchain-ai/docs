...
You can configure subgraph-specific checkpointing behavior. See [subgraph checkpointing](/oss/langgraph/use-subgraphs#subgraph-checkpointing) for details on persistence levels including interrupt support and stateful continuations.
