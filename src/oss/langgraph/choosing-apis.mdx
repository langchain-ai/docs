...
- [LangChain vs. LangGraph vs. Deep Agents](/oss/concepts/products) — decide whether to use LangGraph at all, or reach for a higher-level framework or harness instead.
- [Deep Agents vs. Claude Agent SDK](/oss/deepagents/comparison) — compare the LangChain agent harness with Anthropic's SDK.
