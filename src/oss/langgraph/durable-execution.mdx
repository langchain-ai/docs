...
1. Enable [persistence](/oss/langgraph/persistence) in your workflow by specifying a [checkpointer](/oss/langgraph/checkpointers#checkpointer-libraries) that will save workflow progress.
2. Specify a [thread identifier](/oss/langgraph/checkpointers#threads) when executing a workflow. This will track the execution history for a particular instance of the workflow.
