...
For product-specific streams, see [Deep Agents streaming](/oss/deepagents/streaming-projections) for subagent streams and [LangChain agent streaming](/oss/langchain/streaming) for tool calls and middleware events.
