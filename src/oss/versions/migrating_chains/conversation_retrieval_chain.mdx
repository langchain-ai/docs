...
Advantages of switching to the LCEL implementation are similar to the [`RetrievalQA` migration guide](/oss/versions/migrating_chains/retrieval_qa):
...
Next, check out the [LCEL conceptual docs](/oss/concepts/lcel) for more background information.
