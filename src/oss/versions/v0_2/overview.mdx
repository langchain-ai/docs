...
* Better streaming support via the [Event Streaming API](https://python.langchain.com/oss/expression_language/streaming/#using-stream-events).
...
* [@chain decorator](https://python.langchain.com/oss/expression_language/how_to/decorator/) to more easily create **RunnableLambdas**
* [https://python.langchain.com/oss/expression\_language/how\_to/inspect/](https://python.langchain.com/oss/expression_language/how_to/inspect/)
...
* Tooling to visualize [your runnables](https://python.langchain.com/oss/expression_language/how_to/inspect/) or [your langgraph app](https://github.com/langchain-ai/langgraph/blob/main/examples/visualization.ipynb)
* Interoperability of chat message histories across most providers
* [Over 20+ partner packages in python](https://python.langchain.com/oss/integrations/providers/) for popular integrations
