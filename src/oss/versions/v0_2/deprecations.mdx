...
New features and improvements are not listed here. See the [overview](/oss/versions/v0_2/overview) for a summary of what's new in this release.
...
If you are using `astream_events`, please review how to [migrate to astream events v2](/oss/versions/v0_2/migrating_astream_events).
...
Alternative: Use [LangGraph](/oss/how_to/migrate_agent) or new agent constructor methods like create\_react\_agent, create\_json\_agent, create\_structured\_chat\_agent, etc.
...
Alternative: [RunnableSequence](/oss/how_to/sequence), e.g., `prompt | llm`

This [migration guide](/oss/versions/migrating_chains/llm_chain) has a side-by-side comparison.
...
Alternative: [create\_retrieval\_chain](https://python.langchain.com/api_reference/langchain/chains/langchain.chains.retrieval.create_retrieval_chain.html#langchain-chains-retrieval-create-retrieval-chain) This [migration guide](/oss/versions/migrating_chains/retrieval_qa) has a side-by-side comparison.
