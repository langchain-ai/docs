...
LangChain v0.2 was released in May 2024. This release includes a number of [breaking changes and deprecations](/oss/versions/v0_2/deprecations). This document contains a guide on upgrading to 0.2.x.

<Note>
  * [Breaking Changes & Deprecations](/oss/versions/v0_2/deprecations)
  * [Migrating legacy chains to LCEL](/oss/versions/migrating_chains)
  * [Migrating to Astream Events v2](/oss/versions/v0_2/migrating_astream_events)
</Note>
...
5. Re-run unit tests.
6. If you are using `astream_events`, please review how to [migrate to astream events v2](/oss/versions/v0_2/migrating_astream_events).
