...
[LCEL](/oss/concepts/lcel) is designed to streamline the process of building useful apps with LLMs and combining related components. It does this by providing:
...
* [LLMChain](/oss/versions/migrating_chains/llm_chain)
* [ConversationChain](/oss/versions/migrating_chains/conversation_chain)
* [RetrievalQA](/oss/versions/migrating_chains/retrieval_qa)
* [ConversationalRetrievalChain](/oss/versions/migrating_chains/conversation_retrieval_chain)
* [StuffDocumentsChain](/oss/versions/migrating_chains/stuff_docs_chain)
* [MapReduceDocumentsChain](/oss/versions/migrating_chains/map_reduce_chain)
* [MapRerankDocumentsChain](/oss/versions/migrating_chains/map_rerank_docs_chain)
* [RefineDocumentsChain](/oss/versions/migrating_chains/refine_docs_chain)
* [LLMRouterChain](/oss/versions/migrating_chains/llm_router_chain)
* [MultiPromptChain](/oss/versions/migrating_chains/multi_prompt_chain)
* [LLMMathChain](/oss/versions/migrating_chains/llm_math_chain)
* [ConstitutionalChain](/oss/versions/migrating_chains/constitutional_chain)

Check out the [LCEL conceptual docs](/oss/concepts/lcel) and [LangGraph docs](https://langchain-ai.github.io/langgraph/) for more background information.
