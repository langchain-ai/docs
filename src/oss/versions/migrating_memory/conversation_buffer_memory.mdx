...
Please refer to the following [migration guide](/src/oss/versions/migrating_chains/conversation_chain) for more information.
...
You can follow the standard LangChain tutorial for [building an agent](/src/oss/tutorials/agents) an in depth explanation of how this works.
